...
ContinueFloat
<ol>
WMenuItem(`#Deploy',`The Deployment library')

</ol>
CFloat

</p><p id="Deploy">
WBigTitle(The Deployment library)
WTitle(Importing process and example usage)

OBCode
Deploy = Load:{reuse[L42.is/Deploy]}
..
  (
...
WComm can be seen at https://raw.githack.com/Language42/is/main/testing/Deploy.xhtml
