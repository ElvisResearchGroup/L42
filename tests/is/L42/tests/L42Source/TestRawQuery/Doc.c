...
ContinueFloat
<ol>
WMenuItem(`#RawQuery',`The Raw Query library')

</ol>
CFloat

</p><p id="Query">
WBigTitle(The Query library)
...
WComm can be seen at https://raw.githack.com/Language42/is/main/testing/RawQuery.xhtml
