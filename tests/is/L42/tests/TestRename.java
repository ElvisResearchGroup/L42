...
public static void fail(String sl1,String s2,String err){
  ...
  CoreL l1=init1.p._ofCore(P.of(0,List.of(C.of("Outer",-1))));
...
public static void pass(String sl1,String s2,String sl3){
  ...
  Init init1=new Init("{Outer={"+sl1+"#norm{}}");
  CoreL l1=init1.p._ofCore(P.of(0,List.of(C.of("Outer",-1))));
  CoreL l3Actual=new Rename(new UniqueNsRefresher()).apply(init1.p,C.of("Outer",-1),l1,map(s2),null,null,null,null);
  Init init3=new Init("{Outer={"+sl3+"#norm{}}");
  CoreL l3Expected=init3.p._ofCore(P.of(0,List.of(C.of("Outer",-1))));
