...
and to avoid the temptation of losing time in choosing colors, font and
...
* we use s instead of overbar, so Cs::=C1..Cn
  This can be ambiguis for metavariables ending with s.
  In that case, the metavariable explicitly defined take precedence,
