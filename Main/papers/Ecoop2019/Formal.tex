...
The sum operate is simply defined as:

\begin{defs}
\defi{\summ{L_1}{L_2}}{\clit{\summ{K_1}{K_2}}{\Tz_1 \cup \Tz_2}{(\summ{\Mz}{\Mz'}),\Mz_1,\Mz_2}\wherec}{...}
\defic{L_1=\clit{K_1}{\Tz_1}{\Mz,\Mz_1},\quad L_2=\clit{\Tz_2}{\Mz',\Mz_2}{K_2}}{}
\defic{}{\IOComm{How do we explain the split between $Mz_1$ and $Mz_2$?}}
\defic{\text{if}\ K = \Q{interface}\  \text{then}\ \mdom{L_1}= \mdom{L_2}}{...}

\defiSep
\defi{\summ{\Q{abstract}}{K}}{K\where K \neq \Q{interface}}{Allow adding state to a proper class}
\defi{\summ{K}{\Q{abstract}}}{K\where K \neq \Q{interface}}{\IOComm{Delete this rule?}}
\defi{\summ{\Q{interface}}{\Q{interface}}}{\Q{interface}}{Interfaces must match}
\defiSep
\defi{\summ{\meth{T}{m}{\Txs}{e\q}}{\meth{T}{m}{\Txs}{e}}}{\meth{T}{m}{\Txs}{e}}{...}
\defi{\summ{\meth{T}{m}{\Txs}{e\q}}{\ameth{T}{m}{\Txs}}}{\meth{T}{m}{\Txs}{e\q}}{...}
\defi{\summ{(\ncd{C}{L})}{(\ncd{C}{L'})}}{\ncd{C}{(\summ{L}{L'})}}{Recursively Sum}
\end{defs}
