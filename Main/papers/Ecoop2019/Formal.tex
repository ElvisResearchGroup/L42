...
E}      {L \mmid{} t \mmid{} \summ{E}{E} \mmid{} \red{E}{Cs}{T}}           {HERO}%
...
T}      {\Q{This}n\Q{.}Cs}                                                 {types}
\end{bnf}
\end{minipage}


We will rely on a simplified object oriented language, where expressions $e$ are variables $x$ (including \Q@this@)
and conventional (static) method calls.
Values are of form \Q{new} T\rp{vs} but are considered as run-time expression only: the programmer would just call a static factory method.
Code literals $L$
