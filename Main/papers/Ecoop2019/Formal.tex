...
Note how based on our definitions above, the meaning of a type $T$ depends on our current context, or program. We will define an operator $\fromj{T}{T}{j}=T''$. \IOComm{Marco can you explain `what' from does? (not how it does it), in particular, what does the $j$ mean?} We ommit the definitions for all the trivial propagation cases of form $\fromj{M}{T}{j}$, $\fromj{K}{T}{j}$, and $\fromj{e}{T}{j}$.
...
\begin{defs}
	...
	\defi{\fromj{\This{n+j}{Cs}}{\This{m}{C_1\ldots C_k}}{j}}{%
		\This{m+j}{C_1\ldots C_{k-n}}\where n\leq k}{... explain ...}
	
	\defi{\fromj{\This{n+j}{Cs}}{\This{m}{C_1\ldots C_k}}{j}}{%
		\This{m+j+n-k}{C_1\ldots C_{k-n}{Cs}} \where n> k}{... explain ...}
