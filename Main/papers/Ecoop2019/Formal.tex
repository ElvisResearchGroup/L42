...
The second clause of \fop{remove} requires the $Cs$ to be ordered in such a way where the inner-most nested classes are removed first.
...
\opName{bestRedirection}: the objective of our quest is finally here for us puny readers to be understood.
...
The best redirection is a valid redirection
