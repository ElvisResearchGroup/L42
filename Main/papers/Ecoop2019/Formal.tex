...
The program $p$ is the most interesting form of the grammar,
...
\noindent To look up the value of a type in the program we will use the notation $p(T)=\textit{LV}$, which is defined by the following:,% but only if the RHS denotes an $LV$:
\begin{defye}%
