...
\begin{defs}
	\defi{\clit{\_}{\_}{\Mz}(m)}{\Mz(m)}{get a method}
	\defiSep
...
\begin{defs}
	...
	\defi{\mini{p}{\ncd{C}{E}}}{\ncd{C}{(\mini{(\tld{C}{\_}, p)}{L})}}{minimise a nested class definition}
	\defi{\minid{p}{\Id}{L}}{\mini{(\tld{\Id}{L}, p)}{L}}{minimise an $L$ with name \Id}
\end{defs}
Where \mini{p}{L} simply transforms any contained $T$s and \ncd{C}{E} using the above definitions.
