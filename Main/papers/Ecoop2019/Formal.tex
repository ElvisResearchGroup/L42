...
M}      {\Q{static}$?$ T m\rp{Txs} e$?$ \mmid{} C\eq{}E }                                                    {member}\\\production{%
...
list={interface
  ...
  method This0 pop()
  method Elem top()
  Node:{implements This1
    method This1 push(Elem e) This0.of(e,this)
    method This1 pop() this.next()
    method Elem top() this.elem()
    Elem elem, This1 next
    }
  Empty:{implements This1
    method This1 push(Elem e) Node.of(e,this)
    method This1 pop() error
    method Elem top() error
    ()}//() means no fields
  }
...
IntList={interface
  ...
  method This0 push(Int e)
  method This0 pop()
  method Int top()
  Node={implements This1
    method This1 push(Int e) This0.of(e,this)
    method This1 pop() this.next()
    method Int top() this.elem()
    Int elem, This1 next 
    }//everywhere there was "Elem", now there is "Int"
  Empty={..}}
\end{lstlisting}
Redirect can be propagated in the same way generics parameters are propagate:
For example, in Java one could write
\begin{lstlisting}
...
shapeGroup={
  ...
  ..}
\end{lstlisting}
Interestingly, there are two reasonable ways to reuse this code
