...
\inferrule[(sum)]{
LV_1 \Q@<+@_{p'} LV_2 = LV_3\\\\
C' \textit{fresh} \\p'=p\op{push}{C'\Q@=@ LV_3}
}{
p; id \vdash LV_1 \Q@<+@ LV_2 \Rightarrow LV_3
}
\quad\quad
\inferrule[(redirect)]{{}_{}\\\\{}_{}
}{
p; id \vdash \red{LV}{R} \Rightarrow LV???
}
...
Define L1 <+p L2 = L3
========================================================================================
interface?{Tz1; Mz1; K?1} <+p interface?{Tz2; Mz2; K?2} = {Tz1 U Tz2; Mz1 <+p Mz1; K?}
  {empty, K?1, K?2} = {empty, K?} //may be too sophisticated?
  if interface? = interface then mdom(Mz1)= mdom(Mz2)

Note well formedness, if interface there is no K.
\end{verbatim}
...
Define Mz <+p Mz' = Mz"
-----------------------------------------
M1..Mn,Mz <+pM'1..M'n,Mz'=M1<+pM'1..Mn<+pM'n, Mz,Mz'
  dom(Mz) disjoint dom(Mz')
Define M0 <+p M1 = M2 //note: only defined when M.Mid = M'.Mid
-----------------------------------------
