...
%\begin{defs}
%\defip{p\op{redirectable}{Csz}}{}
%\defic{\Empty \notin Csz}{}
%\defic{Cs\in Csz \implies \This{0}{Cs} \in \dom{p}}{}
%\defic{Cs\in Csz \wedge C \in\dom{p(\This{0}{Cs})} \implies \Cs{Cs}{C} \in Csz}{}
%\defic{\Cs{Cs}{C}{\_} \in Csz \implies  p(\This{0}{Cs}) =\lib{\_}{C \eq{L}\_}{\_}    }{}
%\end{defs}

That is, the class itself (i.e. the one with name $\Empty$ is not redirect-able, every nested class of a redirect path must be redirected away,
