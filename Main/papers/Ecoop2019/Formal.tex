...
\begin{defs}
\defi{\reda{R}{Cs}{\ncd{C}{L}}}{\ncd{C}{\reda{R}{\Cs{Cs}{C}}{L}}}{(propagate to nested class)}

%\defi{\reda{R}{C1\ldots Cn}{T}}{\from{R(Cs)}{\This{n}}{0}}{(since $R(Cs)$ is relative to \This{n})}
%\defic{\wwhere \from{T}{\This{0}{C1\ldots Cn}}{0} = \This{0}{Cs}}{(get $T$ relative to \This{n})}
%\defi{\reda{R}{Cs}{T}}{T\otherwise}{($T$ is not to be renamed)}
\end{defs}
