...
Meta-traits supports separate typechecking of trait definitions:  there is no need to perform meta-trait expansion
...
This issue clearly make local reasoning challenging, in order to safelly
