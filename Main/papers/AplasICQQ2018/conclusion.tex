...
MorphJ \cite{mj} is an interesting outlier, in the sense that is not QQ, but 
...
classes and interfaces. This rely on the fact that a code literal can contain nested classes/interfaces,
...
One of the biggest technical challenge we encounter while designing the primitive composition operator of 42 
was to soundly preserve those relations, especially subtyping ones.

Any programmer using QQ directly in order to obtain this kind of metaprogramming would
need ad hoc solutions to address the difficulties we encountered.
