...
result encodes the right \Q@pow@ function. We will use similar notation to JML, with \Q!@ensure! and \Q!@result! representing methods pre and post conditions in special comments that are used by a verifying compiler and kept as metadata instead of ignored.
...
In our case it is true since they would be sintactically identical.
...
with respect to QQ, since it handles logic problems that would end up hidden in QQ.
...
In this section we have a shown how a combination of
