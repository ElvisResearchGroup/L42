...
Suppose if Java code-reuse (the {\bf extends} keyword) was not introducing subtyping: then an invocation of 
...
\item An extension with nested classes solves the expression problem better than former work.
