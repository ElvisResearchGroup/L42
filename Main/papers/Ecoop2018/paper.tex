...
%  identifierstyle=\idstyle
 morekeywords={method,Use,This,then,constructor},
 deletekeywords={double}
}
%
%\newcommand\saveSpace{}
\newcommand\saveSpace{\vspace{-1pt}}
...
This allowed us to run 3 case studies comparing
our language with languages where use and reuse are connected, like Java and Scala.
\saveSpace\saveSpace
