...
At first glimpse, this seems to be not always possible since we are considering to be able to apply those
...
annotate the expected receiver type on all method calls by doing a purelly syntactic analysis
