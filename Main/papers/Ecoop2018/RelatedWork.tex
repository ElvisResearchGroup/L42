...
and (since it was applied to a dynamically typed language)
it was not clear if it had intention of modelling ThisType.
They purposely avoided any connection between state and traits.
