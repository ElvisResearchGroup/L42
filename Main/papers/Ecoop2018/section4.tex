...
Such solution 
% However the purest solution 
requires methods only in the traits.
...
Consider the simple flavored trait:
\saveSpace\begin{lstlisting}
  flavored:{
...
In order to merge colored and flavored we use  \Q@restrict@ to introduce method selectors \Q@_1merge@ and \Q@_2merge@
...
they can just omit the new name.
