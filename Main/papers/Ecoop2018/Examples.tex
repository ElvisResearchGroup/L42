...
%      CD1..CDn CDs' D Ds -> CDs CDs' D[with E=L] Ds
 ...
 \inferrule[(top)]{
    \mD.\mE \xrightarrow[\overline{\mCD}]{}^+ \mL \quad\overline{\mCD}\vdash\mCD_1:\text{OK} \  \ldots\  \overline{\mCD}\vdash\mCD_n:\text{OK} 
  }{ 
    \overline{\mCD} \ \overline{\mCD'}\ \mD \ \overline{D} \rightarrow \overline{\mCD}\ \overline{\mCD'}\ \mD\text{[with \mE=\mL]}\ \overline{\mD}
...
\inferrule[(CD-OK)]{
    \mC;\overline\mCD,\mC\terminalCode{=}\mL\vdash \mL[\terminalCode{This}=\mC]\ :\text{OK}
  }{ 
     \overline\mCD \vdash \mC\terminalCode{=}\mL\ :\text{OK}
  } \text{coherent}(\mC,\mL)
\quad\quad 
...
\inferrule[(TD-OK)]{
    \terminalCode{This};\overline\mCD,\terminalCode{This=}\mL\vdash \mL\ :\text{OK}
  }{ 
     \overline\mCD \vdash \mt\terminalCode{=}\mL\ :\text{OK}
  }
\\[5ex] 
...
\inferrule[(Many-M)]{
    \mT;\overline\mCD\vdash\mM_1:\text{OK}
\ldots
    \mT;\overline\mCD\vdash\mM_k:\text{OK}
  }{ 
...
\inferrule[(Method-OK)]{
    \text{if}\ \Opt\me=\me\ \text{then}\ \overline\mCD; \mG\vdash\me:\mT
  }{ 
     \mT;\overline\mCD \vdash \Opt{\terminalCode{static}}\ \terminalCode{method}\ \mT_0\ \mm\oR\overline{\mT\,\mx}\cR \Opt\me
  } \begin{array}{l} 
  \text{if}\ \Opt{\terminalCode{static}}=\terminalCode{static}\ \text{then}\ \mG=\mx_1:\mT_1\ .. \ \mx_n:\mT_n\ \\
  \quad\text{else}\ \mG=\terminalCode{this}:\mT,\mx_1:\mT_1\ ..\ \mx_n:\mT_n
  \\
  \forall \mT_i \in \overline\mCD\oR\mC\cR.\overline\mT,\ \text{if}\ \mm \in \text{dom}\oR \overline\mCD\oR\mT_i\cR\cR\ \text{then} \\
...
\inferrule[(Nested-OK)]{
    \mT;\overline\mC,\overline\mCD\vdash \mL\ :\text{OK}
     ...
     \mT;\overline\mCD \vdash \mC\terminalCode{=}\mL\ :\text{OK}
  }
\quad\quad
...
%  \begin{array}{l}
    ...
    \overline\mCD\vdash\mT_1 \leq \mT_2
%  \end{array}
  }{ 
