...
In the full 42 language scoping is indeed supported by an initial desugaring, and a normalization phase takes care of importing methods from interfaces.
}.
...
simplified version of Featherweight Java~\cite{}\bruno{reference please!}.