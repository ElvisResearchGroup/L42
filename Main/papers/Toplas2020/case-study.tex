...
We start presenting the example of a GUI, showing that we are able to verify the invariants over cyclic mutable object graphs in a program that interacts with the real world using I/O.
