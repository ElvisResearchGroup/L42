...
Invalid overriding: method \Q@AA.m()@ return type is \Q@AA.B@, that is unrelated with \Q@A.B@.
...
Here we introduce a simple variant to rename nested types in other nested types.
For example:
\begin{lstlisting}
