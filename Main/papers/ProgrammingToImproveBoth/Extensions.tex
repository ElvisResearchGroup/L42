...
\minisec{Application to the expression problem. Case Study 3:}
...
\begin{wraptable}{l}{0.46\textwidth}
\begin{tabular}{@{} l l l @{}}
\toprule
&                              lines  &   methods\\
\midrule
...
%\paragraph{Transformations (and queries)}
...
%\paragraph{Full power of redirect}
%An expressive form of Redirect can be multiple, that is, can redirect may interdependent classes at the same time.
