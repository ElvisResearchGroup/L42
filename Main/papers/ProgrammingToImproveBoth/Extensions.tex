...
\MS{The main idea of family polymorphism (FP)~\cite{igarashi2005lightweight,IgarashiEtAl08,nystrom2006j,Ernst06,BruceEtAl98,IgarashiViroli07,deep}
...
\MS{In the FP approach, class \Q@AA.B@ would further extends \Q@A.B@, thus also the overriding of method
...
The corresponding code in \name would work, and behave like a FP further extension.
...
\Q@equals@ in~\cite{Zenger-Odersky2005} is \MS{complex} and
