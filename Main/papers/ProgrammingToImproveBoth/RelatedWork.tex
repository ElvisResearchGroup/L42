...
\MS{This property ensures that flattening strictly reduces the number of type errors.
In turn, this
...
The typing of PT offers the same advantages of the \MS{\name} typing model, 
...
While \MS{\name, TR, DJ, and PT} all allow separating inheritance and subtyping only \MS{\name and} \textbf{TR} properly enforce 
