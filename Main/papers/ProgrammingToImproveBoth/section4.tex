...
\footnote{
Since we want to focus on the actual code, while counting line numbers we \emph{omit} white lines and lines containing only open/closed parenthesis.
}
...
Language       & Lines of code & N. of members & N. of classes and traits\\
\hline
