...
Thus, in \name\ they can be abstract, and abstract static methods are similar to the concept of member functions in the module composition setting~\cite{ancona2002calculus}.
