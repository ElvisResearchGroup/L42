...
We synthesize and simplify the best ideas from those 3 very different designs, and couple them with an elegant \emph{novel approach} to state and \MS{self construction} in traits that avoids the complexities and redundancies introduced by fields and their initialisation.
%-------
