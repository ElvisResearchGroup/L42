...
formally model class of languages that soundly support validation; this model is formally verified by a proof, parametric on the presence of a type system which guarantees certain properties of type-modifiers.
