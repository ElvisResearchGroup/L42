...
\newcommand\saveSpace{\vspace{-1px}}
...
we identify the 
\emph{this-leaking problem} as the fundamental limitation that prevents separation of subtyping from subclassing
...
we improve use and reuse and we support the \Q@This@ type and family polymorphism
...
\loseSpace
\noindent\textit{Knowledge and Grounding:}
...
This work is the logical core of the programming language 42. This show that 
