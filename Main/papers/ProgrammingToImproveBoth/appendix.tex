...
Finally, when self \MS{instantiation} is not needed, declaring the abstract factory can be made redundant, as is done in the full 42 language.
...
Just looking at how \MS{tedious} it is to implement an immutable \Q@Point@ class in Java with withers, it is sufficient to dissuade most programmers.
...
\item 
% The runtime semantics do not depend on the Our object model is equivalent to an untyped language.
