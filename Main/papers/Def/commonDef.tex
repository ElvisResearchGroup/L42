...
\newcommand{\EZComm}[1]{\NoteText{\scriptsize \textcolor{blue}{[Elena{:} #1]}}}
\newcommand{\MS}[1]{\NoteColour{green}{#1}} 
\newcommand{\MSComm}[1]{\NoteText{\scriptsize \textcolor{green}{[Marco{:} #1]}}}
\newcommand{\IO}[1]{\NoteColour{blue}{#1}}
\newcommand{\IOComm}[1]{\NoteText{\scriptsize \textcolor{blue}{[Isaac{:} #1]}}}
\newcommand{\IODel}[1]{\NoteText{\textcolor{blue}{[#1]}}}
\newcommand{\AP}[1]{\NoteColour{purple}{#1}} 
\newcommand{\APComm}[1]{\NoteText{\scriptsize \textcolor{purple}{[Alex{:} #1]}}}
\newcommand{\KJX}[1]{\NoteColour{brown}{#1}} 
\newcommand{\KJXComm}[1]{\NoteText{\scriptsize \textcolor{brown}{[kjx{:} #1]}}}
\newcommand{\MAZ}[1]{\NoteColour{purple}{#1}}
\newcommand{\MAZComm}[1]{\NoteText{\scriptsize \textcolor{purple}{[Max{:} #1]}}}
\ifdefined\AC%
