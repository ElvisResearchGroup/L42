...
\saveSpace
In Java, C++, Scala or C\# subclassing 
implies subtyping. A Java subclass definition, such as 
\Q@class A extends B {}@
...
Structural typing~\cite{cook} can deal with the first
...
This is already clear in 3 lines of
