...
and the Scala solution would end up being up to \textbf{9 times heavier than the
...
\end{lstlisting}
\saveSpace\saveSpace
\noindent Our implementation of \Q@equals@
is much simpler than the one proposed by~\cite{Zenger-Odersky2005}
