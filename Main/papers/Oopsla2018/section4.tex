...
traits that deal with \emph{point} objects that represent points
...
Thus, in \name\ they can be abstract, and abstract static methods are very similar to the original concept of member functions in the module composition setting~\cite{ancona2002calculus}.
