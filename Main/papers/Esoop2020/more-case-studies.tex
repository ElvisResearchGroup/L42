...
Thanks to this pattern, the invariant only needs to hold at the end of \Q!Family.processDay(dayOfYear)!, after all the \Q!parents! and \Q!children! have been updated. Thus \Q!Family.processDay(dayOfYear)! is atomic: it updates all its contained \Q!Person!s together.
