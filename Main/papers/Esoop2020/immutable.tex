...
We now show how if we were to relax (as in Rust), or even eliminate (as in Java), the support for OCs, RCs, or SES, the above checks would not be sufficient to enforce our invariant protocol.
