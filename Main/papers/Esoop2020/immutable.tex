\section{Examples}
\label{s:immutable}
Our invariant protocol relies on many different features and
restrictions. In this section % Don't say "We believe that they are all needed;" because we could replace them with other restrictions
we will show examples of using our system, and how relaxing any of our requirements would break the soundness of our
...
\begin{lstlisting}
class MagicCounter {
  method Int incr(){/*magically increment a counter*/}}
