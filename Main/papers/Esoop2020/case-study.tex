...
Our example shows that the RC and OC support our invariant protocol requires, is flexible enough to allow us ton encode interactive GUI programs, where widgets may circularly reference other widgets.
