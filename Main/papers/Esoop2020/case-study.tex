...
We have found that using an inner \Q@Box@ object is a useful pattern in static verification: all relevant mutating state is encapsulated into a subobject which is not directly exposed to the users.
