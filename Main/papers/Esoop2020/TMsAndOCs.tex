...
An object referenced as \Q!mut! is an \emph{mutable object}.

\noindent\rule{1.2ex}{1.2ex} Immutable (\Q@imm@): the referenced object cannot mutate, not even through other aliases. An object referenced as \Q!imm! is an \emph{immutable object}. Note: objects may be mutated and \emph{later} become immutable.
