...
In contrast, 
Pony and L42 do not guarantee that \Q@capsule@ fields contain a \Q!capsule! reference, as they provides non-destructive reads~\cite{ServettoEtAl13a,GIANNINI2019145}.
...
%These forms of \Q!capsule! fields are useful for safe parallelism but not invariant checking: 
In particular, Pony and L42's pre-existing \Q!capsule! fields do not prevent representation exposure.
