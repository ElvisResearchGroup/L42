...
Programmers are still responsible for creating and mutate objects in order to preserve their validity;
...
To clearly communicate what kind of checks the language semantic should perform,
