...
\begin{itemize}
\item \validate methods are guaranteed to be deterministic and to not mutate any state; they represent logic predicates on the receiver’s reachable object graph (ROG).
