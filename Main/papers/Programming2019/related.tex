...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%The same idea could be used in our approach, where 
...
%Such approach will not be transparent, and would be quite verbose, but would ensure that the precondition on the argument holds for the whole execution of the method.
