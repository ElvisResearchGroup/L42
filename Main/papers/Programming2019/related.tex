...
method; depending on the approach, this may even includes trivial getters.
In  our approach,
...
However, the proof rely on the method \Q@Subject.register(Observer)@ respecting its contract.
Such assumption is unrealistic in a real system with dynamic class loading,
and this invariant could trivially be broken by an user defined \Q@EvilSubject@.
