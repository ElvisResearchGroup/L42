...
%once at the end of capsule mutator methods and constructors, and after every field update, and we do not call it in other place;
%Methods that do not directly update or mutate fields are usually more numerous and invoked more often.
%We expect this to result in a dramatic reduction over the number of required checks
...
Of course, \@.validate()@ can be called indirectly, for example by calling a setter.
We expect this to result in a dramatic reduction over the number of required checks,
