...
42[], Gordon[] and Pony[], each of those works is accompanied by proofs of the properties of those modifiers.
...
However, static verification can rely on ownership as a building block~\cite{}.%On ownership verification
