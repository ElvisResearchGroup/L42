...
such $c$ location in scope. In order to simplify our proof, we assume that $c$ only has \Q@mut@ fields, and is initially valid (i.e. $c.validate()$ will return \Q@true@, until perhaps the ROG of $c$ is mutated).
