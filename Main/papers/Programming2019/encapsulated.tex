...
\REVRComm{For performance reasons, this is hardly done in practice and is a continuous source of bugs and unexpected behaviour.}{2}{citation to support this?}

\REVRComm{To avoid this performance bottleneck, we can leverage the well known \Q@capsule@ type modifier~\cite{ServettoEtAl13a,ServettoZucca15,ServettoEtAl13a}}{2}{Worth mentioning any relationship between capsules and promotion/recovery with the following? [...list of papers...]}
