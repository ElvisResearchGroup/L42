...
Object-oriented programming languages, through sub typing and dynamic dispatch provide great flexibility: they allow code to be adapted/specialized to behave differently in different contexts.
However this flexibility hampers code reasoning, which is made even more complex by dynamic class loading (supported by most mainstream OO languages).
...
(It is possible to build class invariants over
validation).
...
formally model a language soundly supporting validation; which is formally verified by a proof, parametric on the presence of a type system with certain properties, guaranteed by type modifiers.
