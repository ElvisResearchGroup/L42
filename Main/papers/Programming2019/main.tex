...
This concept is closely related to the concept of `class invariants', however, unlike validation, they allow for objects to temporarily be in a ‘broken’ state. However our work allows class invariants to be easily encoded in terms of validity. Prior work on class-invariants is typically unsound due to assumptions about library code, or due to trusting programmers to use the provided tools correctly.

Sound prior work, particularly formal verification, heavily restricts dynamic-class loading and the use of I/O, and are very work intensive.
