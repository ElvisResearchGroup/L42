...
\newcommand\REVComm[3]{\textcolor{red}{#1\footnote{\textcolor{red}\textbf{{REV#2{:} #3}}}}}
...
formally model a class of languages that soundly support validation; this model is formally verified by a proof, parametric on the presence of a type system which guarantees certain properties of type modifiers.
