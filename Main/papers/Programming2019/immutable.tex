...
If the class containing the validate method has a super-class, we would inject a \Q@super.validate()@ call as the first line of the sub-class’s validate-method, this is required as otherwise ‘broken’ objects could easily be created by simply using subtyping to redefine \Q@validate@.
