...
We call such methods \emph{capsule mutators}. \IOComm{Sould we mention that these restrictions only need too apply if the field is actually referenced inside the invariant?}
