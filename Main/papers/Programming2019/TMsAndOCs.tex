...
OCs, which L42, Pony, and Gordon et. al.'s work use, are a widely used~\cite{???} programming style that allows associating resources with objects. When this style
