...
\IO{From a usability perspective, this means that
...
be able to encapsulate those data structures in an immutable
 reference, or as we will see later a \Q@capsule@ reference.}
