...
\newcommand{\aabstract}{\Q{abstract}\xspace}
...
\newcommand{\E}[1][\p]{\ensuremath{\mathbf{E}^{#1}}}
...
% a := b
\NewDocumentCommand{\defi}{m m O{}}{\ensuremath{#1\coloneqq#2}&\llap{\text{#3}}\\}
% a if b 
\NewDocumentCommand{\defip}{m m O{}}{\ensuremath{#1\text{ if }#2}&\llap{\text{#3}}\\}
% a % (for things that are always true)
\NewDocumentCommand{\defit}{m O{}}{\ensuremath{#1}&\llap{\text{#2}}\\}
...
\NewDocumentCommand{\defic}{m O{}}{\ensuremath{\quad\quad#1}&\llap{\text{#2}}\\}
\NewDocumentCommand{\defin}{m O{}}{#1\\}
...
\NewDocumentCommand{\produ}{m m O{}}{\ensuremath{#1}&\ensuremath{{}\Coloneqq#2}&\llap{\text{#3}}\\}
\NewDocumentCommand{\prodc}{m mO{}}{&\ensuremath{\quad\quad#1}&\llap{\text{#2}}\\}
% --------------
