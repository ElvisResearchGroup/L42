...
\renewcommand{\This}[1]{\ensuremath{\Q!This!_{\@code{#1}}}\@nextpath}
...
\newcommand{\production}[3]{\ensuremath{#1}&\ensuremath{{}\Coloneqq#2}&\llap{\text{#3}}\\}
\newcommand{\prodNextLine}[2]{&\ensuremath{\quad\quad#1}&\llap{\text{#2}}\\}
% --------------
