...
\begin{irules}
	...
	\irule{Redirect}{
		...
		\ForAll{T' \in \ran{R}}{\Dz; \EmptyZ; T \vdash T'}\\\\
...
\begin{defs}
	\defip{\Sigma\op{validType}{T}}{\Sigma \vdash T : \Ok \text{ and }\Sigma\op{accessible}{T}}{}
	\defis
	
	\defit{(\State{\Dz}{T\.Cs})\op{accessible}{T}}{an outer class}
	\defit{(\State{\Dz}{T\.Cs})\op{accessible}{T\.C}}{nested within an outer class}
	\defit{(\State{\Dz}{T})\op{accessible}{T'\.C} \text{ if } (\State{\Dz}{T})\op{accessible}{T'} \text{ and } \Dz(T')=\cl{\_}{\_}{\cd{C}{E}, \_}}{public class}
\end{defs}
...
\begin{defs}
	\defi{\Sigma\op{superTypes}{T}}{
		T,\Sigma\op{superTypes}{T_1}, \ldots, \Sigma\op{superTypes}{T_n}}{}
	\defic{\wwhere \Sigma(T) = \cl{\_}{T_1\ldots T_n}{\_} \text{ and } \Sigma(T_i) = \cl{\Q{interface}}{\_}{\_}}{}
\end{defs}
...
\begin{defs}
	...
	\defic{\wwhere \Sigma = \State{\Dz}{T}}{}
	\defic{\ForAll{T \in \ran{R'}}{\Dz[T = \red{\cl{}{}{}}];\EmptyZ;T \vdash T'}}{Check that the targets of $R'$ are valid}
\end{defs}
