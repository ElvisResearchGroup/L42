...
\begin{defs}
	...
	\color{Blue} \defi{\E[(\DFz; \Ds, \cd{\id}{E})]}{E}[\IO{current E}]
	\defis
...
\begin{irules}
	\irule[Top]{
		\DFz \subseteq \DFs\\\\
		\vdash \DFz\\\\
		\DFz; \cd{\id}{\MSDel{E \vdash} E} \Rightarrow E'
	}{
		\DFs\ \cd{\id}{E}\ \Ds \Rightarrow \DFs\ \cd{\id}{E'}\ \Ds
	}
	\irule[Ctx-F]{
		\DFz; \Ds,\cd{\id}{\MSDel{E \vdash} E} \Rightarrow E'
	}{
		\DFz; \Ds, \cd{\id}{\MSDel{\_ \vdash} \ctx{F}[E]} \Rightarrow \ctx{F}[E']\\\\
	}
	...
	\begin{array}{cc}
		\irule[Trait]{
			...
			\cd{t}{\LF}, \DFz; \Ds\IO{, \cd{\id}{\MSDel{\vdash}}} t \Rightarrow \LF[\This \coloneqq T]
		}&
		\multirow{1}{*}{
				\irule[Redirect]{	
				...
				\IO{\E = \red{\LF}{R}}\\\\
				\IO{\Csz = \mop{p}{redirectSet}{}}\\\\
				R' = \mop{p}{bestMap}{\MSDel{\LF, R}}
			}{
				p \MSDel{\vdash \red{\LF}{R}} \Rightarrow \reda{\mop{\LF}{remove}{\Csz}}{R'}{T}
			}
		}\\\\
		\irule[Sum]{
			\IO{\E = \summ{\LF_1}{\LF_2}}\\\\
			...
			p \MSDel{\vdash \summ{\LF_1}{\LF_2}} \Rightarrow \LF_3
		}
	\iruleSep\\
	\end{array}\\
	\irule[Enter]{	
		\IO{\E = \cl{K}{\Tz}{\ncd{C}{E},\Mz}}\\\\
		\IO{p, \cd{C}{E} \Rightarrow E'}\\\\
		\MSDel{\DFz; \Ds, \cd{C}{E \vdash E} \Rightarrow E'}
	}{
		 \MSDel{\DFz; \Ds \vdash \cl{K}{\Tz}{\ncd{C}{E},\Mz}}
		 \IO{p} \Rightarrow \cl{K}{\Tz}{\ncd{C}{E'}, \Mz}
	}
\end{irules}
...
\begin{defs}
	\color{Blue}\defi{\mop{p}{redirectSet}{}}{\Csz\where}
	\color{Blue}\defic{p = \DFz; \Ds, \cd{\id}{\red{L}{R}}}
	\color{Blue}\defic{\vdash \DFz}
...
\\\\
\begin{defs}
	\defip{R' \in \mop{p}{validMaps}{\MSDel{L,R}}}{}
	\defic{\IO{\E = \red{L}{R}}}[the redirect we are performing]
	\defic{R \subseteq R'}[it is an extension of $R$]
	\defic{\dom{R'} = \mop{\MSDel{L}\IO{p}}{redirectSet}{\MSDel{\T, R}}}[it completes the redirect map]
...
\\\\
\begin{defs}
	\defi{\mop{p}{bestMap}{\MSDel{L,R}}}{R_1\where \forall p' \IO{{}\succeq{}} p}[for all bigger programs]
	\defic{\mop{p'}{validMaps}{\MSDel{L, R}} = R_1, \ldots, R_n}[$R_1$ is a valid map]
