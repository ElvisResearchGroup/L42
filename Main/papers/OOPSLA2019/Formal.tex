...
\begin{defs}
\color{blue}
	\defi{\Tn[(T\.C_1\.\ldots\.C_n)]}{T}{outer class}
\end{defs}
...
%	
%	\defip{Cs \in \S\op{redirectSet}{R}}{}{}
%	\defic{\redm{Cs}{T} \in R \text{ or } \Exists{Cs' \in \S\op{redirectSet}{R}}{T'\.Cs \in \fop{exposedTypes}{\S[Cs']}}}{}
%	\defic{\wwhere \S = \State{\Dz}{T'}}{}
	\defis
...
%	\defi{\S\op{internals}{\Tz}}{ \Tz\}\where \S = \State}{}
\end{defs}
...
\begin{defs}
	...
	\defic{Csz \subseteq \dom{Cs}}{(can only redirect things that exist)}
...
\defic{\IO{\T[\S'] = \T} \text{ and } \ForAll{C \in \dom{\S}}{\S'(C)\op{remove}{Csz} = \S(C)}}{\Dz' has more nested classes}
	%MostSpecific(p; Pz) = P
	%P in p.minimize(Pz)
