...
\begin{irules}
	...
	\begin{array}{cc}
		...
		\multirow{1}{*}{
				...
				\IO{p = DFz; Ds, \cd{\id}{\red{\LF}{R}}}\\\\
				\IO{\mop{p}{validRedirect}{}}\\\\
		...
		\irule[Sum]{
			...
			\MSDel{p \vdash} \IO{\DFz; \Ds, \cd{id}{}} \summ{\LF_1}{\LF_2} \Rightarrow \LF_3
		}
	\iruleSep\\
	\end{array}\\
	\irule[Enter]{	
		\DFz; \Ds, \IO{, \cd{\id}{\cl{K}{\Tz}{\ncd{C}{E},\Mz}},{}} \cd{C}{\MSDel{E \vdash} E} \Rightarrow E'
	}{
		\DFz; \Ds\IO{, \cd{\id}{}} \MSDel{\vdash} \cl{K}{\Tz}{\ncd{C}{E},\Mz} \Rightarrow \cl{K}{\Tz}{\ncd{C}{E'}, \Mz}
	}
\end{irules}
