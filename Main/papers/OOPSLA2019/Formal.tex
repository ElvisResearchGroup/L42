...
\begin{defs}
	...
	\defis
	\defip{\Sigma\op{accessible}{Cs\.C}}{}{}%
	\defic{
		\Sigma\op{accessible}{Cs} \text{ and } \Sigma(Cs\.C) = \cl{\_}{\_}{\cd{C}{E}, \_}\text{, or}}{public nested class of an accessible class}
	\defic{\Sigma = \State{\Dz}{Cs\.C\.Cs'}\text{, or}}{an outer class}
	\defic{\Sigma = \State{\Dz}{Cs}}{a nested-class within the current class}
...
%%%%%%
%(Dz;T).accessible(T.C)
%(Dz;T.Cs).accessible(T)
%(Dz;T).accessible(T'.C) if (Dz;T).accessible(T') and Dz(T')={_;_;C=E,_}
