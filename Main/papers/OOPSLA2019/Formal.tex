...
\begin{irules}
	\irule{Top}{
		...
		\DVs\ \cd{\Id}{E}\ \Ds \Rightarrow \DVs\ \cd{\Id}{E'}\ \Ds
	}
	\irule{Ctx-V}{
...
\defic{\wwhere L_1=\clit{K_1}{\Tz_1}{\Mz,\Mz_1},\quad L_2=\clit{\Tz_2}{\Mz',\Mz_2}{K_2}}{}
...
\end{defs}
\IOComm{If the LHS of a redirect is ill-typed because it refers to a nested class that dosn't exist yet, adding new classes (in similar programs) could change the result of redirect....}
