...
}$\displaystyle % dinferences? spacinhg!
	\inferrule[(Top)]{
		\State{\DVs, C = E}{C} \vdash E \Rightarrow E'\\\\
		\text{if } \Id = t \text{ then } C = \This \text{, otherwise } C = \Id
	}{
...
As well as a lookup for the current class in $\Sigma$:
...
\begin{irules}
	...
	\irule{Redirect}{
		...
		\irule{Trait}{\Dz \vdash \cd{t}{LV} : \Ok}{
...
\begin{defs}
	...
	\defic{\Sigma \vdash \Sigma(T) : \Ok}{}
	\defic{\Sigma\op{accessible}{T}}{}
	\defis
...
\begin{defs}
	...
	\defic{\Exists{Cs' \in \Sigma\op{redirectSet}{R}}{Cs\in \Sigma\op{internals}{\fop{exposedTypes}{\Sigma[Cs']}}}}{}
	\defis
	...
	\defi{\Sigma\op{internals}{\Tz}}{\{Cs \mid T\.Cs \in \Tz\}\where \Sigma = \State{\Dz}{T}}{}
\end{defs}
