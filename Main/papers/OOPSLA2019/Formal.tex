...
\begin{grammar}
	...
	\produ{K}{\interface \mid{} \abstract \mid{} \Txs}{kind}
...
\defi{\summ{\abstract}{\abstract}}{\abstract}{keep abstract classes}
\defi{\summ{\abstract}{\Txs}}{\summ{\Txs}{\abstract} \coloneqq K}{allow adding state to an abstract class}
\defis
