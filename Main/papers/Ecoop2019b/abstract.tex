\begin{abstract}
In this paper we use pre existing type modifier and object capability systems to enable a system for sound runtime verification of invariants.
...
We also formalise our approach and prove that such pre existing type modifier and object capability systems are sufficient to ensure its soundness.
\end{abstract}
