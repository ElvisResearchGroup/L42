...
programming patterns supporting \IO{demonstrating that these restrictions do not significantly hamper expressivity} \IODel{very expressive programming patterns}.
