...
its \Q@invariant@ method \REV{must be of the form \Q@read method Bool invariant() {..}@}{2}{Can  a program write say mut method invariant or is it syntactically [???]}
...
\REV{\textit{Unrestricted use of object-capabilities:}}{3}{Where do OCs factor in to this example? Cite/explain how this example works in Rust and Java.}
