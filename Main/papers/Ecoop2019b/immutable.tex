...
\subheading{Unrestricted \IO{Access To Capability Objects} \IODel{use of non-determinism}} Allowing the \Q@invariant@ method to (indirectly) perform a non deterministic operation\IODel{, such as} by creating new capability objects \IO{or mutating existing ones}, could break our guarantee that (manually) calling it always returns \Q!true!.
