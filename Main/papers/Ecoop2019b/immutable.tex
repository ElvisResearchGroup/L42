...
\subheading{Unrestricted use of non determinism} Allowing the \Q@invariant@ method to (indirectly) perform a non deterministic operation, such as by creating new capability objects, could break our guarantee that (manually) calling it always returns \IO{\Q!true!}.
