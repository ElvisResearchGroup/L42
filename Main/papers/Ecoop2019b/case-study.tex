...
Our design, \REV{using an inner \Q@Box@ object, is a common pattern in static verification}{C}{I thought I knew a bit about static verification, but I've never heard of the Box pattern or seen anything like it.}: where one encapsulates all relevant mutating state into an encapsulated sub object which is not exposed to users.
