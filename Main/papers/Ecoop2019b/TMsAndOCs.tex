...
\item Encapsulated (\Q@capsule@):
 everything in the reachable object graph (ROG) of a capsule reference (including itself) is mutable only through that reference; \REV{however immutable references can be freely shared across capsule boundaries}{B}{what does [this] mean}.
\end{itemize}
