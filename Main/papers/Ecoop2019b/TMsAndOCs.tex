...
Here we assume the full/deep meaning~\cite{ZibinEtAl10,Potanin2013}:\SS
\begin{itemize}
...
However, since
L42 allows user code to perform foreign calls without going through a predefined standard library, its type system enforces the OC pattern over such calls:\SS
...
as being deterministic and not mutating existing memory. Such methods are pure because:\SS
\begin{itemize}
