...
\iftoggle{ECOOP}{%
	\newcommand\ECOOPDel[1]{#1}}
{%
	\newcommand\ECOOPDel[1]{\MSDel{#1}}%
}
\ECOOPDel{
\MSBlock{If rejected by ECOOP, put this subheading in the appendix and add a note: we have extended related work on RV Tools}{
