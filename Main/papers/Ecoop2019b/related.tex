...
This does not happen with a type system, since its properties are more coarse grained, simpler and easier to check.
 Static-verification has more flexible and fine-grained annotations and is more fragile since it uses a theorem prover as a back-end.}{3}{This hole discussion seems muddled.}
