...
than Spec\#, (the system with the most comparable goals). \IO{In Section~\ref{s:formalism} we formalised our invariant protocol and in Appendix~\ref{s:proof} we prove it sound.}
