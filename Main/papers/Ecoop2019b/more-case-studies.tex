...
% TODO: Our visisble state semantics does invariant checks on field accesses, even though they are not via getters?
...
We then have a simple test case that calls \Q!processDay! on a \Q!Family! for $1,095$ times (3 years worth):
\begin{lstlisting}
