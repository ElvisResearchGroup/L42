...
We have a simple test case that calls \Q!processDay! on a \Q!Family! $3\times365$ times ($1{,}095$ years worth):
\begin{lstlisting}
...
%The Spec\# verifier is able to do this as it assumes that arithmetic overflow does not occur, however one can turn on runtime-checking for overflow. This is sound in both the context of Spec\# and L42, since overflow will have the same result as a runtime invariant %check failure, namely it will raise an unchecked exception.
