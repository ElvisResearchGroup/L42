...
similarly, our approach prevents the exponential explosion of nested invariant checks (see section \ref{s:case-study}) when deep object graphs are involved, but in this example the object graph of \Q!fam! is very shallow.
\loseSpace
