...
\REV{Consider managing the shipment of items, where there is a maximum combined weight:}{D}{This discussion of shipping lists and items explains a problem that this system's
...
\REV{Allowing \Q@this@ to be used more than once can also cause problems:}{D}{allowing 'this' to be used more than once without restriction does cause problems, but are there no intermediate restrictions that work?  This one is drastic.}
\begin{lstlisting}
...
If the former code were accepted, 
