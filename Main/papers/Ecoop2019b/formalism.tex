...
\begin{itemize}
	\item An implicit program/class table; \IO{we use the notation $C.m$ to get the method declaration for $m$, within class $C$, similarly we use $C.f$ to get the field declaration of field $f$.}
