...
public class MiniJ {
  ...
  public static final class IfTypeCase implements S {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IfTypeCase(final String x0, final String x1, final String cn, final B then, final B _else) {
      this.x0 = x0;
      this.x1 = x1;
      this.cn = cn;
      this.then = then;
