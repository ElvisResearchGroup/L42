...
public class MiniJ {
  ...
  public static final class CD {
    ...
    @java.beans.ConstructorProperties({"isInterface", "cn", "cns", "ms"})
  ...
  public static final class M {
    ...
    @java.beans.ConstructorProperties({"retT", "name", "ts", "xs", "body"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public M(final String retT, final String name, final List<String> ts, final List<String> xs, final S body) {
      this.retT = retT;
      this.name = name;
      this.ts = ts;
      this.xs = xs;
    ...
    public int hashCode() {
      ...
      result = result * PRIME + ($retT == null ? 0 : $retT.hashCode());
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "MiniJ.M(retT=" + this.getRetT() + ", name=" + this.getName() + ", ts=" + this.getTs() + ", xs=" + this.getXs() + ", body=" + this.getBody() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public M withRetT(final String retT) {
      return this.retT == retT ? this : new M(retT, this.name, this.ts, this.xs, this.body);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public M withName(final String name) {
      return this.name == name ? this : new M(this.retT, name, this.ts, this.xs, this.body);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public M withTs(final List<String> ts) {
      return this.ts == ts ? this : new M(this.retT, this.name, ts, this.xs, this.body);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public M withXs(final List<String> xs) {
      return this.xs == xs ? this : new M(this.retT, this.name, this.ts, xs, this.body);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public M withBody(final S body) {
      return this.body == body ? this : new M(this.retT, this.name, this.ts, this.xs, body);
    }
  }
  ...
  public static final class IfTypeCase implements S {
    ...
    @java.beans.ConstructorProperties({"x0", "x1", "cn", "then", "_else"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IfTypeCase(final String x0, final String x1, final String cn, final S then, final S _else) {
      this.x0 = x0;
      this.x1 = x1;
      this.cn = cn;
      this.then = then;
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final IfTypeCase other = (IfTypeCase)o;
    ...
    public int hashCode() {
      ...
      result = result * PRIME + ($x0 == null ? 0 : $x0.hashCode());
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "MiniJ.IfTypeCase(x0=" + this.getX0() + ", x1=" + this.getX1() + ", cn=" + this.getCn() + ", then=" + this.getThen() + ", _else=" + this.get_else() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IfTypeCase withX0(final String x0) {
      return this.x0 == x0 ? this : new IfTypeCase(x0, this.x1, this.cn, this.then, this._else);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IfTypeCase withX1(final String x1) {
      return this.x1 == x1 ? this : new IfTypeCase(this.x0, x1, this.cn, this.then, this._else);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IfTypeCase withCn(final String cn) {
      return this.cn == cn ? this : new IfTypeCase(this.x0, this.x1, cn, this.then, this._else);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IfTypeCase withThen(final S then) {
      return this.then == then ? this : new IfTypeCase(this.x0, this.x1, this.cn, then, this._else);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IfTypeCase with_else(final S _else) {
      return this._else == _else ? this : new IfTypeCase(this.x0, this.x1, this.cn, this.then, _else);
    }
  }
  ...
  public static final class WhileTrue implements S {
    ...
    @java.beans.ConstructorProperties({"label", "s"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
  ...
  public static final class Return implements S {
    ...
    @java.beans.ConstructorProperties({"e"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
  ...
  public static final class UseCall implements E {
    ...
    @java.beans.ConstructorProperties({"cn", "mName", "xs", "inner"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public UseCall(final String cn, final String mName, final List<String> xs, final S inner) {
      this.cn = cn;
      this.mName = mName;
      this.xs = xs;
      this.inner = inner;
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "MiniJ.UseCall(cn=" + this.getCn() + ", mName=" + this.getMName() + ", xs=" + this.getXs() + ", inner=" + this.getInner() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public UseCall withCn(final String cn) {
      return this.cn == cn ? this : new UseCall(cn, this.mName, this.xs, this.inner);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public UseCall withMName(final String mName) {
      return this.mName == mName ? this : new UseCall(this.cn, mName, this.xs, this.inner);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public UseCall withXs(final List<String> xs) {
      return this.xs == xs ? this : new UseCall(this.cn, this.mName, xs, this.inner);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public UseCall withInner(final S inner) {
      return this.inner == inner ? this : new UseCall(this.cn, this.mName, this.xs, inner);
    }
  }
