// Generated by delombok at Fri Aug 28 11:58:43 CEST 2015
package ast;
...
public class Util {
	...
	public static class PathSPath {
		...
		@java.beans.ConstructorProperties({"path", "paths"})
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public PathSPath(@NonNull final Path path, @NonNull final List<Path> paths) {
			if (path == null) {
				throw new java.lang.NullPointerException("path");
			}
			if (paths == null) {
				throw new java.lang.NullPointerException("paths");
			}
			this.path = path;
			this.paths = paths;
		}
		...
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public void setPaths(@NonNull final List<Path> paths) {
			if (paths == null) {
				throw new java.lang.NullPointerException("paths");
			}
			this.paths = paths;
		...
		public int hashCode() {
			...
			result = result * PRIME + ($paths == null ? 0 : $paths.hashCode());
			return result;
		}
		...
		public PathSPath withPath(@NonNull final Path path) {
			...
			return this.path == path ? this : new PathSPath(path, this.paths);
		}

		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public PathSPath withPaths(@NonNull final List<Path> paths) {
			if (paths == null) {
				throw new java.lang.NullPointerException("paths");
			}
			return this.paths == paths ? this : new PathSPath(this.path, paths);
		}
	}
	...
	public static class SPathSPath {
		...
		@java.beans.ConstructorProperties({"paths1", "paths2"})
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public SPathSPath(@NonNull final List<Path> paths1, @NonNull final List<Path> paths2) {
			if (paths1 == null) {
				throw new java.lang.NullPointerException("paths1");
			}
			if (paths2 == null) {
				throw new java.lang.NullPointerException("paths2");
			}
			this.paths1 = paths1;
			this.paths2 = paths2;
		}
		...
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public void setPaths1(@NonNull final List<Path> paths1) {
			if (paths1 == null) {
				throw new java.lang.NullPointerException("paths1");
			}
			this.paths1 = paths1;
		...
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public void setPaths2(@NonNull final List<Path> paths2) {
			if (paths2 == null) {
				throw new java.lang.NullPointerException("paths2");
			}
			this.paths2 = paths2;
		...
		public boolean equals(final java.lang.Object o) {
			...
			if (!other.canEqual((java.lang.Object)this)) return false;
			final java.lang.Object this$paths1 = this.getPaths1();
			final java.lang.Object other$paths1 = other.getPaths1();
			if (this$paths1 == null ? other$paths1 != null : !this$paths1.equals(other$paths1)) return false;
			final java.lang.Object this$paths2 = this.getPaths2();
			final java.lang.Object other$paths2 = other.getPaths2();
			if (this$paths2 == null ? other$paths2 != null : !this$paths2.equals(other$paths2)) return false;
			return true;
		}
		...
		public int hashCode() {
			final int PRIME = 59;
			int result = 1;
			final java.lang.Object $paths1 = this.getPaths1();
			result = result * PRIME + ($paths1 == null ? 0 : $paths1.hashCode());
			final java.lang.Object $paths2 = this.getPaths2();
			result = result * PRIME + ($paths2 == null ? 0 : $paths2.hashCode());
			return result;
		}

		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public SPathSPath withPaths1(@NonNull final List<Path> paths1) {
			if (paths1 == null) {
				throw new java.lang.NullPointerException("paths1");
			}
			return this.paths1 == paths1 ? this : new SPathSPath(paths1, this.paths2);
		}

		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public SPathSPath withPaths2(@NonNull final List<Path> paths2) {
			if (paths2 == null) {
				throw new java.lang.NullPointerException("paths2");
			}
			return this.paths2 == paths2 ? this : new SPathSPath(this.paths1, paths2);
		}
	}
