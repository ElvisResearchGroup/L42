...
public class Util {
	...
	public static class CachedStage {
		...
		@javax.annotation.Generated("lombok")
		public java.lang.String toString() {
			return "Util.CachedStage(stage=" + this.getStage() + ", dependencies=" + this.getDependencies() + ", allSupertypes=" + this.getAllSupertypes() + ", verified=" + this.isVerified() + ", privateNormalized=" + this.isPrivateNormalized() + ", families=" + this.getFamilies() + ")";
		}
	}
