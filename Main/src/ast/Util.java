...
public class Util {
	...
	public interface Locator {
		...
		class ImplLocator implements Locator {
			@NonNull
			...
			@java.beans.ConstructorProperties({"mTail", "mPos", "mOuters"})
			@java.lang.SuppressWarnings("all")
			@javax.annotation.Generated("lombok")
			public ImplLocator(@NonNull final java.util.List<ClassB.Member> mTail, @NonNull final java.util.List<Integer> mPos, @NonNull final java.util.List<ClassB> mOuters) {
				if (mTail == null) {
			...
			public boolean equals(final java.lang.Object o) {
				if (o == this) return true;
				if (!(o instanceof Util.Locator.ImplLocator)) return false;
				final ImplLocator other = (ImplLocator)o;
			...
			protected boolean canEqual(final java.lang.Object other) {
				return other instanceof Util.Locator.ImplLocator;
			}
			...
			@javax.annotation.Generated("lombok")
			public java.lang.String toString() {
				return "Util.Locator.ImplLocator(mTail=" + this.getMTail() + ", mPos=" + this.getMPos() + ", mOuters=" + this.getMOuters() + ")";
			}
		}
	}
