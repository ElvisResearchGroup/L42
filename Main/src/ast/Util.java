...
public class Util {
	...
	public static final class PathMwt {
		...
		@javax.annotation.Generated("lombok")
		public java.lang.String toString() {
			return "Util.PathMwt(original=" + this.getOriginal() + ", mwt=" + this.getMwt() + ")";
		}
	}
	...
	public static class CachedStage {
		...
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public java.util.ListIterator<PathMwt> getInherited() {
		...
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public void setInherited(final java.util.ListIterator<PathMwt> inherited) {
		...
		@javax.annotation.Generated("lombok")
		public java.lang.String toString() {
			return "Util.CachedStage(stage=" + this.getStage() + ", dependencies=" + this.getDependencies() + ", inherited=" + this.getInherited() + ", verified=" + this.isVerified() + ", coherent=" + this.isCoherent() + ", givenName=" + this.getGivenName() + ", privateNormalized=" + this.isPrivateNormalized() + ", families=" + this.getFamilies() + ")";
		}
	}
