...
public class Util {
  ...
  public static class MethodLocator {
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "Util.MethodLocator(mTail=" + this.getMTail() + ", mPos=" + this.getMPos() + ", that=" + this.getThat() + ", newName=" + this.getNewName() + ")";
    }
  ...
  public static class NestedLocator {
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "Util.NestedLocator(mTail=" + this.getMTail() + ", mPos=" + this.getMPos() + ", that=" + this.getThat() + ", newName=" + this.getNewName() + ")";
    }
  }
}