...
public class Util {
	...
	public static class CachedStage {
		...
		@javax.annotation.Generated("lombok")
		public java.lang.String toString() {
			return "Util.CachedStage(verified=" + this.isVerified() + ", privateNormalized=" + this.isPrivateNormalized() + ", families=" + this.getFamilies() + ", stage=" + this.getStage() + ", dependencies=" + this.getDependencies() + ", inherited=" + this.getInherited() + ", coherent=" + this.isCoherent() + ", givenName=" + this.getGivenName() + ")";
		}
	}
