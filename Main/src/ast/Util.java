// Generated by delombok at Mon Jun 26 12:35:20 NZST 2017
package ast;
...
public class Util {
  ...
  public static final class CsMxMx {
    ...
    public String toString() {
      String prefix = "This0";
      if (!cs.isEmpty()) {
        prefix = String.join(".", cs.toString());
      }
      return prefix + "::" + ms1 + "->ms2";
    }

    @java.beans.ConstructorProperties({"cs", "ms1", "ms2"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CsMxMx(@NonNull final java.util.List<Ast.C> cs, @NonNull final MethodSelector ms1, @NonNull final MethodSelector ms2) {
      if (cs == null) {
        throw new java.lang.NullPointerException("cs");
      }
      if (ms1 == null) {
    ...
    public CsMxMx withCs(@NonNull final java.util.List<Ast.C> cs) {
      ...
      return this.cs == cs ? this : new CsMxMx(cs, this.ms1, this.ms2);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CsMxMx withMs1(@NonNull final MethodSelector ms1) {
      if (ms1 == null) {
        throw new java.lang.NullPointerException("ms1");
      }
      return this.ms1 == ms1 ? this : new CsMxMx(this.cs, ms1, this.ms2);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CsMxMx withMs2(@NonNull final MethodSelector ms2) {
      if (ms2 == null) {
        throw new java.lang.NullPointerException("ms2");
      }
      return this.ms2 == ms2 ? this : new CsMxMx(this.cs, this.ms1, ms2);
    }
  }
