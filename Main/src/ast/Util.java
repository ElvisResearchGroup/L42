...
public class Util {
  ...
  public static class CsPz {
    ...
    @java.lang.SuppressWarnings("all")
    public CsPz(@NonNull final List<Ast.C> cs, @NonNull final java.util.Set<Path> pathsSet) {
      if (cs == null) {
        throw new java.lang.NullPointerException("cs is marked @NonNull but is null");
      }
      if (pathsSet == null) {
    ...
    @java.lang.SuppressWarnings("all")
    public CsPz withCs(@NonNull final List<Ast.C> cs) {
      if (cs == null) {
        throw new java.lang.NullPointerException("cs is marked @NonNull but is null");
      }
    ...
    @java.lang.SuppressWarnings("all")
    public CsPz withPathsSet(@NonNull final java.util.Set<Path> pathsSet) {
      if (pathsSet == null) {
        throw new java.lang.NullPointerException("pathsSet is marked @NonNull but is null");
      }
