// Generated by delombok at Fri Aug 21 04:50:54 CEST 2015
package ast;
...
public interface ExpCore {
  ...
  final class ClassB implements ExpCore, Ast.Atom {
    ...
    private final ast.Util.CachedStage stage = new ast.Util.CachedStage();
    ...
    public static final class MethodImplemented implements Member {
      ...
      @NonNull
      private final ExpCore inner;
      private final ast.Util.CachedMt mt = new ast.Util.CachedMt();
      private final Position p;
      ...
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public ast.Util.CachedMt getMt() {
        return this.mt;
      }
    ...
    public ClassB withDoc1(final Doc doc1) {
      return this.doc1 == doc1 ? this : new ClassB(doc1, this.doc2, this.isInterface, this.supertypes, this.ms);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withDoc2(final Doc doc2) {
      return this.doc2 == doc2 ? this : new ClassB(this.doc1, doc2, this.isInterface, this.supertypes, this.ms);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withInterface(final boolean isInterface) {
      return this.isInterface == isInterface ? this : new ClassB(this.doc1, this.doc2, isInterface, this.supertypes, this.ms);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withSupertypes(final List<Ast.Path> supertypes) {
      return this.supertypes == supertypes ? this : new ClassB(this.doc1, this.doc2, this.isInterface, supertypes, this.ms);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withMs(final List<Member> ms) {
      return this.ms == ms ? this : new ClassB(this.doc1, this.doc2, this.isInterface, this.supertypes, ms);
    }
