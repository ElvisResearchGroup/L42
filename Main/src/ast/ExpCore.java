...
public interface ExpCore extends Serializable {
  ...
  final class MCall implements ExpCore, HasPos<MCall>, WithInner<MCall> {
    ...
    @java.beans.ConstructorProperties({"inner", "s", "doc", "es", "p", "typeRec", "typeOut"})
  ...
  final class OperationDispatch implements ExpCore, HasPos<OperationDispatch> {
    ...
    @java.beans.ConstructorProperties({"s", "doc", "es", "p"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final OperationDispatch other = (OperationDispatch)o;
      final java.lang.Object this$s = this.getS();
      final java.lang.Object other$s = other.getS();
      if (this$s == null ? other$s != null : !this$s.equals(other$s)) return false;
      final java.lang.Object this$doc = this.getDoc();
  ...
  final class Block implements ExpCore, HasPos<Block>, WithInner<Block> {
    ...
    public static final class Dec implements WithInner<Dec>, Serializable {
      ...
      @java.beans.ConstructorProperties({"isVar", "_t", "x", "inner"})
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      ...
      public int hashCode() {
        ...
        result = result * PRIME + ($_t == null ? 0 : $_t.hashCode());
    ...
    @java.beans.ConstructorProperties({"doc", "decs", "inner", "ons", "p", "typeOut"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
