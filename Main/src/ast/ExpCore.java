// Generated by delombok at Sat Mar 11 08:38:56 ICT 2017
package ast;
...
public interface ExpCore {
  ...
  final class ClassB implements ExpCore, Ast.Atom, HasPos {
    ...
    public static ExpCore.ClassB docClass(Doc d) {
      return new ClassB(d, false, Collections.emptyList(), Collections.emptyList(), Position.noInfo, verifiedStage.copyMostStableInfo(), Phase.Typed, "");
    }
    ...
    public static ExpCore.ClassB membersClass(List<Member> ms, Position pos) {
      return new ClassB(Doc.empty(), false, Collections.emptyList(), ms, pos, new CachedStage(), Phase.None, "");
    }
    
    public List<Path> getSuperPaths() {
      return this.getSupertypes().stream().map(t -> t.getNT().getPath()).collect(Collectors.toList());
    }
    ...
    public ClassB withDoc1(final Doc doc1) {
      return this.doc1 == doc1 ? this : new ClassB(doc1, this.isInterface, this.supertypes, this.ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withInterface(final boolean isInterface) {
      return this.isInterface == isInterface ? this : new ClassB(this.doc1, isInterface, this.supertypes, this.ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withSupertypes(final List<Ast.Type> supertypes) {
      return this.supertypes == supertypes ? this : new ClassB(this.doc1, this.isInterface, supertypes, this.ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withMs(final List<Member> ms) {
      return this.ms == ms ? this : new ClassB(this.doc1, this.isInterface, this.supertypes, ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withP(final Position p) {
      return this.p == p ? this : new ClassB(this.doc1, this.isInterface, this.supertypes, this.ms, p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withStage(final ast.Util.CachedStage stage) {
      return this.stage == stage ? this : new ClassB(this.doc1, this.isInterface, this.supertypes, this.ms, this.p, stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withPhase(final Phase phase) {
      return this.phase == phase ? this : new ClassB(this.doc1, this.isInterface, this.supertypes, this.ms, this.p, this.stage, phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withUniqueId(final String uniqueId) {
      return this.uniqueId == uniqueId ? this : new ClassB(this.doc1, this.isInterface, this.supertypes, this.ms, this.p, this.stage, this.phase, uniqueId);
    }
  ...
  final class Signal implements ExpCore, WithInner<Signal> {
    private final SignalKind kind;
    private final ExpCore inner;
    private final NormType typeOut;
    private final NormType typeIn;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Signal(final SignalKind kind, final ExpCore inner, final NormType typeOut, final NormType typeIn) {
      this.kind = kind;
      this.inner = inner;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getTypeOut() {
      return this.typeOut;
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getTypeIn() {
      return this.typeIn;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Signal withTypeOut(final NormType typeOut) {
      return this.typeOut == typeOut ? this : new Signal(this.kind, this.inner, typeOut, this.typeIn);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Signal withTypeIn(final NormType typeIn) {
