// Generated by delombok at Sun Sep 25 13:11:29 ICT 2016
package ast;
...
public interface ExpCore {
  ...
  final class MCall implements ExpCore, HasPos, WithInner<MCall> {
  ...
  final class Block implements ExpCore, HasPos, WithInner<Block> {
    private final Doc doc;
    ...
    public static final class Dec implements WithInner<Dec> {
      ...
      @java.beans.ConstructorProperties({"t", "x", "inner"})
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Dec(final Type t, final String x, final ExpCore inner) {
        this.t = t;
        this.x = x;
        this.inner = inner;
      }
      ...
      @javax.annotation.Generated("lombok")
      public java.lang.String toString() {
        return "ExpCore.Block.Dec(t=" + this.getT() + ", x=" + this.getX() + ", inner=" + this.getInner() + ")";
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Dec withT(final Type t) {
        return this.t == t ? this : new Dec(t, this.x, this.inner);
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Dec withX(final String x) {
        return this.x == x ? this : new Dec(this.t, x, this.inner);
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Dec withInner(final ExpCore inner) {
        return this.inner == inner ? this : new Dec(this.t, this.x, inner);
      }
    }
    ...
    public static final class On implements HasPos, WithInner<On> {
  ...
  final class ClassB implements ExpCore, Ast.Atom, HasPos {
    ...
    public static ExpCore.ClassB docClass(Doc d) {
      return new ClassB(d, Doc.empty(), false, Collections.emptyList(), Collections.emptyList(), Position.noInfo, verifiedStage.copyMostStableInfo(), Phase.Typed, "-");
    }
    //TODO: remove when chachd stage is out
    private static final CachedStage verifiedStage = new CachedStage();
    static {
      verifiedStage.setVerified(true);
    }
    
    public static ExpCore.ClassB membersClass(List<Member> ms, Position pos) {
      return new ClassB(Doc.empty(), Doc.empty(), false, Collections.emptyList(), ms, pos, new CachedStage(), Phase.None, "");
    }
    ...
    public ClassB withDoc1(final Doc doc1) {
      return this.doc1 == doc1 ? this : new ClassB(doc1, this.doc2, this.isInterface, this.supertypes, this.ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withDoc2(final Doc doc2) {
      return this.doc2 == doc2 ? this : new ClassB(this.doc1, doc2, this.isInterface, this.supertypes, this.ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withInterface(final boolean isInterface) {
      return this.isInterface == isInterface ? this : new ClassB(this.doc1, this.doc2, isInterface, this.supertypes, this.ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withSupertypes(final List<Ast.Path> supertypes) {
      return this.supertypes == supertypes ? this : new ClassB(this.doc1, this.doc2, this.isInterface, supertypes, this.ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withMs(final List<Member> ms) {
      return this.ms == ms ? this : new ClassB(this.doc1, this.doc2, this.isInterface, this.supertypes, ms, this.p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withP(final Position p) {
      return this.p == p ? this : new ClassB(this.doc1, this.doc2, this.isInterface, this.supertypes, this.ms, p, this.stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withStage(final ast.Util.CachedStage stage) {
      return this.stage == stage ? this : new ClassB(this.doc1, this.doc2, this.isInterface, this.supertypes, this.ms, this.p, stage, this.phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withPhase(final Phase phase) {
      return this.phase == phase ? this : new ClassB(this.doc1, this.doc2, this.isInterface, this.supertypes, this.ms, this.p, this.stage, phase, this.uniqueId);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withUniqueId(final String uniqueId) {
      return this.uniqueId == uniqueId ? this : new ClassB(this.doc1, this.doc2, this.isInterface, this.supertypes, this.ms, this.p, this.stage, this.phase, uniqueId);
    }
...
class _Aux {
  ...
  static boolean isConsistent(ClassB cb) {
    ...
    assert (cb.getPhase() == ast.ExpCore.ClassB.Phase.None && cb.getUniqueId().isEmpty()) || ((cb.getPhase() != ast.ExpCore.ClassB.Phase.None && !cb.getUniqueId().isEmpty())):
    "";
