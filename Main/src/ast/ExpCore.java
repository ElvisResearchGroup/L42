...
public interface ExpCore {
  ...
  final class MCall implements ExpCore, HasPos<MCall>, WithInner<MCall> {
    ...
    @java.beans.ConstructorProperties({"inner", "s", "doc", "es", "p", "typeRec"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall(final ExpCore inner, final MethodSelector s, final Doc doc, final List<ExpCore> es, final Position p, final Type typeRec) {
      this.inner = inner;
      this.s = s;
      this.doc = doc;
      this.es = es;
    ...
    public MCall withInner(final ExpCore inner) {
      return this.inner == inner ? this : new MCall(inner, this.s, this.doc, this.es, this.p, this.typeRec);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withS(final MethodSelector s) {
      return this.s == s ? this : new MCall(this.inner, s, this.doc, this.es, this.p, this.typeRec);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withDoc(final Doc doc) {
      return this.doc == doc ? this : new MCall(this.inner, this.s, doc, this.es, this.p, this.typeRec);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withEs(final List<ExpCore> es) {
      return this.es == es ? this : new MCall(this.inner, this.s, this.doc, es, this.p, this.typeRec);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withP(final Position p) {
      return this.p == p ? this : new MCall(this.inner, this.s, this.doc, this.es, p, this.typeRec);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withTypeRec(final Type typeRec) {
      return this.typeRec == typeRec ? this : new MCall(this.inner, this.s, this.doc, this.es, this.p, typeRec);
    }
  }
