  ...
  final class ClassB implements ExpCore, Ast.Atom, HasPos<ClassB> {
    ...
    public static final class NestedClass implements Member {
      ...
      public NestedClass(@NonNull final Doc doc, @NonNull final Ast.C name, @NonNull final ExpCore inner, final Position p) {
        if (doc == null) {
          throw new java.lang.NullPointerException("doc is marked @NonNull but is null");
        }
        if (name == null) {
          throw new java.lang.NullPointerException("name is marked @NonNull but is null");
        }
        if (inner == null) {
          throw new java.lang.NullPointerException("inner is marked @NonNull but is null");
        }
        this.doc = doc;
        this.name = name;
        this.inner = inner;
    ...
    public static final class MethodWithType implements Member {
      ...
      @java.lang.SuppressWarnings("all")
      public MethodWithType(@NonNull final Doc doc, @NonNull final MethodSelector ms, @NonNull final MethodType mt, final ExpCore _inner, final Position p) {
        if (doc == null) {
          throw new java.lang.NullPointerException("doc is marked @NonNull but is null");
        }
        if (ms == null) {
        ...
        if (mt == null) {
          throw new java.lang.NullPointerException("mt is marked @NonNull but is null");
        }
        this.doc = doc;
        this.ms = ms;
        this.mt = mt;
