// Generated by delombok at Sat May 02 16:48:52 NZST 2015
package ast;
...
public interface ExpCore {
  ...
  final class MCall implements ExpCore {
    ...
    public java.lang.String toString() {
      return "ExpCore.MCall(receiver=" + this.getReceiver() + ", name=" + this.getName() + ", doc=" + this.getDoc() + ", xs=" + this.getXs() + ", es=" + this.getEs() + ")";
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withSource(final Expression source) {
      return this.source == source ? this : new MCall(source, this.receiver, this.name, this.doc, this.xs, this.es);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withReceiver(final ExpCore receiver) {
      return this.receiver == receiver ? this : new MCall(this.source, receiver, this.name, this.doc, this.xs, this.es);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withName(final String name) {
      return this.name == name ? this : new MCall(this.source, this.receiver, name, this.doc, this.xs, this.es);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withDoc(final Doc doc) {
      return this.doc == doc ? this : new MCall(this.source, this.receiver, this.name, doc, this.xs, this.es);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withXs(final List<String> xs) {
      return this.xs == xs ? this : new MCall(this.source, this.receiver, this.name, this.doc, xs, this.es);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withEs(final List<ExpCore> es) {
      return this.es == es ? this : new MCall(this.source, this.receiver, this.name, this.doc, this.xs, es);
    }
  }
  ...
  final class Block implements ExpCore {
    private final Expression source;
    private final Doc doc;
    ...
    public static final class Catch {
      ...
      @java.beans.ConstructorProperties({"kind", "x", "ons"})
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Catch(final SignalKind kind, final String x, final List<On> ons) {
        this.kind = kind;
        this.x = x;
        this.ons = ons;
      }
      ...
      public boolean equals(final java.lang.Object o) {
        if (o == this) return true;
        if (!(o instanceof ExpCore.Block.Catch)) return false;
      ...
      @javax.annotation.Generated("lombok")
      public java.lang.String toString() {
        return "ExpCore.Block.Catch(kind=" + this.getKind() + ", x=" + this.getX() + ", ons=" + this.getOns() + ")";
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Catch withKind(final SignalKind kind) {
        return this.kind == kind ? this : new Catch(kind, this.x, this.ons);
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Catch withX(final String x) {
        return this.x == x ? this : new Catch(this.kind, x, this.ons);
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public Catch withOns(final List<On> ons) {
        return this.ons == ons ? this : new Catch(this.kind, this.x, ons);
      }
    }
    ...
    public static final class On {
      ...
      @java.beans.ConstructorProperties({"t", "inner"})
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public On(final Type t, final ExpCore inner) {
        this.t = t;
        this.inner = inner;
      }
      ...
      @javax.annotation.Generated("lombok")
      public java.lang.String toString() {
        return "ExpCore.Block.On(t=" + this.getT() + ", inner=" + this.getInner() + ")";
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public On withT(final Type t) {
        return this.t == t ? this : new On(t, this.inner);
      }
      
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public On withInner(final ExpCore inner) {
        return this.inner == inner ? this : new On(this.t, inner);
      }
    }
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ExpCore.Block(doc=" + this.getDoc() + ", decs=" + this.getDecs() + ", inner=" + this.getInner() + ", _catch=" + this.get_catch() + ")";
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block withSource(final Expression source) {
      return this.source == source ? this : new Block(source, this.doc, this.decs, this.inner, this._catch);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block withDoc(final Doc doc) {
      return this.doc == doc ? this : new Block(this.source, doc, this.decs, this.inner, this._catch);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block withDecs(final List<Dec> decs) {
      return this.decs == decs ? this : new Block(this.source, this.doc, decs, this.inner, this._catch);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block withInner(final ExpCore inner) {
      return this.inner == inner ? this : new Block(this.source, this.doc, this.decs, inner, this._catch);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block with_catch(final Optional<Catch> _catch) {
      return this._catch == _catch ? this : new Block(this.source, this.doc, this.decs, this.inner, _catch);
    }
  }
  ...
  final class ClassB implements ExpCore, Ast.Atom {
    ...
    public static final class NestedClass implements Member {
      ...
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public NestedClass(@NonNull final Doc doc, @NonNull final String name, @NonNull final ExpCore inner) {
        if (doc == null) {
    ...
    public static final class MethodImplemented implements Member {
      ...
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public MethodImplemented(@NonNull final Doc doc, @NonNull final MethodSelector s, @NonNull final ExpCore inner) {
        if (doc == null) {
          throw new java.lang.NullPointerException("doc");
        }
        if (s == null) {
    ...
    public static final class MethodWithType implements Member {
      ...
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public MethodWithType(@NonNull final Doc doc, @NonNull final MethodSelector ms, @NonNull final MethodType mt, @NonNull final Optional<ExpCore> inner) {
        if (doc == null) {
          throw new java.lang.NullPointerException("doc");
        }
        if (ms == null) {
  ...
  final class Using implements ExpCore {
    ...
    @java.beans.ConstructorProperties({"path", "name", "doc", "xs", "es", "inner"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Using(final Path path, final String name, final Doc doc, final List<String> xs, final List<ExpCore> es, final ExpCore inner) {
      this.path = path;
      this.name = name;
      this.doc = doc;
      this.xs = xs;
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ExpCore.Using(path=" + this.getPath() + ", name=" + this.getName() + ", doc=" + this.getDoc() + ", xs=" + this.getXs() + ", es=" + this.getEs() + ", inner=" + this.getInner() + ")";
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Using withPath(final Path path) {
      return this.path == path ? this : new Using(path, this.name, this.doc, this.xs, this.es, this.inner);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Using withName(final String name) {
      return this.name == name ? this : new Using(this.path, name, this.doc, this.xs, this.es, this.inner);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Using withDoc(final Doc doc) {
      return this.doc == doc ? this : new Using(this.path, this.name, doc, this.xs, this.es, this.inner);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Using withXs(final List<String> xs) {
      return this.xs == xs ? this : new Using(this.path, this.name, this.doc, xs, this.es, this.inner);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Using withEs(final List<ExpCore> es) {
      return this.es == es ? this : new Using(this.path, this.name, this.doc, this.xs, es, this.inner);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Using withInner(final ExpCore inner) {
      return this.inner == inner ? this : new Using(this.path, this.name, this.doc, this.xs, this.es, inner);
    }
  }
