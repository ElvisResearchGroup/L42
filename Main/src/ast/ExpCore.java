...
public interface ExpCore extends Serializable {
  ...
  final class MCall implements ExpCore, HasPos<MCall>, WithInner<MCall> {
    ...
    public MCall(final ExpCore inner, final MethodSelector s, final Doc doc, final List<ExpCore> es, final Position p, final Type typeRec, final Type typeOut) {
      this.inner = inner;
      this.s = s;
      this.doc = doc;
      this.es = es;
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.MCall other = (ExpCore.MCall) o;
    ...
    public MCall withInner(final ExpCore inner) {
      return this.inner == inner ? this : new MCall(inner, this.s, this.doc, this.es, this.p, this.typeRec, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public MCall withS(final MethodSelector s) {
      return this.s == s ? this : new MCall(this.inner, s, this.doc, this.es, this.p, this.typeRec, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public MCall withDoc(final Doc doc) {
      return this.doc == doc ? this : new MCall(this.inner, this.s, doc, this.es, this.p, this.typeRec, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public MCall withEs(final List<ExpCore> es) {
      return this.es == es ? this : new MCall(this.inner, this.s, this.doc, es, this.p, this.typeRec, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public MCall withP(final Position p) {
      return this.p == p ? this : new MCall(this.inner, this.s, this.doc, this.es, p, this.typeRec, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public MCall withTypeRec(final Type typeRec) {
      return this.typeRec == typeRec ? this : new MCall(this.inner, this.s, this.doc, this.es, this.p, typeRec, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public MCall withTypeOut(final Type typeOut) {
      return this.typeOut == typeOut ? this : new MCall(this.inner, this.s, this.doc, this.es, this.p, this.typeRec, typeOut);
    }
  }


  final class OperationDispatch implements ExpCore, HasPos<OperationDispatch> {
    private final MethodSelector s;
    private final Doc doc;
    private final List<ExpCore> es;
    private final Position p;
    ...
    @java.lang.SuppressWarnings("all")
    public OperationDispatch(final MethodSelector s, final Doc doc, final List<ExpCore> es, final Position p) {
      this.s = s;
      this.doc = doc;
      this.es = es;
      this.p = p;
    ...
    public boolean equals(final java.lang.Object o) {
      if (o == this) return true;
      if (!(o instanceof ExpCore.OperationDispatch)) return false;
      final ExpCore.OperationDispatch other = (ExpCore.OperationDispatch) o;
      final java.lang.Object this$s = this.getS();
      final java.lang.Object other$s = other.getS();
      if (this$s == null ? other$s != null : !this$s.equals(other$s)) return false;
      final java.lang.Object this$doc = this.getDoc();
    ...
    @java.lang.SuppressWarnings("all")
    public java.lang.String toString() {
      return "ExpCore.OperationDispatch(s=" + this.getS() + ", doc=" + this.getDoc() + ", es=" + this.getEs() + ")";
    }

    @java.lang.SuppressWarnings("all")
    public OperationDispatch withS(final MethodSelector s) {
      return this.s == s ? this : new OperationDispatch(s, this.doc, this.es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    public OperationDispatch withDoc(final Doc doc) {
      return this.doc == doc ? this : new OperationDispatch(this.s, doc, this.es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    public OperationDispatch withEs(final List<ExpCore> es) {
      return this.es == es ? this : new OperationDispatch(this.s, this.doc, es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    public OperationDispatch withP(final Position p) {
      return this.p == p ? this : new OperationDispatch(this.s, this.doc, this.es, p);
    }
  }
  ...
  final class UpdateVar implements ExpCore, HasPos<UpdateVar>, WithInner<UpdateVar> {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.UpdateVar other = (ExpCore.UpdateVar) o;
      final java.lang.Object this$inner = this.getInner();
      final java.lang.Object other$inner = other.getInner();
      if (this$inner == null ? other$inner != null : !this$inner.equals(other$inner)) return false;
  ...
  final class X implements ExpCore, Ast.Atom, HasPos<X> {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.X other = (ExpCore.X) o;
      final java.lang.Object this$inner = this.getInner();
      final java.lang.Object other$inner = other.getInner();
      if (this$inner == null ? other$inner != null : !this$inner.equals(other$inner)) return false;
      return true;
  ...
  final class Block implements ExpCore, HasPos<Block>, WithInner<Block> {
    ...
    public static final class Dec implements WithInner<Dec>, Serializable {
      ...
      @java.lang.SuppressWarnings("all")
      public Dec(final boolean isVar, final Type _t, final String x, final ExpCore inner) {
        this.isVar = isVar;
        this._t = _t;
        this.x = x;
        this.inner = inner;
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        final ExpCore.Block.Dec other = (ExpCore.Block.Dec) o;
        if (this.isVar() != other.isVar()) return false;
        final java.lang.Object this$_t = this.get_t();
        final java.lang.Object other$_t = other.get_t();
      ...
      public int hashCode() {
        ...
        final java.lang.Object $_t = this.get_t();
      ...
      @java.lang.SuppressWarnings("all")
      public java.lang.String toString() {
        return "ExpCore.Block.Dec(isVar=" + this.isVar() + ", _t=" + this.get_t() + ", x=" + this.getX() + ", inner=" + this.getInner() + ")";
      }

      @java.lang.SuppressWarnings("all")
      public Dec withVar(final boolean isVar) {
        return this.isVar == isVar ? this : new Dec(isVar, this._t, this.x, this.inner);
      }

      @java.lang.SuppressWarnings("all")
      public Dec with_t(final Type _t) {
        return this._t == _t ? this : new Dec(this.isVar, _t, this.x, this.inner);
      }

      @java.lang.SuppressWarnings("all")
      public Dec withX(final String x) {
        return this.x == x ? this : new Dec(this.isVar, this._t, x, this.inner);
      }

      @java.lang.SuppressWarnings("all")
      public Dec withInner(final ExpCore inner) {
        return this.inner == inner ? this : new Dec(this.isVar, this._t, this.x, inner);
      }
    }
    ...
    public static final class On implements HasPos<On>, WithInner<On>, Serializable {
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        final ExpCore.Block.On other = (ExpCore.Block.On) o;
    ...
    @java.lang.SuppressWarnings("all")
    public Block(final Doc doc, final List<Dec> decs, final ExpCore inner, final List<On> ons, final Position p, final Type typeOut) {
      this.doc = doc;
      this.decs = decs;
      this.inner = inner;
      this.ons = ons;
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.Block other = (ExpCore.Block) o;
      final java.lang.Object this$doc = this.getDoc();
      final java.lang.Object other$doc = other.getDoc();
      if (this$doc == null ? other$doc != null : !this$doc.equals(other$doc)) return false;
    ...
    public int hashCode() {
      ...
      result = result * PRIME + ($decs == null ? 43 : $decs.hashCode());
      final java.lang.Object $inner = this.getInner();
      result = result * PRIME + ($inner == null ? 43 : $inner.hashCode());
      final java.lang.Object $ons = this.getOns();
      result = result * PRIME + ($ons == null ? 43 : $ons.hashCode());
      return result;
    }
    ...
    public Block withDoc(final Doc doc) {
      return this.doc == doc ? this : new Block(doc, this.decs, this.inner, this.ons, this.p, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public Block withDecs(final List<Dec> decs) {
      return this.decs == decs ? this : new Block(this.doc, decs, this.inner, this.ons, this.p, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public Block withInner(final ExpCore inner) {
      return this.inner == inner ? this : new Block(this.doc, this.decs, inner, this.ons, this.p, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public Block withOns(final List<On> ons) {
      return this.ons == ons ? this : new Block(this.doc, this.decs, this.inner, ons, this.p, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public Block withP(final Position p) {
      return this.p == p ? this : new Block(this.doc, this.decs, this.inner, this.ons, p, this.typeOut);
    }

    @java.lang.SuppressWarnings("all")
    public Block withTypeOut(final Type typeOut) {
      return this.typeOut == typeOut ? this : new Block(this.doc, this.decs, this.inner, this.ons, this.p, typeOut);
    }
  }
  ...
  final class ClassB implements ExpCore, Ast.Atom, HasPos<ClassB> {
    ...
    public MethodWithType _getMwt(ast.Ast.MethodSelector ms) {
      return (ClassB.MethodWithType) (this._getMember(ms));
    }
    ...
    public static ExpCore.ClassB docClass(Doc d) {
      return new ClassB(d, false, Collections.emptyList(), Collections.emptyList(), Position.noInfo, Phase.Typed, -2);
    }

    public static ExpCore.ClassB membersClass(List<Member> ms, Position pos, Phase phase) {
      return new ClassB(Doc.empty(), false, Collections.emptyList(), ms, pos, phase, -2);
    }

    public Set<MethodSelector> msDom() {
      return this.mwts().stream().map(MethodWithType::getMs).collect(Collectors.toSet());
    }

    public Set<Ast.C> cDom() {
      return this.ns().stream().map(NestedClass::getName).collect(Collectors.toSet());
    }
    ...
    public static final class NestedClass implements Member {
      ...
      @java.lang.SuppressWarnings("all")
      public NestedClass(final Doc doc, final Ast.C name, final ExpCore inner, final Position p) {
        this.doc = doc;
        this.name = name;
        this.inner = inner;
        this.p = p;
      ...
      @java.lang.SuppressWarnings("all")
      public NestedClass withInner(final ExpCore inner) {
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        final ExpCore.ClassB.NestedClass other = (ExpCore.ClassB.NestedClass) o;
        final java.lang.Object this$doc = this.getDoc();
        final java.lang.Object other$doc = other.getDoc();
        if (this$doc == null ? other$doc != null : !this$doc.equals(other$doc)) return false;
    ...
    public static final class MethodImplemented implements Member {
      ...
      @java.lang.SuppressWarnings("all")
      public MethodImplemented(final Doc doc, final MethodSelector s, final ExpCore inner, final Position p) {
        this.doc = doc;
        this.s = s;
        this.inner = inner;
        this.p = p;
      ...
      @java.lang.SuppressWarnings("all")
      public MethodImplemented withInner(final ExpCore inner) {
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        final ExpCore.ClassB.MethodImplemented other = (ExpCore.ClassB.MethodImplemented) o;
        final java.lang.Object this$doc = this.getDoc();
        final java.lang.Object other$doc = other.getDoc();
        if (this$doc == null ? other$doc != null : !this$doc.equals(other$doc)) return false;
        final java.lang.Object this$s = this.getS();
    ...
    public static final class MethodWithType implements Member {
      ...
      public int getSize() {
        return this.getMs().getNames().size();
      }

      public List<String> getXs() {
        return this.getMs().getNames();
      }

      public List<Mdf> getMdfs() {
        return this.getMt().getTs().stream().map(Type::getMdf).collect(Collectors.toList());
      }

      public List<Path> getPaths() {
        return this.getMt().getTs().stream().map(Type::getPath).collect(Collectors.toList());
      }

      public List<Path> getExceptions() {
        return this.getMt().getExceptions().stream().map(Type::getPath).collect(Collectors.toList());
      }

      public Mdf getMdf() {
        return this.getMt().getMdf();
      }

      public Mdf getReturnMdf() {
        return this.getMt().getReturnType().getMdf();
      }

      public Path getReturnPath() {
        return this.getMt().getReturnType().getPath();
      }

      public Type getReturnType() {
        return this.getMt().getReturnType();
      }

      @java.lang.SuppressWarnings("all")
      public MethodWithType(final Doc doc, final MethodSelector ms, final MethodType mt, final ExpCore _inner, final Position p) {
        this.doc = doc;
        this.ms = ms;
        this.mt = mt;
        this._inner = _inner;
      ...
      @java.lang.SuppressWarnings("all")
      public MethodWithType with_inner(final ExpCore _inner) {
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        final ExpCore.ClassB.MethodWithType other = (ExpCore.ClassB.MethodWithType) o;
        final java.lang.Object this$doc = this.getDoc();
        final java.lang.Object other$doc = other.getDoc();
        if (this$doc == null ? other$doc != null : !this$doc.equals(other$doc)) return false;
      ...
      public int hashCode() {
        ...
        result = result * PRIME + ($_inner == null ? 43 : $_inner.hashCode());
        return result;
      }
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.ClassB other = (ExpCore.ClassB) o;
    ...
    public int hashCode() {
      ...
      result = result * PRIME + ($doc1 == null ? 43 : $doc1.hashCode());
  ...
  final class EPath implements ExpCore, HasPos<EPath>, Atom {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.EPath other = (ExpCore.EPath) o;
      final java.lang.Object this$inner = this.getInner();
      final java.lang.Object other$inner = other.getInner();
      if (this$inner == null ? other$inner != null : !this$inner.equals(other$inner)) return false;
      return true;
  ...
  final class Using implements ExpCore, WithInner<Using> {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.Using other = (ExpCore.Using) o;
  ...
  final class Signal implements ExpCore, WithInner<Signal> {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.Signal other = (ExpCore.Signal) o;
      final java.lang.Object this$kind = this.getKind();
      final java.lang.Object other$kind = other.getKind();
      if (this$kind == null ? other$kind != null : !this$kind.equals(other$kind)) return false;
      final java.lang.Object this$inner = this.getInner();
  ...
  final class Loop implements ExpCore, WithInner<Loop> {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final ExpCore.Loop other = (ExpCore.Loop) o;
      final java.lang.Object this$inner = this.getInner();
      final java.lang.Object other$inner = other.getInner();
      if (this$inner == null ? other$inner != null : !this$inner.equals(other$inner)) return false;
      return true;
