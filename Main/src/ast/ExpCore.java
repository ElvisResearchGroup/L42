// Generated by delombok at Mon Aug 10 18:58:42 NZST 2015
package ast;
...
public interface ExpCore {
  ...
  final class MCall implements ExpCore, HasPos {
    ...
    @java.beans.ConstructorProperties({"receiver", "name", "doc", "xs", "es", "p"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall(final ExpCore receiver, final String name, final Doc doc, final List<String> xs, final List<ExpCore> es, final Position p) {
    ...
    public MCall withReceiver(final ExpCore receiver) {
      return this.receiver == receiver ? this : new MCall(receiver, this.name, this.doc, this.xs, this.es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withName(final String name) {
      return this.name == name ? this : new MCall(this.receiver, name, this.doc, this.xs, this.es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withDoc(final Doc doc) {
      return this.doc == doc ? this : new MCall(this.receiver, this.name, doc, this.xs, this.es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withXs(final List<String> xs) {
      return this.xs == xs ? this : new MCall(this.receiver, this.name, this.doc, xs, this.es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withEs(final List<ExpCore> es) {
      return this.es == es ? this : new MCall(this.receiver, this.name, this.doc, this.xs, es, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MCall withP(final Position p) {
      return this.p == p ? this : new MCall(this.receiver, this.name, this.doc, this.xs, this.es, p);
    }
  }
  ...
  final class Block implements ExpCore, HasPos {
    ...
    public Block withDoc(final Doc doc) {
      return this.doc == doc ? this : new Block(doc, this.decs, this.inner, this._catch, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block withDecs(final List<Dec> decs) {
      return this.decs == decs ? this : new Block(this.doc, decs, this.inner, this._catch, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block withInner(final ExpCore inner) {
      return this.inner == inner ? this : new Block(this.doc, this.decs, inner, this._catch, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block with_catch(final Optional<Catch> _catch) {
      return this._catch == _catch ? this : new Block(this.doc, this.decs, this.inner, _catch, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Block withP(final Position p) {
      return this.p == p ? this : new Block(this.doc, this.decs, this.inner, this._catch, p);
    }
  }
  ...
  final class ClassB implements ExpCore, Ast.Atom {
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ExpCore.ClassB(doc1=" + this.getDoc1() + ", doc2=" + this.getDoc2() + ", isInterface=" + this.isInterface() + ", supertypes=" + this.getSupertypes() + ", ms=" + this.getMs() + ", stage=" + this.getStage() + ")";
    }
