...
public interface ExpCore {
	...
	final class Block implements ExpCore, HasPos {
		...
		public static final class On {
			...
			@java.beans.ConstructorProperties({"kind", "x", "t", "inner"})
			@java.lang.SuppressWarnings("all")
			@javax.annotation.Generated("lombok")
			public On(final SignalKind kind, final String x, final Type t, final ExpCore inner) {
				this.kind = kind;
				this.x = x;
				this.t = t;
				this.inner = inner;
			...
			public On withKind(final SignalKind kind) {
				return this.kind == kind ? this : new On(kind, this.x, this.t, this.inner);
			}
			
			@java.lang.SuppressWarnings("all")
			@javax.annotation.Generated("lombok")
			public On withX(final String x) {
				return this.x == x ? this : new On(this.kind, x, this.t, this.inner);
			}
			
			@java.lang.SuppressWarnings("all")
			@javax.annotation.Generated("lombok")
			public On withT(final Type t) {
				return this.t == t ? this : new On(this.kind, this.x, t, this.inner);
			}
			
			@java.lang.SuppressWarnings("all")
			@javax.annotation.Generated("lombok")
			public On withInner(final ExpCore inner) {
				return this.inner == inner ? this : new On(this.kind, this.x, this.t, inner);
			}
		}
