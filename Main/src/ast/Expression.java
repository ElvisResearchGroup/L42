...
public interface Expression extends Ast {
  ...
  final class With implements Expression, HasPos {
    ...
    public static final class On {
      ...
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public On(final List<NormType> ts, final Expression inner) {
        this.ts = ts;
        this.inner = inner;
      }
      ...
      @java.lang.SuppressWarnings("all")
      @javax.annotation.Generated("lombok")
      public On withTs(final List<NormType> ts) {
  ...
  final class Catch1 implements Catch {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Catch1(final Position p, final SignalKind kind, final NormType t, final String x, final Expression inner) {
      this.p = p;
      this.kind = kind;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Catch1 withT(final NormType t) {
  ...
  final class CatchMany implements Catch {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CatchMany(final Position p, final SignalKind kind, final List<NormType> ts, final Expression inner) {
      this.p = p;
      this.kind = kind;
      this.ts = ts;
      this.inner = inner;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CatchMany withTs(final List<NormType> ts) {
  ...
  final class CatchProp implements Catch {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CatchProp(final Position p, final SignalKind kind, final List<NormType> ts, final Expression inner) {
      this.p = p;
      this.kind = kind;
      this.ts = ts;
      this.inner = inner;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CatchProp withTs(final List<NormType> ts) {
  ...
  final class ClassB implements Expression, Ast.Atom, HasPos {
    ...
    private final List<NormType> supertypes;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public List<NormType> getSupertypes() {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withSupertypes(final List<NormType> supertypes) {
