...
/*@ToString(exclude = "p")*/
  ...
  final class ClassB implements Expression, Ast.Atom, HasPos {
    ...
    public ClassB withDoc1(final Doc doc1) {
      return this.doc1 == doc1 ? this : new ClassB(doc1, this.h, this.fields, this.supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withH(final Header h) {
      return this.h == h ? this : new ClassB(this.doc1, h, this.fields, this.supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withFields(final List<Ast.FieldDec> fields) {
      return this.fields == fields ? this : new ClassB(this.doc1, this.h, fields, this.supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withSupertypes(final List<Type> supertypes) {
      return this.supertypes == supertypes ? this : new ClassB(this.doc1, this.h, this.fields, supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withMs(final List<Member> ms) {
      return this.ms == ms ? this : new ClassB(this.doc1, this.h, this.fields, this.supertypes, ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withP(final Position p) {
      return this.p == p ? this : new ClassB(this.doc1, this.h, this.fields, this.supertypes, this.ms, p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withStage(final Stage stage) {
      return this.stage == stage ? this : new ClassB(this.doc1, this.h, this.fields, this.supertypes, this.ms, this.p, stage);
    }
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "Expression.ClassB(doc1=" + this.getDoc1() + ", h=" + this.getH() + ", fields=" + this.getFields() + ", supertypes=" + this.getSupertypes() + ", ms=" + this.getMs() + ", stage=" + this.getStage() + ")";
    }
  }
