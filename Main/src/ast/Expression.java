...
/*@ToString(exclude = "p")*/
  ...
  final class ClassB implements Expression, Ast.Atom, HasPos {
    ...
    public ClassB withDoc1(final Doc doc1) {
      return this.doc1 == doc1 ? this : new ClassB(doc1, this.doc2, this.h, this.supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withDoc2(final Doc doc2) {
      return this.doc2 == doc2 ? this : new ClassB(this.doc1, doc2, this.h, this.supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withH(final Header h) {
      return this.h == h ? this : new ClassB(this.doc1, this.doc2, h, this.supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withSupertypes(final List<Path> supertypes) {
      return this.supertypes == supertypes ? this : new ClassB(this.doc1, this.doc2, this.h, supertypes, this.ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withMs(final List<Member> ms) {
      return this.ms == ms ? this : new ClassB(this.doc1, this.doc2, this.h, this.supertypes, ms, this.p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withP(final Position p) {
      return this.p == p ? this : new ClassB(this.doc1, this.doc2, this.h, this.supertypes, this.ms, p, this.stage);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ClassB withStage(final Stage stage) {
      return this.stage == stage ? this : new ClassB(this.doc1, this.doc2, this.h, this.supertypes, this.ms, this.p, stage);
    }
