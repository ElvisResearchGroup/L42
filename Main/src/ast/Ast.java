// Generated by delombok at Sun Jan 08 17:20:25 ICT 2017
package ast;
...
public interface Ast {
  ...
  final class NormType implements Type {
    ...
    @java.beans.ConstructorProperties({"mdf", "path", "ph", "doc"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType(final Mdf mdf, final Path path, final Ph ph, final Doc doc) {
      this.mdf = mdf;
      this.path = path;
      this.ph = ph;
      this.doc = doc;
    ...
    public NormType withMdf(final Mdf mdf) {
      return this.mdf == mdf ? this : new NormType(mdf, this.path, this.ph, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType withPath(final Path path) {
      return this.path == path ? this : new NormType(this.mdf, path, this.ph, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType withPh(final Ph ph) {
      return this.ph == ph ? this : new NormType(this.mdf, this.path, ph, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType withDoc(final Doc doc) {
      return this.doc == doc ? this : new NormType(this.mdf, this.path, this.ph, doc);
    }
  }
  ...
  final class HistoricType implements Type {
    ...
    @java.beans.ConstructorProperties({"path", "selectors", "forcePlaceholder", "doc"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType(final Path path, final List<MethodSelectorX> selectors, final boolean forcePlaceholder, final Doc doc) {
      this.path = path;
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "Ast.HistoricType(path=" + this.getPath() + ", selectors=" + this.getSelectors() + ", forcePlaceholder=" + this.isForcePlaceholder() + ", doc=" + this.getDoc() + ")";
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType withPath(final Path path) {
      return this.path == path ? this : new HistoricType(path, this.selectors, this.forcePlaceholder, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType withSelectors(final List<MethodSelectorX> selectors) {
      return this.selectors == selectors ? this : new HistoricType(this.path, selectors, this.forcePlaceholder, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType withForcePlaceholder(final boolean forcePlaceholder) {
      return this.forcePlaceholder == forcePlaceholder ? this : new HistoricType(this.path, this.selectors, forcePlaceholder, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType withDoc(final Doc doc) {
      return this.doc == doc ? this : new HistoricType(this.path, this.selectors, this.forcePlaceholder, doc);
    }
  }
  ...
  final class MethodType {
    ...
    @java.beans.ConstructorProperties({"refine", "docExceptions", "mdf", "ts", "returnType", "exceptions"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodType(final boolean refine, final Doc docExceptions, final Mdf mdf, final List<Type> ts, final Type returnType, final List<Path> exceptions) {
      this.refine = refine;
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "Ast.MethodType(refine=" + this.isRefine() + ", docExceptions=" + this.getDocExceptions() + ", mdf=" + this.getMdf() + ", ts=" + this.getTs() + ", returnType=" + this.getReturnType() + ", exceptions=" + this.getExceptions() + ")";
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodType withRefine(final boolean refine) {
      return this.refine == refine ? this : new MethodType(refine, this.docExceptions, this.mdf, this.ts, this.returnType, this.exceptions);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodType withDocExceptions(final Doc docExceptions) {
      return this.docExceptions == docExceptions ? this : new MethodType(this.refine, docExceptions, this.mdf, this.ts, this.returnType, this.exceptions);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodType withMdf(final Mdf mdf) {
      return this.mdf == mdf ? this : new MethodType(this.refine, this.docExceptions, mdf, this.ts, this.returnType, this.exceptions);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodType withTs(final List<Type> ts) {
      return this.ts == ts ? this : new MethodType(this.refine, this.docExceptions, this.mdf, ts, this.returnType, this.exceptions);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodType withReturnType(final Type returnType) {
      return this.returnType == returnType ? this : new MethodType(this.refine, this.docExceptions, this.mdf, this.ts, returnType, this.exceptions);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodType withExceptions(final List<Path> exceptions) {
      return this.exceptions == exceptions ? this : new MethodType(this.refine, this.docExceptions, this.mdf, this.ts, this.returnType, exceptions);
    }
  }
  /* @ToString(exclude="n") */
  final class Path implements Expression, ExpCore, Atom {
    ...
    public NormType toImmNT() {
      return new NormType(Mdf.Immutable, this, Ph.None, Doc.empty());
    }
  ...
  final class Doc {
    ...
    private static int readAnnotation(String s, int start, List<Object> paths) {
      ...
      for (int i = start; i < s.length(); i++) {
        char ci = s.charAt(i);
        if (Path.isValidPathChar(ci)) {
          sb.append(ci);
        } else if (ci == '.' && isPath && i + 1 < s.length() && Path.isValidPathStart(s.charAt(i + 1))) {
          sb.append(ci);
        } else {
          break;
        }
    ...
    @java.beans.ConstructorProperties({"multiline", "s", "annotations", "parameters"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Doc(final boolean multiline, final String s, final List<Object> annotations, final List<String> parameters) {
    ...
    public Doc withMultiline(final boolean multiline) {
      return this.multiline == multiline ? this : new Doc(multiline, this.s, this.annotations, this.parameters);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Doc withS(final String s) {
      return this.s == s ? this : new Doc(this.multiline, s, this.annotations, this.parameters);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Doc withAnnotations(final List<Object> annotations) {
      return this.annotations == annotations ? this : new Doc(this.multiline, this.s, annotations, this.parameters);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Doc withParameters(final List<String> parameters) {
      return this.parameters == parameters ? this : new Doc(this.multiline, this.s, this.annotations, parameters);
    }
  }
  ...
  interface HasReceiver extends HasPos, Expression {
