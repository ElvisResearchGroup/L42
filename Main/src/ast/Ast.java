...
public interface Ast {
  ...
  final class C {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final java.lang.Object other$inner = other.getInner();
      if (this$inner == null ? other$inner != null : !this$inner.equals(other$inner)) return false;
      if (this.getPrivateNum() != other.getPrivateNum()) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      final java.lang.Object $inner = this.getInner();
      result = result * PRIME + ($inner == null ? 0 : $inner.hashCode());
      final long $privateNum = this.getPrivateNum();
      result = result * PRIME + (int)($privateNum >>> 32 ^ $privateNum);
      return result;
    }
    ...
    public C withInner(final String inner) {
      return this.inner == inner ? this : new C(inner, this.privateNum);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public C withPrivateNum(final long privateNum) {
      return this.privateNum == privateNum ? this : new C(this.inner, privateNum);
    }
  }
  //-------------------
  abstract class Path implements Expression, ExpCore, Atom {
  ...
  final class Doc implements Expression.HasPos {
