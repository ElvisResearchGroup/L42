...
public interface Ast {
	...
	final class MethodType {
		...
		@java.beans.ConstructorProperties({"refine", "docExceptions", "mdf", "ts", "tDocs", "returnType", "exceptions"})
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType(final boolean refine, final Doc docExceptions, final Mdf mdf, final List<Type> ts, final List<Doc> tDocs, final Type returnType, final List<Path> exceptions) {
			this.refine = refine;
		...
		@javax.annotation.Generated("lombok")
		public java.lang.String toString() {
			return "Ast.MethodType(refine=" + this.isRefine() + ", docExceptions=" + this.getDocExceptions() + ", mdf=" + this.getMdf() + ", ts=" + this.getTs() + ", tDocs=" + this.getTDocs() + ", returnType=" + this.getReturnType() + ", exceptions=" + this.getExceptions() + ")";
		}
		
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType withRefine(final boolean refine) {
			return this.refine == refine ? this : new MethodType(refine, this.docExceptions, this.mdf, this.ts, this.tDocs, this.returnType, this.exceptions);
		}
		
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType withDocExceptions(final Doc docExceptions) {
			return this.docExceptions == docExceptions ? this : new MethodType(this.refine, docExceptions, this.mdf, this.ts, this.tDocs, this.returnType, this.exceptions);
		}
		
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType withMdf(final Mdf mdf) {
			return this.mdf == mdf ? this : new MethodType(this.refine, this.docExceptions, mdf, this.ts, this.tDocs, this.returnType, this.exceptions);
		}
		
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType withTs(final List<Type> ts) {
			return this.ts == ts ? this : new MethodType(this.refine, this.docExceptions, this.mdf, ts, this.tDocs, this.returnType, this.exceptions);
		}
		
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType withTDocs(final List<Doc> tDocs) {
			return this.tDocs == tDocs ? this : new MethodType(this.refine, this.docExceptions, this.mdf, this.ts, tDocs, this.returnType, this.exceptions);
		}
		
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType withReturnType(final Type returnType) {
			return this.returnType == returnType ? this : new MethodType(this.refine, this.docExceptions, this.mdf, this.ts, this.tDocs, returnType, this.exceptions);
		}
		
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public MethodType withExceptions(final List<Path> exceptions) {
			return this.exceptions == exceptions ? this : new MethodType(this.refine, this.docExceptions, this.mdf, this.ts, this.tDocs, this.returnType, exceptions);
		}
	}
	/* @ToString(exclude="n") */
