...
public interface Ast {
  ...
  final class NormType implements Type {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType(final Mdf mdf, final Path path, final Doc doc) {
      this.mdf = mdf;
      this.path = path;
      this.doc = doc;
    }
    ...
    public NormType withMdf(final Mdf mdf) {
      return this.mdf == mdf ? this : new NormType(mdf, this.path, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType withPath(final Path path) {
      return this.path == path ? this : new NormType(this.mdf, path, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType withDoc(final Doc doc) {
      return this.doc == doc ? this : new NormType(this.mdf, this.path, doc);
    }
  }
  ...
  final class HistoricType implements Type {
    ...
    @java.beans.ConstructorProperties({"path", "selectors", "doc"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType(final Path path, final List<MethodSelectorX> selectors, final Doc doc) {
      this.path = path;
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "Ast.HistoricType(path=" + this.getPath() + ", selectors=" + this.getSelectors() + ", doc=" + this.getDoc() + ")";
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType withPath(final Path path) {
      return this.path == path ? this : new HistoricType(path, this.selectors, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType withSelectors(final List<MethodSelectorX> selectors) {
      return this.selectors == selectors ? this : new HistoricType(this.path, selectors, this.doc);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HistoricType withDoc(final Doc doc) {
      return this.doc == doc ? this : new HistoricType(this.path, this.selectors, doc);
    }
  }
  ...
  abstract class Path implements Expression, ExpCore, Atom {
    ...
    public NormType toImmNT() {
      return new NormType(Mdf.Immutable, this, Doc.empty());
    }
