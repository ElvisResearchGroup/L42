...
public interface Ast {
	...
	final class Doc {
		...
		@java.beans.ConstructorProperties({"multiline", "s", "annotations"})
		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public Doc(final boolean multiline, final String s, final List<Object> annotations) {
		...
		public Doc withMultiline(final boolean multiline) {
			return this.multiline == multiline ? this : new Doc(multiline, this.s, this.annotations);
		}

		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public Doc withS(final String s) {
			return this.s == s ? this : new Doc(this.multiline, s, this.annotations);
		}

		@java.lang.SuppressWarnings("all")
		@javax.annotation.Generated("lombok")
		public Doc withAnnotations(final List<Object> annotations) {
			return this.annotations == annotations ? this : new Doc(this.multiline, this.s, annotations);
		}
	}
