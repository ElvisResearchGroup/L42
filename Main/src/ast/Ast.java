...
public interface Ast {
	...
	final class Path implements Expression, ExpCore, Atom {
		...
		public Path(List<String> rowData) {
			assert !rowData.get(0).contains("-") : rowData;// as in This-1 :-(
			assert !rowData.get(0).contains("_") : rowData;// as in This_ //TODO:just for testing, remove later
			rowData = Collections.unmodifiableList(rowData);
			this.rowData = rowData;
	...
	final class Position {
		...
		public Position(final String file, final int line1, final int pos1, final int line2, final int pos2) {
			...
			this.line2 = line2;
			this.pos2 = pos2;
			if(file!=null && file.contains("localhost/AdamTowel01.L42") && line1==2 && line2==1880){
