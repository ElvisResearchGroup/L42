...
public interface Ast {
  ...
  final class Doc implements Expression.HasPos {
    ...
    public Doc withS(final String s) {
      return this.s == s ? this : new Doc(this.multiline, s, this.annotations, this.parameters, this.p);
    }
    
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Doc withAnnotations(final List<Object> annotations) {
      return this.annotations == annotations ? this : new Doc(this.multiline, this.s, annotations, this.parameters, this.p);
    }
