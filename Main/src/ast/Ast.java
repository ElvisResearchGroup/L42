...
public interface Ast {
  ...
  final class Parameters {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.Parameters other = (Ast.Parameters) o;
  ...
  final class VarDecXE implements VarDec {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.VarDecXE other = (Ast.VarDecXE) o;
  ...
  final class VarDecE implements VarDec {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.VarDecE other = (Ast.VarDecE) o;
      final java.lang.Object this$inner = this.getInner();
      final java.lang.Object other$inner = other.getInner();
      if (this$inner == null ? other$inner != null : !this$inner.equals(other$inner)) return false;
      return true;
  ...
  final class VarDecCE implements VarDec {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.VarDecCE other = (Ast.VarDecCE) o;
      final java.lang.Object this$inner = this.getInner();
      final java.lang.Object other$inner = other.getInner();
      if (this$inner == null ? other$inner != null : !this$inner.equals(other$inner)) return false;
      return true;
  ...
  final class ConcreteHeader implements Header, Expression.HasPos<ConcreteHeader> {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.ConcreteHeader other = (Ast.ConcreteHeader) o;
    ...
    public int hashCode() {
      ...
      result = result * PRIME + ($fs == null ? 43 : $fs.hashCode());
      return result;
    }
  ...
  final class FieldDec {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.FieldDec other = (Ast.FieldDec) o;
      if (this.isVar() != other.isVar()) return false;
      final java.lang.Object this$t = this.getT();
      final java.lang.Object other$t = other.getT();
      if (this$t == null ? other$t != null : !this$t.equals(other$t)) return false;
  ...
  final class Type implements Serializable {
    ...
    public static Type of(Path P) {
      return new Type(Mdf.Immutable, P, Doc.empty());
    }
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.Type other = (Ast.Type) o;
      final java.lang.Object this$mdf = this.getMdf();
      final java.lang.Object other$mdf = other.getMdf();
      if (this$mdf == null ? other$mdf != null : !this$mdf.equals(other$mdf)) return false;
  ...
  final class MethodSelector implements Serializable {
    private final String name;
    ...
    public String name(int that) {
      return this.names.get(that);
    }
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.MethodSelector other = (Ast.MethodSelector) o;
      final java.lang.Object this$name = this.getName();
      final java.lang.Object other$name = other.getName();
      if (this$name == null ? other$name != null : !this$name.equals(other$name)) return false;
  ...
  final class MethodType implements Serializable {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.MethodType other = (Ast.MethodType) o;
  ...
  //-------------------
  abstract class Path implements Serializable {
    ...
    public int tryOuterNumber() {
      return this instanceof PathCore ? this.outerNumber() : -1;
    }
  ...
  final class Doc implements Expression.HasPos<Doc>, Serializable {
  ...
  enum Mdf {
    Immutable(""), Mutable("mut"), Readable("read"), Lent("lent"), Capsule("capsule"), Class("class"), ImmutableFwd("fwd"), ImmutablePFwd("%fwd"), MutableFwd("fwd mut"), MutablePFwd("%fwd mut");
    ...
    public boolean isImm() {
      return this == Mdf.Immutable;
    }

    public boolean isMut() {
      return this == Mdf.Mutable;
    }

    public boolean isRead() {
      return this == Mdf.Readable;
    }

    public boolean isLent() {
      return this == Mdf.Lent;
    }

    public boolean isCapsule() {
      return this == Mdf.Capsule;
    }

    public boolean isClass() {
      return this == Mdf.Class;
    }

    public boolean isFwdImm() {
      return this == Mdf.ImmutableFwd;
    }

    public boolean isFwdPImm() {
      return this == Mdf.ImmutablePFwd;
    }

    public boolean isFwdMut() {
      return this == Mdf.MutableFwd;
    }

    public boolean isFwdPMut() {
      return this == Mdf.MutablePFwd;
    }

    public boolean isIn(Mdf a, Mdf b) {
      return this == a || this == b;
    }

    public boolean isIn(Mdf a, Mdf b, Mdf c) {
      return this == a || this == b || this == c;
    }

    public boolean isIn(Mdf a, Mdf b, Mdf c, Mdf d) {
  ...
  enum Stage {
    None(""), Less("##less"), ToIterate("##toIterateTemp"), 
    // Meta("##meta"),
    Plus("##plus"), Star("##star");
    // Needed("##needed"),
    // Needable("##needable");
  ...
  final class Position implements Serializable {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final Ast.Position other = (Ast.Position) o;
    ...
    public int hashCode() {
      ...
      result = result * PRIME + ($_next == null ? 43 : $_next.hashCode());
      return result;
    }
