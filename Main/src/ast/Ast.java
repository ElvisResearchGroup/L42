...
public interface Ast {
  ...
  final class ConcreteHeader implements Header {
    ...
    @java.beans.ConstructorProperties({"mdf", "name", "fs"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConcreteHeader(final Mdf mdf, final String name, final List<FieldDec> fs) {
      this.mdf = mdf;
      this.name = name;
      this.fs = fs;
    }
    ...
    public ConcreteHeader withMdf(final Mdf mdf) {
      return this.mdf == mdf ? this : new ConcreteHeader(mdf, this.name, this.fs);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConcreteHeader withName(final String name) {
      return this.name == name ? this : new ConcreteHeader(this.mdf, name, this.fs);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConcreteHeader withFs(final List<FieldDec> fs) {
      return this.fs == fs ? this : new ConcreteHeader(this.mdf, this.name, fs);
    }
  }
  ...
  final class MethodSelector {
    ...
    public static MethodSelector parse(String s) {
      ...
      if (last == ')') {
        ...
        String parentesis=s.substring(i + 1, s.length() - 1);
        if(!parentesis.trim().isEmpty()){
          String[] names = parentesis.split(",");//single representation required
          for (String si : names) {
            assert checkX(si, false): "|"+si+"|"+parentesis;
            xs.add(si);
          }
        }
      }
    ...
    @java.beans.ConstructorProperties({"name", "names"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodSelector(final String name, final List<String> names) {
      this.name = name;
      this.names = names;
    }
...
/*@ToString(exclude="n")*/
  ...
  static boolean isValidPathStart(char c) {
    if (c == '%') {
      return true;
    }
    if (c == '$') {
  ...
  final class Doc {
    ...
    public boolean isPrivate() {
      if (this.toString().startsWith("@private")) {
        return true;
      }
    ...
    private static int readPath(String s, int start, List<Path> paths) {
      ...
      for (int i = start; i < s.length(); i++) {
        char ci = s.charAt(i);
        //missing % _ and $
        if (ci == ':' || Character.isAlphabetic(ci) || Character.isDigit(ci)) {
          sb.append(ci);
        } else {
    ...
    @java.beans.ConstructorProperties({"s", "paths"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Doc(final String s, final List<Path> paths) {
      this.s = s;
      this.paths = paths;
    }
    ...
    public Doc withS(final String s) {
      return this.s == s ? this : new Doc(s, this.paths);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Doc withPaths(final List<Path> paths) {
      return this.paths == paths ? this : new Doc(this.s, paths);
    }
  }
