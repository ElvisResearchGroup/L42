// Generated by delombok at Sun Aug 13 10:59:22 NZST 2017
package ast;
...
public abstract class ErrorMessage extends RuntimeException {
  ...
  public static final class MethodNotPresent extends TypeError implements PosImprove {
    ...
    @java.beans.ConstructorProperties({"path", "ms", "call", "pos"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent(final Path path, final MethodSelector ms, final ExpCore.MCall call, final Position pos) {
      this.path = path;
      this.ms = ms;
      this.call = call;
      this.pos = pos;
    ...
    public MethodNotPresent withPath(final Path path) {
      return this.path == path ? this : new MethodNotPresent(path, this.ms, this.call, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent withMs(final MethodSelector ms) {
      return this.ms == ms ? this : new MethodNotPresent(this.path, ms, this.call, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent withCall(final ExpCore.MCall call) {
      return this.call == call ? this : new MethodNotPresent(this.path, this.ms, call, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent withPos(final Position pos) {
      return this.pos == pos ? this : new MethodNotPresent(this.path, this.ms, this.call, pos);
    }
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ErrorMessage.MethodNotPresent(super=" + super.toString() + ", path=" + this.getPath() + ", ms=" + this.getMs() + ", call=" + this.getCall() + ", pos=" + this.getPos() + ")";
    }
  }
