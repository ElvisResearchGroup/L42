// Generated by delombok at Fri Apr 22 17:14:39 NZST 2016
package ast;
...
public abstract class ErrorMessage extends RuntimeException {
  ...
  public static final class IncoherentMwts extends ErrorMessage implements PosImprove {
    ...
    private final List<String> exploredPath;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IncoherentMwts(final ast.Ast.MethodSelector guilty, final List<String> exploredPath, final List<PathMwt> incoherent, final Ast.Position pos) {
      this.guilty = guilty;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public List<String> getExploredPath() {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IncoherentMwts withExploredPath(final List<String> exploredPath) {
  ...
  public static final class InvalidCharacterOutOfString extends ErrorMessage {
    private final String file;
    private final int line;
    private final int pos;
    private final String token;
  ...
  public static final class InvalidCharacterInMultilineStringIndentation extends ErrorMessage {
    private final String file;
    private final int line;
    private final int pos;
    private final String token;
  ...
  public static final class PathNonExistant extends TypeError implements PosImprove {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathNonExistant(final List<String> listOfNodeNames, final ClassB cb, final Position pos) {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathNonExistant withListOfNodeNames(final List<String> listOfNodeNames) {
      return this.listOfNodeNames == listOfNodeNames ? this : new PathNonExistant(listOfNodeNames, this.cb, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathNonExistant withCb(final ClassB cb) {
      return this.cb == cb ? this : new PathNonExistant(this.listOfNodeNames, cb, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathNonExistant withPos(final Position pos) {
      return this.pos == pos ? this : new PathNonExistant(this.listOfNodeNames, this.cb, pos);
    }
  ...
  public static final class PathsNotSubtype extends TypeError {
    ...
    private final ExpCore e;
    private final List<ClassB> p;
    private final CachedStage cachedInfo;
    private final Position pos;

    @java.beans.ConstructorProperties({"tActual", "tExpected", "e", "p", "cachedInfo", "pos"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype(final Type tActual, final Type tExpected, final ExpCore e, final List<ClassB> p, final CachedStage cachedInfo, final Position pos) {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CachedStage getCachedInfo() {
    ...
    public PathsNotSubtype withTActual(final Type tActual) {
      return this.tActual == tActual ? this : new PathsNotSubtype(tActual, this.tExpected, this.e, this.p, this.cachedInfo, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype withTExpected(final Type tExpected) {
      return this.tExpected == tExpected ? this : new PathsNotSubtype(this.tActual, tExpected, this.e, this.p, this.cachedInfo, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype withE(final ExpCore e) {
      return this.e == e ? this : new PathsNotSubtype(this.tActual, this.tExpected, e, this.p, this.cachedInfo, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype withP(final List<ClassB> p) {
      return this.p == p ? this : new PathsNotSubtype(this.tActual, this.tExpected, this.e, p, this.cachedInfo, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype withCachedInfo(final CachedStage cachedInfo) {
      return this.cachedInfo == cachedInfo ? this : new PathsNotSubtype(this.tActual, this.tExpected, this.e, this.p, cachedInfo, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype withPos(final Position pos) {
      return this.pos == pos ? this : new PathsNotSubtype(this.tActual, this.tExpected, this.e, this.p, this.cachedInfo, pos);
    }
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final java.lang.Object other$p = other.getP();
      if (this$p == null ? other$p != null : !this$p.equals(other$p)) return false;
      final java.lang.Object this$cachedInfo = this.getCachedInfo();
      final java.lang.Object other$cachedInfo = other.getCachedInfo();
      if (this$cachedInfo == null ? other$cachedInfo != null : !this$cachedInfo.equals(other$cachedInfo)) return false;
      final java.lang.Object this$pos = this.getPos();
      final java.lang.Object other$pos = other.getPos();
      if (this$pos == null ? other$pos != null : !this$pos.equals(other$pos)) return false;
      return true;
    ...
    public int hashCode() {
      ...
      final java.lang.Object $p = this.getP();
      result = result * PRIME + ($p == null ? 0 : $p.hashCode());
      final java.lang.Object $cachedInfo = this.getCachedInfo();
      result = result * PRIME + ($cachedInfo == null ? 0 : $cachedInfo.hashCode());
      final java.lang.Object $pos = this.getPos();
      result = result * PRIME + ($pos == null ? 0 : $pos.hashCode());
      return result;
    }
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ErrorMessage.PathsNotSubtype(super=" + super.toString() + ", tActual=" + this.getTActual() + ", tExpected=" + this.getTExpected() + ", e=" + this.getE() + ", p=" + this.getP() + ", cachedInfo=" + this.getCachedInfo() + ", pos=" + this.getPos() + ")";
    }
  }
