// Generated by delombok at Wed Mar 09 20:09:41 NZDT 2016
package ast;
...
public abstract class ErrorMessage extends RuntimeException {
  ...
  public static final class IncoherentMwts extends ErrorMessage {
  ...
  public static final class PathNonExistant extends TypeError {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathNonExistant withPos(final Ast.Position pos) {
  ...
  public static final class PathNonStar extends TypeError {
    ...
    @java.beans.ConstructorProperties({"path", "varEnv"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathNonStar(final Path path, final HashMap<String, Ast.NormType> varEnv) {
      this.path = path;
      this.varEnv = varEnv;
    }
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ErrorMessage.PathNonStar(super=" + super.toString() + ", path=" + this.getPath() + ", varEnv=" + this.getVarEnv() + ")";
    }
  }
  ...
  public static final class ConfusedResultingTypeForMultiCatch extends TypeError {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConfusedResultingTypeForMultiCatch(final List<ExpCore.Block.On> k, final HashSet<Type> options) {
      this.k = k;
  ...
  public static final class PathsNotSubtype extends TypeError {
    ...
    @java.beans.ConstructorProperties({"tActual", "tExpected", "e", "p", "cachedInfo"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype(final Type tActual, final Type tExpected, final ExpCore e, final List<ClassB> p, final CachedStage cachedInfo) {
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ErrorMessage.PathsNotSubtype(super=" + super.toString() + ", tActual=" + this.getTActual() + ", tExpected=" + this.getTExpected() + ", e=" + this.getE() + ", p=" + this.getP() + ", cachedInfo=" + this.getCachedInfo() + ")";
    }
  }
  ...
  public static final class MethodNotPresent extends TypeError {
    ...
    public MethodNotPresent withPath(final Path path) {
      return this.path == path ? this : new MethodNotPresent(path, this.ms, this.call, this.pos, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent withMs(final MethodSelector ms) {
      return this.ms == ms ? this : new MethodNotPresent(this.path, ms, this.call, this.pos, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent withCall(final ExpCore.MCall call) {
      return this.call == call ? this : new MethodNotPresent(this.path, this.ms, call, this.pos, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent withPos(final Ast.Position pos) {
      return this.pos == pos ? this : new MethodNotPresent(this.path, this.ms, this.call, pos, this.p);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public MethodNotPresent withP(final List<ClassB> p) {
      return this.p == p ? this : new MethodNotPresent(this.path, this.ms, this.call, this.pos, p);
    }
