// Generated by delombok at Sun Oct 18 13:21:12 CEST 2015
package ast;
...
public abstract class ErrorMessage extends RuntimeException {
  ...
  public static final class IncoherentMwts extends ErrorMessage {
    ...
    @java.beans.ConstructorProperties({"incoherent"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IncoherentMwts(final List<PathMwt> incoherent) {
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ErrorMessage.IncoherentMwts(super=" + super.toString() + ", incoherent=" + this.getIncoherent() + ")";
    }
  }
