// Generated by delombok at Sat Jun 03 09:10:45 ICT 2017
package ast;
...
public abstract class ErrorMessage extends RuntimeException {
  ...
  public static final class NormImpossible extends ErrorMessage {
    private final NormType notNorm;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormImpossible(final NormType notNorm, final Throwable cause, final List<ClassB> p) {
  ...
  public static final class ConfusedResultingTypeForMultiCatch extends TypeError {
    ...
    private final HashSet<NormType> options;
    private final Position pos;

    @java.beans.ConstructorProperties({"k", "options", "pos"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConfusedResultingTypeForMultiCatch(final List<ExpCore.Block.On> k, final HashSet<NormType> options, final Position pos) {
      this.k = k;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public HashSet<NormType> getOptions() {
      return this.options;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConfusedResultingTypeForMultiCatch withOptions(final HashSet<NormType> options) {
  ...
  public static final class ConfusedResultingTypeForCatchAndBlock extends TypeError {
    ...
    private final NormType te;
    private final NormType tk;
    private final Position pos;

    @java.beans.ConstructorProperties({"e", "te", "tk", "pos"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConfusedResultingTypeForCatchAndBlock(final ExpCore.Block e, final NormType te, final NormType tk, final Position pos) {
      this.e = e;
      this.te = te;
      this.tk = tk;
      this.pos = pos;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getTe() {
      return this.te;
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getTk() {
      return this.tk;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConfusedResultingTypeForCatchAndBlock withTe(final NormType te) {
      return this.te == te ? this : new ConfusedResultingTypeForCatchAndBlock(this.e, te, this.tk, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ConfusedResultingTypeForCatchAndBlock withTk(final NormType tk) {
  ...
  public static final class PathsNotSubtype extends TypeError {
    private final NormType tActual;
    private final NormType tExpected;
    private final ExpCore e;
    private final List<ClassB> p;
    private final Position pos;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype(final NormType tActual, final NormType tExpected, final ExpCore e, final List<ClassB> p, final Position pos) {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getTActual() {
      return this.tActual;
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getTExpected() {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype withTActual(final NormType tActual) {
      return this.tActual == tActual ? this : new PathsNotSubtype(tActual, this.tExpected, this.e, this.p, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PathsNotSubtype withTExpected(final NormType tExpected) {
  ...
  public static final class TypesNotSubtype extends TypeError {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public TypesNotSubtype(final NormType tActual, final NormType tExpected, final ExpCore e, final Throwable promotionAttemptedBut, final Position pos) {
      this.tActual = tActual;
      this.tExpected = tExpected;
      this.e = e;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public TypesNotSubtype withTActual(final NormType tActual) {
      return this.tActual == tActual ? this : new TypesNotSubtype(tActual, this.tExpected, this.e, this.promotionAttemptedBut, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public TypesNotSubtype withTExpected(final NormType tExpected) {
  ...
  public static final class PromotionImpossible extends TypeError {
    private final NormType pFrom;
    private final NormType pTo;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PromotionImpossible(final NormType pFrom, final NormType pTo, final Throwable sealCause, final ExpCore inner, final Position pos) {
      this.pFrom = pFrom;
      this.pTo = pTo;
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getPFrom() {
      return this.pFrom;
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public NormType getPTo() {
      return this.pTo;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PromotionImpossible withPFrom(final NormType pFrom) {
      return this.pFrom == pFrom ? this : new PromotionImpossible(pFrom, this.pTo, this.sealCause, this.inner, this.pos);
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public PromotionImpossible withPTo(final NormType pTo) {
