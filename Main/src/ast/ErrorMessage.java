// Generated by delombok at Sun Nov 15 13:58:27 CET 2015
package ast;
...
public abstract class ErrorMessage extends RuntimeException {
  ...
  public static final class IncoherentMwts extends ErrorMessage {
    ...
    @java.beans.ConstructorProperties({"guilty", "incoherent", "pos"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public IncoherentMwts(final ast.Ast.MethodSelector guilty, final List<PathMwt> incoherent, final Ast.Position pos) {
      this.guilty = guilty;
    ...
    @javax.annotation.Generated("lombok")
    public java.lang.String toString() {
      return "ErrorMessage.IncoherentMwts(super=" + super.toString() + ", guilty=" + this.getGuilty() + ", incoherent=" + this.getIncoherent() + ", pos=" + this.getPos() + ")";
    }
  }
