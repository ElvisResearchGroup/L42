...
public interface L42Visitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitUseSquare(@NotNull L42Parser.UseSquareContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link L42Parser#contextId}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitContextId(@NotNull L42Parser.ContextIdContext ctx);
