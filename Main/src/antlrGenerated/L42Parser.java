...
public class L42Parser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"'var'", "'default'", "'interface'", "'method'", "'using'", "'check'", 
		"'##field'", "'##walkBy'", "Stage", "Path", "'::'", "MX", "X", "HashX", 
	...
	public static final int
		...
		RULE_ifExpr = 22, RULE_using = 23, RULE_whileExpr = 24, RULE_signalExpr = 25, 
		RULE_loopExpr = 26, RULE_block = 27, RULE_roundBlockForMethod = 28, RULE_roundBlock = 29, 
		RULE_bb = 30, RULE_curlyBlock = 31, RULE_varDec = 32, RULE_d = 33, RULE_stringParse = 34, 
		RULE_square = 35, RULE_squareW = 36, RULE_mCall = 37, RULE_round = 38, 
		RULE_ps = 39, RULE_k = 40, RULE_on = 41, RULE_onPlus = 42, RULE_nudeE = 43, 
		RULE_classBExtra = 44, RULE_classBReuse = 45, RULE_classB = 46, RULE_mhs = 47, 
		RULE_mht = 48, RULE_member = 49, RULE_methodWithType = 50, RULE_methodImplemented = 51, 
		RULE_nestedClass = 52, RULE_header = 53, RULE_fieldDec = 54, RULE_w = 55, 
		RULE_wSwitch = 56, RULE_i = 57, RULE_wSimple = 58;
	public static final String[] ruleNames = {
		"m", "mDec", "path", "docs", "docsOpt", "t", "concreteT", "historicalSeq", 
		"historicalT", "methSelector", "x", "xOp", "eTopForMethod", "eTop", "eL3", 
		"eL2", "eL1", "numParse", "eUnOp", "ePost", "eAtom", "mxRound", "ifExpr", 
	...
	public final MDecContext mDec() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(121); match(UnOp);
				setState(122); match(ORoundNoSpace);
				}
				break;
			...
			case 7:
				...
				setState(132); match(ORoundSpace);
				}
				break;
	...
	public final ConcreteTContext concreteT() throws RecognitionException {
		...
		try {
			...
			if (_la==Mdf) {
				{
				setState(157); match(Mdf);
				}
			}

			setState(160); match(Path);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final HistoricalSeqContext historicalSeq() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(162); match(ClassSep);
			setState(163); methSelector();
			setState(166);
	...
	public final MethSelectorContext methSelector() throws RecognitionException {
		...
		try {
			...
			case ORoundNoSpace:
				{
				setState(175); match(ORoundNoSpace);
				}
				break;
			case ORoundSpace:
				{
				setState(176); match(ORoundSpace);
				}
				break;
			default:
	...
	public final ETopForMethodContext eTopForMethod() throws RecognitionException {
		...
		try {
			...
			case ORoundNoSpace:
				enterOuterAlt(_localctx, 2);
				{
				setState(194); roundBlockForMethod();
				setState(205);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ORoundNoSpace) | (1L << OSquare) | (1L << Dot) | (1L << StringQuote) | (1L << Doc))) != 0)) {
					...
					case 4:
						{
						setState(199); match(ORoundNoSpace);
						setState(200); round();
						}
						break;
	...
	public final NumParseContext numParse() throws RecognitionException {
		...
		try {
			...
			if (_la==DataOp) {
				{
				setState(236); match(DataOp);
				}
			}

			setState(239); match(NumParse);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						{
						setState(251); match(ORoundNoSpace);
						setState(252); round();
						}
						break;
	...
	public final EAtomContext eAtom() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				if (_la==DataOp || _la==NumParse) {
					{
					setState(267); numParse();
					}
				}

				setState(270); match(Path);
				}
				break;
	...
	public final UsingContext using() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(296); match(Using);
			setState(297); match(Path);
			setState(298); match(Check);
			setState(299); mCall();
			setState(300); eTop();
			}
		}
	...
	public final SignalExprContext signalExpr() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_signalExpr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(306); match(S);
			setState(307); eTop();
			}
		}
		catch (RecognitionException re) {
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			case ORoundSpace:
				enterOuterAlt(_localctx, 1);
				{
				setState(312); roundBlock();
				}
				break;
			case OCurly:
				enterOuterAlt(_localctx, 2);
				{
				setState(313); curlyBlock();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final RoundBlockForMethodContext roundBlockForMethod() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_roundBlockForMethod);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			setState(316); match(ORoundNoSpace);
			setState(317); docsOpt();
			setState(321);
			_errHandler.sync(this);
	...
	public final RoundBlockContext roundBlock() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_roundBlock);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			setState(327); match(ORoundSpace);
			setState(328); docsOpt();
			setState(332);
			_errHandler.sync(this);
	...
	public final BbContext bb() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_bb);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final CurlyBlockContext curlyBlock() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_curlyBlock);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(346); match(OCurly);
			setState(347); docsOpt();
			setState(349); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
	...
	public final VarDecContext varDec() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_varDec);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final StringParseContext stringParse() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_stringParse);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(370); match(StringQuote);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SquareContext square() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_square);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			setState(372); match(OSquare);
	...
	public final SquareWContext squareW() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_squareW);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final MCallContext mCall() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_mCall);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(391); m();
	...
	public final RoundContext round() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_round);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(394); docsOpt();
			setState(395); ps();
			setState(396); match(CRound);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsContext ps() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_ps);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final KContext k() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_k);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(409); match(Catch);
			setState(410); match(S);
			setState(412);
			_la = _input.LA(1);
			if (_la==X) {
				{
				setState(411); match(X);
				}
			}
			...
			if (_la==Default) {
				{
				setState(421); match(Default);
				setState(422); eTop();
				}
			}

			setState(425); match(CRound);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OnContext on() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_on);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OnPlusContext onPlus() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_onPlus);
		int _la;
		try {
			int _alt;
			setState(451);
	...
	public final NudeEContext nudeE() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_nudeE);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(453); eTop();
	...
	public final ClassBExtraContext classBExtra() throws RecognitionException {
		...
		enterRule(_localctx, 88, RULE_classBExtra);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ClassBReuseContext classBReuse() throws RecognitionException {
		...
		enterRule(_localctx, 90, RULE_classBReuse);
		int _la;
		try {
			setState(483);
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(467); match(OCurly);
				setState(468); docsOpt();
				setState(469); match(Url);
				setState(470); match(CCurly);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(472); match(OCurly);
				setState(473); docsOpt();
				setState(474); match(UrlNL);
				setState(475); docsOpt();
				setState(477); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
	...
	public final ClassBContext classB() throws RecognitionException {
		...
		enterRule(_localctx, 92, RULE_classB);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			setState(485); match(OCurly);
			setState(486); docsOpt();
			setState(487); header();
			setState(489);
			_la = _input.LA(1);
			if (_la==Implements) {
				{
				setState(488); match(Implements);
				}
			}
			...
			setState(504); match(CCurly);
			setState(506);
			switch ( getInterpreter().adaptivePredict(_input,50,_ctx) ) {
			case 1:
				{
				setState(505); classBExtra();
				}
				break;
			}
			}
	...
	public final MhsContext mhs() throws RecognitionException {
		...
		enterRule(_localctx, 94, RULE_mhs);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(508); match(Method);
			setState(509); docsOpt();
			setState(510); methSelector();
			setState(514);
			_la = _input.LA(1);
			if (_la==EndType) {
				{
				setState(511); match(EndType);
	...
	public final MhtContext mht() throws RecognitionException {
		...
		enterRule(_localctx, 96, RULE_mht);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			if (_la==Mdf) {
				{
				setState(516); match(Mdf);
				}
			}

			setState(519); match(Method);
			...
			case ORoundNoSpace:
				{
				setState(523); match(ORoundNoSpace);
				}
				break;
			case ORoundSpace:
				{
				setState(524); match(ORoundSpace);
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			setState(536); match(CRound);
			setState(543);
			switch ( getInterpreter().adaptivePredict(_input,56,_ctx) ) {
			case 1:
				{
				setState(537); match(S);
				setState(539); 
				_errHandler.sync(this);
				_alt = 1;
				do {
	...
	public final MemberContext member() throws RecognitionException {
		...
		enterRule(_localctx, 98, RULE_member);
		try {
			setState(548);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(546); methodImplemented();
				}
				break;
	...
	public final MethodWithTypeContext methodWithType() throws RecognitionException {
		...
		enterRule(_localctx, 100, RULE_methodWithType);
		int _la;
		try {
			setState(562);
			...
			case 1:
				...
				if (_la==EndType) {
					{
					setState(551); match(EndType);
					setState(552); match(Path);
					}
				}
			...
			case 2:
				...
				{
				setState(559); mht();
				setState(560); match(FieldSpecial);
				}
				break;
			}
		}
	...
	public final MethodImplementedContext methodImplemented() throws RecognitionException {
		...
		enterRule(_localctx, 102, RULE_methodImplemented);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(564); mhs();
	...
	public final NestedClassContext nestedClass() throws RecognitionException {
		...
		enterRule(_localctx, 104, RULE_nestedClass);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(567); match(Path);
			setState(568); match(Colon);
			setState(569); docsOpt();
			setState(570); eTop();
			}
		}
		catch (RecognitionException re) {
	...
	public final HeaderContext header() throws RecognitionException {
		...
		enterRule(_localctx, 106, RULE_header);
		int _la;
		try {
			setState(589);
			...
			case 3:
				...
				case ORoundSpace:
					{
					setState(578); match(ORoundSpace);
					}
					break;
				case ORoundNoSpace:
					{
					setState(579); match(ORoundNoSpace);
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final FieldDecContext fieldDec() throws RecognitionException {
		...
		enterRule(_localctx, 108, RULE_fieldDec);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			if (_la==Var) {
				{
				setState(591); match(Var);
				}
			}

			setState(594); t();
			setState(595); x();
			setState(596); docsOpt();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final WContext w() throws RecognitionException {
		...
		enterRule(_localctx, 110, RULE_w);
		try {
			setState(600);
	...
	public final WSwitchContext wSwitch() throws RecognitionException {
		...
		enterRule(_localctx, 112, RULE_wSwitch);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			setState(602); match(With);
			setState(606);
			_errHandler.sync(this);
			...
			setState(621); match(ORoundSpace);
			setState(623); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
			...
			if (_la==Default) {
				{
				setState(627); match(Default);
				setState(628); eTop();
				}
			}

			setState(631); match(CRound);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IContext i() throws RecognitionException {
		...
		enterRule(_localctx, 114, RULE_i);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final WSimpleContext wSimple() throws RecognitionException {
		...
		enterRule(_localctx, 116, RULE_wSimple);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(643); match(With);
			setState(645); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
	...
	public static final String _serializedATN =
		...
		"\13\3\f\3\f\3\r\3\r\3\r\3\r\3\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16\3"+
		"\16\3\16\7\16\u00ce\n\16\f\16\16\16\u00d1\13\16\5\16\u00d3\n\16\3\17\3"+
		"\17\3\17\7\17\u00d8\n\17\f\17\16\17\u00db\13\17\3\20\3\20\3\20\7\20\u00e0"+
		"\n\20\f\20\16\20\u00e3\13\20\3\21\3\21\3\21\7\21\u00e8\n\21\f\21\16\21"+
		"\u00eb\13\21\3\22\3\22\3\23\5\23\u00f0\n\23\3\23\3\23\3\24\5\24\u00f5"+
		"\n\24\3\24\3\24\3\25\3\25\3\25\3\25\3\25\3\25\3\25\3\25\3\25\7\25\u0102"+
		"\n\25\f\25\16\25\u0105\13\25\3\26\3\26\3\26\5\26\u010a\n\26\3\26\3\26"+
		"\3\26\5\26\u010f\n\26\3\26\3\26\5\26\u0113\n\26\3\26\3\26\3\26\3\26\3"+
		"\26\3\26\3\26\3\26\3\26\3\26\5\26\u011f\n\26\3\27\3\27\3\27\3\30\3\30"+
		"\3\30\3\30\3\30\5\30\u0129\n\30\3\31\3\31\3\31\3\31\3\31\3\31\3\32\3\32"+
		"\3\32\3\32\3\33\3\33\3\33\3\34\3\34\3\34\3\35\3\35\5\35\u013d\n\35\3\36"+
		"\3\36\3\36\7\36\u0142\n\36\f\36\16\36\u0145\13\36\3\36\3\36\3\36\3\37"+
		"\3\37\3\37\7\37\u014d\n\37\f\37\16\37\u0150\13\37\3\37\3\37\3\37\3 \6"+
		" \u0156\n \r \16 \u0157\3 \5 \u015b\n \3!\3!\3!\6!\u0160\n!\r!\16!\u0161"+
