...
private VarDecXE getDecForVar(String cName,VarDecXE varDec) {
 ...
 private VarDecCE getClassBForVar(VarDecXE varDec) {
   ...
   ClassB cb=new ClassB(Doc.empty(),Doc.empty(),new Ast.ConcreteHeader(Mdf.Mutable, "",fs,Position.noInfo),Collections.emptyList(),Collections.emptyList(),Position.noInfo,Stage.None);
