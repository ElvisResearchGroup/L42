...
/*private static String newName(String s, HashSet<String> forbidden) {
  int i=0;
  while(true){
    String result=s+i;
    if(forbidden.contains(result)){i++;continue;}
...
C:(
  Void unused=(
    Void unused0=(
      Outer0::Bool cond=(
        Void unused17=(
          Outer0::N candidate=Outer0::N.#apply(that:{'@int32
          '3
          })
          mut Outer0::Util::Varcandidate varcandidate=Outer0::Util::Varcandidate.#apply(inner:candidate)
          Void unused16=(
            Outer0::NList::CellNext this0=(
              Outer0::NList::CellNext cell3=(
                Outer0::N that0=(
                  Outer0::N n0=Outer0::N.#apply(that:{'@int32
                  '3
                  })
                  n0
                  )
                (
                  Outer0::NList::CellNext cell2=(
                    Outer0::NList::CellEnd cell1=(
                      Outer0::NList::CellEnd cellEnd=Outer0::NList::CellEnd.#apply()
                      cellEnd
                      )
                    (
                      Outer0::NList::CellNext cellNext0=Outer0::NList::CellNext.#apply(elem:that0, _next:cell1)
                      cellNext0
                      )
                    )
                  cell2
            ...
            Outer0::True that=(
              Outer0::True true=Outer0::True._private()
              true
              )
            mut Outer0::NList::Iterator iterator=Outer0::NList::Iterator.#apply(that:this0, terminate:that)
            (
              Void unused5=(
                Void unused6=(
                  Void unused7=(
                    Void void0=(
                      (
                        Void unused10=(
                          Void unused11=iterator.#checkEnd()
                    ...
                    loop (
                      ...
                      (
                        Outer0::Bool cond0=iterator.#inner().#right(that:varcandidate.#inner())
                        (
                          Void unused13=cond0.#checkTrue()
                          catch exception unused14 (
                            on Void void
                            )
                          varcandidate.inner(that:iterator.#inner())
                          )
                        )
                      )
                    )
          ...
          Void unused10=return varcandidate.#inner()
          void
          )
        ...
        ).#equalequal(that:Outer0::N.#numberParser(that:{'@stringU
      '3
      }))
      (
        ...
        return Outer0::ExitCode.normal()
        )
      )
    Void unused1=return Outer0::ExitCode.failure()
    void
    )
  catch return result (
    on Library result
