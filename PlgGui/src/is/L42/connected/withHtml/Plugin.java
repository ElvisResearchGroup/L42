...
public class Plugin implements PluginType {
  ...
  public Resources.Void Mopen£wName£html£x£y(Object _wName, Object _html,Object _x,Object _y){
  ...
  public  Object MexecuteJs£wName£command(Object _wName, Object _command){
  ...
  public Object MeventPending£wName(Object _wName){
    String wName=EncodingHelper.ensureExtractStringU(_wName);
    return Frame.getEventString(wName);     
  }
  
  @ActionType({ActionType.Type.Void,ActionType.Type.Library,})
  public Resources.Void Mclose£wName(Object _wName){
    String wName=EncodingHelper.ensureExtractStringU(_wName);
    Frame.close(wName);
    return Resources.Void.instance;
  }
