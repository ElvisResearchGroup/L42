...
import static is.L42.nativeCode.OpUtils.all;
import static is.L42.nativeCode.OpUtils.append;
import static is.L42.nativeCode.OpUtils.doc;
import static is.L42.nativeCode.OpUtils.mapChoice;
import static is.L42.nativeCode.OpUtils.mapOutOfBound;
import static is.L42.nativeCode.OpUtils.method;
import static is.L42.nativeCode.OpUtils.nested;
import static is.L42.nativeCode.OpUtils.optChoice;
import static is.L42.nativeCode.OpUtils.setOutOfBound;
import static is.L42.nativeCode.OpUtils.trustedIO;
import static is.L42.nativeCode.OpUtils.type;
import static is.L42.nativeCode.OpUtils.use;
import static is.L42.nativeCode.OpUtils.useToS;
import static is.L42.nativeCode.OpUtils.vectorGet;
import static is.L42.nativeCode.OpUtils.vectorKs;
import static is.L42.nativeCode.OpUtils.vectorOp;
import static is.L42.nativeCode.OpUtils.vectorOpRemove;
import static is.L42.nativeCode.OpUtils.vectorReadGet;
import static is.L42.nativeCode.Signature.sig;
import static is.L42.nativeCode.Signature.sigI;
import static is.L42.nativeCode.TT.Any;
import static is.L42.nativeCode.TT.Gen1;
import static is.L42.nativeCode.TT.Gen2;
import static is.L42.nativeCode.TT.Gen3;
import static is.L42.nativeCode.TT.Lib;
import static is.L42.nativeCode.TT.This;
import static is.L42.nativeCode.TT.Void;
import static is.L42.nativeCode.TrustedKind.AnyKind;
import static is.L42.nativeCode.TrustedKind.BigRational;
import static is.L42.nativeCode.TrustedKind.Bool;
import static is.L42.nativeCode.TrustedKind.Doc;
import static is.L42.nativeCode.TrustedKind.Double;
import static is.L42.nativeCode.TrustedKind.HIMap;
import static is.L42.nativeCode.TrustedKind.HMMap;
import static is.L42.nativeCode.TrustedKind.HSet;
import static is.L42.nativeCode.TrustedKind.Int;
import static is.L42.nativeCode.TrustedKind.LazyMessage;
import static is.L42.nativeCode.TrustedKind.Long;
import static is.L42.nativeCode.TrustedKind.Meta;
import static is.L42.nativeCode.TrustedKind.Method;
import static is.L42.nativeCode.TrustedKind.Name;
import static is.L42.nativeCode.TrustedKind.Nested;
import static is.L42.nativeCode.TrustedKind.NonDeterministicError;
import static is.L42.nativeCode.TrustedKind.Opt;
import static is.L42.nativeCode.TrustedKind.SelfVector;
import static is.L42.nativeCode.TrustedKind.String;
import static is.L42.nativeCode.TrustedKind.StringBuilder;
