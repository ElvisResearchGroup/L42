...
public class Half {
  ...
  public static final class PCastT implements Leaf, XP, Visitable<PCastT> {
    ...
    public PCastT(final Pos pos, final P p, final List<ST> stz) {
      this.pos = pos;
      this.p = p;
      this.stz = stz;
    }
    ...
    @java.lang.SuppressWarnings("all")
    public Half.PCastT withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.PCastT(pos, this.p, this.stz);
    }

    @java.lang.SuppressWarnings("all")
    public Half.PCastT withP(final P p) {
      return this.p == p ? this : new Half.PCastT(this.pos, p, this.stz);
    }

    @java.lang.SuppressWarnings("all")
    public Half.PCastT withStz(final List<ST> stz) {
      return this.stz == stz ? this : new Half.PCastT(this.pos, this.p, stz);
    }
  }


  public static final class SlashCastT implements Leaf, XP, Visitable<SlashCastT> {
    @Override
    public Visitable<SlashCastT> visitable() {
      return this;
    }

    @Override
    public SlashCastT accept(CloneVisitor cv) {
      return cv.visitSlashCastT(this);
    }

    @Override
    public void accept(CollectorVisitor cv) {
      cv.visitSlashCastT(this);
    }
    ...
    private final Pos pos;
    private final List<ST> stz;
    private final List<ST> stz1;

    @java.lang.SuppressWarnings("all")
    public SlashCastT(final Pos pos, final List<ST> stz, final List<ST> stz1) {
      this.pos = pos;
      this.stz = stz;
      this.stz1 = stz1;
    }
    ...
    public boolean equals(final java.lang.Object o) {
      if (o == this) return true;
      if (!(o instanceof Half.SlashCastT)) return false;
      final Half.SlashCastT other = (Half.SlashCastT) o;
      final java.lang.Object this$stz = this.stz();
      final java.lang.Object other$stz = other.stz();
      if (this$stz == null ? other$stz != null : !this$stz.equals(other$stz)) return false;
      final java.lang.Object this$stz1 = this.stz1();
      final java.lang.Object other$stz1 = other.stz1();
      if (this$stz1 == null ? other$stz1 != null : !this$stz1.equals(other$stz1)) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      final java.lang.Object $stz = this.stz();
      result = result * PRIME + ($stz == null ? 43 : $stz.hashCode());
      final java.lang.Object $stz1 = this.stz1();
      result = result * PRIME + ($stz1 == null ? 43 : $stz1.hashCode());
      return result;
    }

    @java.lang.SuppressWarnings("all")
    public Half.SlashCastT withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.SlashCastT(pos, this.stz, this.stz1);
    }

    @java.lang.SuppressWarnings("all")
    public Half.SlashCastT withStz(final List<ST> stz) {
      return this.stz == stz ? this : new Half.SlashCastT(this.pos, stz, this.stz1);
    }

    @java.lang.SuppressWarnings("all")
    public Half.SlashCastT withStz1(final List<ST> stz1) {
      return this.stz1 == stz1 ? this : new Half.SlashCastT(this.pos, this.stz, stz1);
    }
  }
  ...
  public static final class BinOp implements E, Visitable<BinOp> {
    ...
    @java.lang.SuppressWarnings("all")
    public Half.BinOp withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.BinOp(pos, this.op, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Half.BinOp withOp(final Op op) {
      return this.op == op ? this : new Half.BinOp(this.pos, op, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Half.BinOp withEs(final List<XP> es) {
      return this.es == es ? this : new Half.BinOp(this.pos, this.op, es);
    }
  }
  ...
  public static final class MCall implements E, Visitable<MCall> {
    ...
    @java.lang.SuppressWarnings("all")
    public Half.MCall withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.MCall(pos, this.xP, this.s, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Half.MCall withXP(final XP xP) {
      return this.xP == xP ? this : new Half.MCall(this.pos, xP, this.s, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Half.MCall withS(final S s) {
      return this.s == s ? this : new Half.MCall(this.pos, this.xP, s, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Half.MCall withEs(final List<E> es) {
      return this.es == es ? this : new Half.MCall(this.pos, this.xP, this.s, es);
    }
  }
  ...
  public static final class Block implements E, Visitable<Block> {
    ...
    @java.lang.SuppressWarnings("all")
    public Half.Block withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.Block(pos, this.ds, this.ks, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.Block withDs(final List<D> ds) {
      return this.ds == ds ? this : new Half.Block(this.pos, ds, this.ks, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.Block withKs(final List<K> ks) {
      return this.ks == ks ? this : new Half.Block(this.pos, this.ds, ks, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.Block withE(final E e) {
      return this.e == e ? this : new Half.Block(this.pos, this.ds, this.ks, e);
    }
  }
  ...
  public static final class Loop implements Wrapper, Visitable<Loop> {
    ...
    @java.lang.SuppressWarnings("all")
    public Half.Loop withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.Loop(pos, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.Loop withE(final E e) {
      return this.e == e ? this : new Half.Loop(this.pos, e);
    }
  }
  ...
  public static final class Throw implements Wrapper, Visitable<Throw> {
    ...
    @java.lang.SuppressWarnings("all")
    public Half.Throw withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.Throw(pos, this.thr, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.Throw withThr(final ThrowKind thr) {
      return this.thr == thr ? this : new Half.Throw(this.pos, thr, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.Throw withE(final E e) {
      return this.e == e ? this : new Half.Throw(this.pos, this.thr, e);
    }
  }
  ...
  public static final class OpUpdate implements Wrapper, Visitable<OpUpdate> {
    ...
    @java.lang.SuppressWarnings("all")
    public Half.OpUpdate withPos(final Pos pos) {
      return this.pos == pos ? this : new Half.OpUpdate(pos, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.OpUpdate withX(final X x) {
      return this.x == x ? this : new Half.OpUpdate(this.pos, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.OpUpdate withE(final E e) {
      return this.e == e ? this : new Half.OpUpdate(this.pos, this.x, e);
    }
  }
  ...
  public static final class D implements Visitable<D> {
    ...
    @java.lang.SuppressWarnings("all")
    public D(final boolean isVar, final Mdf _mdf, final List<ST> stz, final X x, final E e) {
      this.isVar = isVar;
      this._mdf = _mdf;
      this.stz = stz;
      this.x = x;
    ...
    @java.lang.SuppressWarnings("all")
    public Half.D withVar(final boolean isVar) {
      return this.isVar == isVar ? this : new Half.D(isVar, this._mdf, this.stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.D with_mdf(final Mdf _mdf) {
      return this._mdf == _mdf ? this : new Half.D(this.isVar, _mdf, this.stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.D withStz(final List<ST> stz) {
      return this.stz == stz ? this : new Half.D(this.isVar, this._mdf, stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.D withX(final X x) {
      return this.x == x ? this : new Half.D(this.isVar, this._mdf, this.stz, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.D withE(final E e) {
      return this.e == e ? this : new Half.D(this.isVar, this._mdf, this.stz, this.x, e);
    }
  }
  ...
  public static final class K implements Visitable<K> {
    ...
    @java.lang.SuppressWarnings("all")
    public Half.K withThr(final ThrowKind thr) {
      return this.thr == thr ? this : new Half.K(thr, this.stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.K withStz(final List<ST> stz) {
      return this.stz == stz ? this : new Half.K(this.thr, stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.K withX(final X x) {
      return this.x == x ? this : new Half.K(this.thr, this.stz, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Half.K withE(final E e) {
      return this.e == e ? this : new Half.K(this.thr, this.stz, this.x, e);
    }
  }
}
