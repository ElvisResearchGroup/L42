...
public class Core {
  ...
  public static final class EX implements Leaf, Full.E, Full.Leaf, XP, Half.XP, Visitable<EX> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.EX withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.EX(pos, this.x);
    }

    @java.lang.SuppressWarnings("all")
    public Core.EX withX(final X x) {
      return this.x == x ? this : new Core.EX(this.pos, x);
    }
  }
  ...
  public static final class PCastT implements Leaf, XP, Visitable<PCastT> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.PCastT withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.PCastT(pos, this.p, this.t);
    }

    @java.lang.SuppressWarnings("all")
    public Core.PCastT withP(final P p) {
      return this.p == p ? this : new Core.PCastT(this.pos, p, this.t);
    }

    @java.lang.SuppressWarnings("all")
    public Core.PCastT withT(final T t) {
      return this.t == t ? this : new Core.PCastT(this.pos, this.p, t);
    }
  }
  ...
  public static final class EVoid implements Leaf, Full.Leaf, Half.Leaf, Visitable<EVoid> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.EVoid withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.EVoid(pos);
    }
  }
  ...
  public static final class L implements LL, Leaf, Half.Leaf, Visitable<L> {
    ...
    public void visitInnerL(InnerLAction a) {
      a.start(this);
    }

    public void visitInnerLNoPrivate(InnerLActionNoPrivate a) {
      a.start(this);
    }
    ...
    public static interface InnerLAction {
      ...
      default void start(Core.L l) {
        step(l, L());
      }

      default boolean filterOut(Core.L.NC nc) {
        return false;
      }
    ...
    public static final class MWT implements LDom.HasKey, Visitable<MWT> {
      ...
      @java.lang.SuppressWarnings("all")
      public MWT(final List<Pos> poss, final List<Doc> docs, final MH mh, final String nativeUrl, final E _e) {
        this.poss = poss;
        this.docs = docs;
        this.mh = mh;
      ...
      @java.lang.SuppressWarnings("all")
      public Core.L.MWT withPoss(final List<Pos> poss) {
        return this.poss == poss ? this : new Core.L.MWT(poss, this.docs, this.mh, this.nativeUrl, this._e);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.MWT withDocs(final List<Doc> docs) {
        return this.docs == docs ? this : new Core.L.MWT(this.poss, docs, this.mh, this.nativeUrl, this._e);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.MWT withMh(final MH mh) {
        return this.mh == mh ? this : new Core.L.MWT(this.poss, this.docs, mh, this.nativeUrl, this._e);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.MWT withNativeUrl(final String nativeUrl) {
        return this.nativeUrl == nativeUrl ? this : new Core.L.MWT(this.poss, this.docs, this.mh, nativeUrl, this._e);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.MWT with_e(final E _e) {
        return this._e == _e ? this : new Core.L.MWT(this.poss, this.docs, this.mh, this.nativeUrl, _e);
      }
    }
    ...
    public static final class NC implements LDom.HasKey, Visitable<NC> {
      ...
      @java.lang.SuppressWarnings("all")
      public NC(final List<Pos> poss, final List<Doc> docs, final C key, final L l) {
        this.poss = poss;
        this.docs = docs;
        this.key = key;
        this.l = l;
      ...
      @java.lang.SuppressWarnings("all")
      public Core.L.NC withPoss(final List<Pos> poss) {
        return this.poss == poss ? this : new Core.L.NC(poss, this.docs, this.key, this.l);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.NC withDocs(final List<Doc> docs) {
        return this.docs == docs ? this : new Core.L.NC(this.poss, docs, this.key, this.l);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.NC withKey(final C key) {
        return this.key == key ? this : new Core.L.NC(this.poss, this.docs, key, this.l);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.NC withL(final L l) {
        return this.l == l ? this : new Core.L.NC(this.poss, this.docs, this.key, l);
      }
    }
    ...
    public static final class Info implements Visitable<Info> {
      ...
      private final List<P.NCs> metaCoherentDep;
      private final List<P.NCs> watched;
      private final List<PathSel> usedMethods;
      private final List<P.NCs> hiddenSupertypes;
      ...
      public Info sumInfo(Info info2) {
        ...
        List<Core.PathSel> allU = L(c -> {
          //avoid the ps in watched
          for (var ps : info1.usedMethods()) {
            if (!allW.contains(ps.p()) && !c.contains(ps)) {
              c.add(ps);
            }
          }
          for (var ps : info2.usedMethods()) {
            if (!allW.contains(ps.p()) && !c.contains(ps)) {
              c.add(ps);
            }
          }
        });
        Info res = new Info(info1.isTyped() && info2.isTyped(), mergeU(info1.typeDep(), info2.typeDep()), mergeU(info1.coherentDep(), info2.coherentDep()), mergeU(info1.metaCoherentDep(), info2.metaCoherentDep()), allW, allU, mergeU(info1.hiddenSupertypes(), info2.hiddenSupertypes()), mergeU(info1.refined(), info2.refined()), info1.close() || info2.close(), info1.nativeKind() + info2.nativeKind(), info1.nativePar().isEmpty() ? info2.nativePar() : info1.nativePar(), Math.max(info1._uniqueId(), info2._uniqueId()));
        if (res.equals(info1)) {
          return info1;
        }
        if (res.equals(info2)) {
      ...
      public Info(final boolean isTyped, final List<P.NCs> typeDep, final List<P.NCs> coherentDep, final List<P.NCs> metaCoherentDep, final List<P.NCs> watched, final List<PathSel> usedMethods, final List<P.NCs> hiddenSupertypes, final List<S> refined, final boolean close, final String nativeKind, final List<P> nativePar, final int _uniqueId) {
        ...
        this.metaCoherentDep = metaCoherentDep;
        this.watched = watched;
        this.usedMethods = usedMethods;
        this.hiddenSupertypes = hiddenSupertypes;
      ...
      @java.lang.SuppressWarnings("all")
      public List<P.NCs> metaCoherentDep() {
        return this.metaCoherentDep;
      }

      @java.lang.SuppressWarnings("all")
      public List<P.NCs> watched() {
        return this.watched;
      }
      ...
      @java.lang.SuppressWarnings("all")
      public List<P.NCs> hiddenSupertypes() {
        return this.hiddenSupertypes;
      }
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        if (this.close() != other.close()) return false;
        ...
        final java.lang.Object this$metaCoherentDep = this.metaCoherentDep();
        final java.lang.Object other$metaCoherentDep = other.metaCoherentDep();
        if (this$metaCoherentDep == null ? other$metaCoherentDep != null : !this$metaCoherentDep.equals(other$metaCoherentDep)) return false;
        final java.lang.Object this$watched = this.watched();
        final java.lang.Object other$watched = other.watched();
        if (this$watched == null ? other$watched != null : !this$watched.equals(other$watched)) return false;
        ...
        final java.lang.Object this$hiddenSupertypes = this.hiddenSupertypes();
        final java.lang.Object other$hiddenSupertypes = other.hiddenSupertypes();
        if (this$hiddenSupertypes == null ? other$hiddenSupertypes != null : !this$hiddenSupertypes.equals(other$hiddenSupertypes)) return false;
      ...
      public int hashCode() {
        ...
        result = result * PRIME + (this.close() ? 79 : 97);
        ...
        final java.lang.Object $metaCoherentDep = this.metaCoherentDep();
        result = result * PRIME + ($metaCoherentDep == null ? 43 : $metaCoherentDep.hashCode());
        final java.lang.Object $watched = this.watched();
        result = result * PRIME + ($watched == null ? 43 : $watched.hashCode());
        final java.lang.Object $usedMethods = this.usedMethods();
        result = result * PRIME + ($usedMethods == null ? 43 : $usedMethods.hashCode());
        final java.lang.Object $hiddenSupertypes = this.hiddenSupertypes();
        result = result * PRIME + ($hiddenSupertypes == null ? 43 : $hiddenSupertypes.hashCode());
      ...
      @java.lang.SuppressWarnings("all")
      public Core.L.Info withTyped(final boolean isTyped) {
        return this.isTyped == isTyped ? this : new Core.L.Info(isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withTypeDep(final List<P.NCs> typeDep) {
        return this.typeDep == typeDep ? this : new Core.L.Info(this.isTyped, typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withCoherentDep(final List<P.NCs> coherentDep) {
        return this.coherentDep == coherentDep ? this : new Core.L.Info(this.isTyped, this.typeDep, coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withMetaCoherentDep(final List<P.NCs> metaCoherentDep) {
        return this.metaCoherentDep == metaCoherentDep ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withWatched(final List<P.NCs> watched) {
        return this.watched == watched ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withUsedMethods(final List<PathSel> usedMethods) {
        return this.usedMethods == usedMethods ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withHiddenSupertypes(final List<P.NCs> hiddenSupertypes) {
        return this.hiddenSupertypes == hiddenSupertypes ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withRefined(final List<S> refined) {
        return this.refined == refined ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, refined, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withClose(final boolean close) {
        return this.close == close ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withNativeKind(final String nativeKind) {
        return this.nativeKind == nativeKind ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info withNativePar(final List<P> nativePar) {
        return this.nativePar == nativePar ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Core.L.Info with_uniqueId(final int _uniqueId) {
        return this._uniqueId == _uniqueId ? this : new Core.L.Info(this.isTyped, this.typeDep, this.coherentDep, this.metaCoherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.close, this.nativeKind, this.nativePar, _uniqueId);
      }
    }

    @java.lang.SuppressWarnings("all")
    public L(final List<Pos> poss, final boolean isInterface, final List<T> ts, final List<MWT> mwts, final List<NC> ncs, final Info info, final List<Doc> docs) {
      this.poss = poss;
      ...
      this.info = info;
      this.docs = docs;
      this.inDomFun = c2->ncs.stream().anyMatch(m -> c2 == m.key());
    }
    ...
    @java.lang.SuppressWarnings("all")
    public Core.L withPoss(final List<Pos> poss) {
      return this.poss == poss ? this : new Core.L(poss, this.isInterface, this.ts, this.mwts, this.ncs, this.info, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.L withInterface(final boolean isInterface) {
      return this.isInterface == isInterface ? this : new Core.L(this.poss, isInterface, this.ts, this.mwts, this.ncs, this.info, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.L withTs(final List<T> ts) {
      return this.ts == ts ? this : new Core.L(this.poss, this.isInterface, ts, this.mwts, this.ncs, this.info, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.L withMwts(final List<MWT> mwts) {
      return this.mwts == mwts ? this : new Core.L(this.poss, this.isInterface, this.ts, mwts, this.ncs, this.info, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.L withNcs(final List<NC> ncs) {
      return this.ncs == ncs ? this : new Core.L(this.poss, this.isInterface, this.ts, this.mwts, ncs, this.info, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.L withInfo(final Info info) {
      return this.info == info ? this : new Core.L(this.poss, this.isInterface, this.ts, this.mwts, this.ncs, info, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.L withDocs(final List<Doc> docs) {
      return this.docs == docs ? this : new Core.L(this.poss, this.isInterface, this.ts, this.mwts, this.ncs, this.info, docs);
    }
  }
  ...
  public static final class MCall implements E, Visitable<MCall> {
    ...
    public MCall(Pos pos, XP xP, S s, List<E> es) {
      this.pos = pos;
      this.xP = xP;
      this.s = s;
      this.es = es;
    ...
    @java.lang.SuppressWarnings("all")
    public Core.MCall withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.MCall(pos, this.xP, this.s, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MCall withXP(final XP xP) {
      return this.xP == xP ? this : new Core.MCall(this.pos, xP, this.s, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MCall withS(final S s) {
      return this.s == s ? this : new Core.MCall(this.pos, this.xP, s, this.es);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MCall withEs(final List<E> es) {
      return this.es == es ? this : new Core.MCall(this.pos, this.xP, this.s, es);
    }
  }
  ...
  public static final class Block implements E, Visitable<Block> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.Block withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.Block(pos, this.ds, this.ks, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Block withDs(final List<D> ds) {
      return this.ds == ds ? this : new Core.Block(this.pos, ds, this.ks, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Block withKs(final List<K> ks) {
      return this.ks == ks ? this : new Core.Block(this.pos, this.ds, ks, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Block withE(final E e) {
      return this.e == e ? this : new Core.Block(this.pos, this.ds, this.ks, e);
    }
  }
  ...
  public static final class Loop implements Wrapper, Visitable<Loop> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.Loop withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.Loop(pos, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Loop withE(final E e) {
      return this.e == e ? this : new Core.Loop(this.pos, e);
    }
  }
  ...
  public static final class Throw implements Wrapper, Visitable<Throw> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.Throw withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.Throw(pos, this.thr, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Throw withThr(final ThrowKind thr) {
      return this.thr == thr ? this : new Core.Throw(this.pos, thr, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Throw withE(final E e) {
      return this.e == e ? this : new Core.Throw(this.pos, this.thr, e);
    }
  }
  ...
  public static final class OpUpdate implements Wrapper, Visitable<OpUpdate> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.OpUpdate withPos(final Pos pos) {
      return this.pos == pos ? this : new Core.OpUpdate(pos, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.OpUpdate withX(final X x) {
      return this.x == x ? this : new Core.OpUpdate(this.pos, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.OpUpdate withE(final E e) {
      return this.e == e ? this : new Core.OpUpdate(this.pos, this.x, e);
    }
  }
  ...
  public static final class D implements Visitable<D> {
    ...
    @java.lang.SuppressWarnings("all")
    public D(final boolean isVar, final T t, final X x, final E e) {
      this.isVar = isVar;
      this.t = t;
      this.x = x;
      this.e = e;
    ...
    @java.lang.SuppressWarnings("all")
    public Core.D withVar(final boolean isVar) {
      return this.isVar == isVar ? this : new Core.D(isVar, this.t, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.D withT(final T t) {
      return this.t == t ? this : new Core.D(this.isVar, t, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.D withX(final X x) {
      return this.x == x ? this : new Core.D(this.isVar, this.t, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.D withE(final E e) {
      return this.e == e ? this : new Core.D(this.isVar, this.t, this.x, e);
    }
  }
  ...
  public static final class K implements Visitable<K> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.K withThr(final ThrowKind thr) {
      return this.thr == thr ? this : new Core.K(thr, this.t, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.K withT(final T t) {
      return this.t == t ? this : new Core.K(this.thr, t, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.K withX(final X x) {
      return this.x == x ? this : new Core.K(this.thr, this.t, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public Core.K withE(final E e) {
      return this.e == e ? this : new Core.K(this.thr, this.t, this.x, e);
    }
  }
  ...
  public static final class T implements ST, Visitable<T> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.T withMdf(final Mdf mdf) {
      return this.mdf == mdf ? this : new Core.T(mdf, this.docs, this.p);
    }

    @java.lang.SuppressWarnings("all")
    public Core.T withDocs(final List<Doc> docs) {
      return this.docs == docs ? this : new Core.T(this.mdf, docs, this.p);
    }

    @java.lang.SuppressWarnings("all")
    public Core.T withP(final P p) {
      return this.p == p ? this : new Core.T(this.mdf, this.docs, p);
    }
  }
  ...
  public static final class Doc implements Visitable<Doc> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.Doc with_pathSel(final PathSel _pathSel) {
      return this._pathSel == _pathSel ? this : new Core.Doc(_pathSel, this.texts, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Doc withTexts(final List<String> texts) {
      return this.texts == texts ? this : new Core.Doc(this._pathSel, texts, this.docs);
    }

    @java.lang.SuppressWarnings("all")
    public Core.Doc withDocs(final List<Doc> docs) {
      return this.docs == docs ? this : new Core.Doc(this._pathSel, this.texts, docs);
    }
  }
  ...
  public static final class PathSel implements Visitable<PathSel> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.PathSel withP(final P p) {
      return this.p == p ? this : new Core.PathSel(p, this._s, this._x);
    }

    @java.lang.SuppressWarnings("all")
    public Core.PathSel with_s(final S _s) {
      return this._s == _s ? this : new Core.PathSel(this.p, _s, this._x);
    }

    @java.lang.SuppressWarnings("all")
    public Core.PathSel with_x(final X _x) {
      return this._x == _x ? this : new Core.PathSel(this.p, this._s, _x);
    }
  }
  ...
  public static final class MH implements LDom.HasKey, Visitable<MH> {
    ...
    @java.lang.SuppressWarnings("all")
    public Core.MH withMdf(final Mdf mdf) {
      return this.mdf == mdf ? this : new Core.MH(mdf, this.docs, this.t, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MH withDocs(final List<Doc> docs) {
      return this.docs == docs ? this : new Core.MH(this.mdf, docs, this.t, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MH withT(final T t) {
      return this.t == t ? this : new Core.MH(this.mdf, this.docs, t, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MH withS(final S s) {
      return this.s == s ? this : new Core.MH(this.mdf, this.docs, this.t, s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MH withPars(final List<T> pars) {
      return this.pars == pars ? this : new Core.MH(this.mdf, this.docs, this.t, this.s, pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Core.MH withExceptions(final List<T> exceptions) {
      return this.exceptions == exceptions ? this : new Core.MH(this.mdf, this.docs, this.t, this.s, this.pars, exceptions);
    }
  }
}
