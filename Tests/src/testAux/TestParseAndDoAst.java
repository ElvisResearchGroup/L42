...
},{"{ method a(b c) {d e f}}","Expression.ClassB(doc1=, doc2=, h=Ast.TraitHeader(), supertypes=[], ms=[Expression.ClassB.MethodImplemented(doc=, s=a(b,c), inner=Expression.CurlyBlock(doc=, contents=[Expression.BlockContent(decs=[Ast.VarDecE(inner=d), Ast.VarDecE(inner=e), Ast.VarDecE(inner=f)], _catch=[])]))], stage=None)"
