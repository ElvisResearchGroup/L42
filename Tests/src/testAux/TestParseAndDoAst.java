...
},{"{ method Any a()}","Expression.ClassB(doc1=, doc2=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=, ms=a(), mt=Ast.MethodType(refine=false, docExceptions=, mdf=Immutable, ts=[], tDocs=[], returnType=Immutable[Any], exceptions=[]), inner=Optional.empty)], stage=None)"
},{"{ method //a\nAny a()}","Expression.ClassB(doc1=, doc2=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=a\n, ms=a(), mt=Ast.MethodType(refine=false, docExceptions=, mdf=Immutable, ts=[], tDocs=[], returnType=Immutable[Any], exceptions=[]), inner=Optional.empty)], stage=None)"
...
},{"{ method Any a(T x, C y, B z)}","Expression.ClassB(doc1=, doc2=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=, ms=a(x,y,z), mt=Ast.MethodType(refine=false, docExceptions=, mdf=Immutable, ts=[Immutable[T], Immutable[C], Immutable[B]], tDocs=[, , ], returnType=Immutable[Any], exceptions=[]), inner=Optional.empty)], stage=None)"
},{"{ method Any a(T x, C y//foo\n,,,,,,,,,,,,, B z)}","Expression.ClassB(doc1=, doc2=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=, ms=a(x,y,z), mt=Ast.MethodType(refine=false, docExceptions=, mdf=Immutable, ts=[Immutable[T], Immutable[C], Immutable[B]], tDocs=[, foo\n, ], returnType=Immutable[Any], exceptions=[]), inner=Optional.empty)], stage=None)"
