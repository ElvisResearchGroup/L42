...
},{lineNumber()," ( shared Any b=c c)"
},{lineNumber()," ( type Any b=c c)"
},{lineNumber()," ( fwd type Any b=c c)"
},{lineNumber()," if a (b)"
...
},{lineNumber()," ( a catch error x (on Any foo) a)"
},{lineNumber()," ( a catch error x (on Any case e foo) a)"
},{lineNumber()," ( a=e catch error x (on Any foo on Bar fee) a)"
},{lineNumber()," ( a catch error x (on Any foo) b c d a)"
},{lineNumber()," ( a catch error x (on Any foo) b c catch error x (on Any foo) d a)"
},{lineNumber()," ( void catch exception x ( default x) void )"
},{lineNumber()," ( void catch exception x ( on Void x  default x) void )"
},{lineNumber()," {a}"
},{lineNumber()," {a a}"
},{lineNumber()," {a b c}"
},{lineNumber()," { a = b c}"
...
},{lineNumber()," { a catch error x (on Any foo)}"
},{lineNumber()," { a=e catch error x (on Any foo on Bar fee)}"
},{lineNumber()," { a=e catch error x (on Any foo on Bar fee) a}"
},{lineNumber()," { a catch error x (on Any foo) b c d a}"
},{lineNumber()," { a catch error x (on Any foo) b c catch error x (on Any foo)}"
},{lineNumber()," { var C::B a=d catch error x (on Any foo) b c d a}"
},{lineNumber()," ( A: x+y  n)"
},{lineNumber()," { var C::B a=d A: x+y  n w catch error x (on Any foo) b c d a}"
},{lineNumber()," {x( A f )}"
...
},{lineNumber(),"a[with x in a (a+b*c)]"
},{lineNumber(),"{ method a(b c) {d e f}}"
},{lineNumber(),"{ type method T () (e)}"
},{lineNumber(),"{ type method T #a (T b) exception C (e)}"
},{lineNumber(),"{ type method T #a (T b) exception C ^## C::D (e)}"
},{lineNumber(),"{ type method T #a (T b) exception C}"
},{lineNumber(),"{ type method T #a (T b) }"
},{lineNumber(),"{ type method T #a (T b) ##field}"
},{lineNumber(),"{C: e}"
},{lineNumber(),"{C: ...}"
},{lineNumber(),"using Foo::BAr check time(limit:soFoo) b+a"
},{lineNumber(),"using Foo::BAr check time('bla bla \n limit:soFoo) b+a"
},{lineNumber(),"Foo\"bla\""
  //},{"(a+b)'bla\n"
}});}
