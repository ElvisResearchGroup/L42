...
},{lineNumber()," {var A f mut B f2}"
},{lineNumber()," {var mut A f mut B f2}"
},{lineNumber()," {}"
},{lineNumber()," { }"
...
},{lineNumber()," { implements  A.B, C}","Expression.ClassB(doc1=, h=Ast.TraitHeader(), fields=[], supertypes=[A.B, C], ms=[])"
},{lineNumber()," {//foo\n implements  A.B, C //bar\n}","Expression.ClassB(doc1=foo\n, h=Ast.TraitHeader(), fields=[], supertypes=[A.B, C], ms=[])"
},{lineNumber()," {//foo\n implements  A.B, C }","Expression.ClassB(doc1=foo\n, h=Ast.TraitHeader(), fields=[], supertypes=[A.B, C], ms=[])"
},{lineNumber()," { implements  A.B, C //bar\n}","Expression.ClassB(doc1=, h=Ast.TraitHeader(), fields=[], supertypes=[A.B, C], ms=[])"
},{lineNumber(),"{ method Any a()}","Expression.ClassB(doc1=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=, ms=a(), mt=Immutable:->Any, inner=Optional.empty)])"
},{lineNumber(),"{ method //a\nAny a()}","Expression.ClassB(doc1=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=a\n, ms=a(), mt=Immutable:->Any, inner=Optional.empty)])"
},{lineNumber(),"{ method Any a(T x, C y, B z)}","Expression.ClassB(doc1=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=, ms=a(x,y,z), mt=Immutable:T,C,B->Any, inner=Optional.empty)])"
},{lineNumber(),"{ method Any a(T x, C y//foo\n,,,,,,,,,,,,, B z)}","Expression.ClassB(doc1=, h=Ast.TraitHeader(), fields=[], supertypes=[], ms=[Expression.ClassB.MethodWithType(doc=, ms=a(x,y,z), mt=Immutable:T,C,B->Any, inner=Optional.empty)])"
