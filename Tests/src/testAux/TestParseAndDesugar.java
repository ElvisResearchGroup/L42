...
//TOO UNSTABLE},{"{ reuse L42.is/base }","{Bool:{interface type method Void #checkTrue() exception Void} True:{ _private()<:Outer1::Bool method #checkTrue() ( void )} False:{ _private()<:Outer1::Bool method #checkTrue() (exception  void )}}"
...
},{"{ <(T bar) }'bla\n"," ('bla\n{ type method Outer0 #left(Outer0::T^bar'@private @consistent\n)mut method '@private @consistent\nOuter0::T #bar()read method '@private @consistent\nOuter0::T bar()})"
},{"{ (T bar) }"," {type method Outer0 #apply(Outer0::T^bar'@private @consistent\n) mut method '@private @consistent\nOuter0::T #bar() read method '@private @consistent\nOuter0::T bar() }"
  ...
  " {Vara0:'@private\n{type method \n"
+"mut Outer0 #apply(Outer1::T^inner'@private @consistent\n"
+") \n"
+"mut method '@private @consistent\n"
...
+"mut Outer0 #apply(Outer1::#begin() ^inner'@private @consistent\n"
+")\n"
+"mut method '@private @consistent\n"
...
+")\n"
+"type method '@private\n"
+"mut Outer0 new1(Outer1::Foo^a0'@private @consistent\n"
    +", Outer1::Foo^b0'@private @consistent\n"
+")\n"
+"mut method '@private @consistent\n"
+"Outer1::Foo #a0()\n"
+"read method '@private @consistent\n"
...
+" method"
+" Void foo() void}}"
},{//whe we fix this test, go in FlatFirstLevel and put back the @private add.
