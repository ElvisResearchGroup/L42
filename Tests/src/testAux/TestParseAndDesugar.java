...
//TOO UNSTABLE},{"{ reuse L42.is/base }","{Bool:{interface type method Void #checkTrue() exception Void} True:{ _private()<:Outer1::Bool method #checkTrue() ( void )} False:{ _private()<:Outer1::Bool method #checkTrue() (exception  void )}}"
...
},{lineNumber(), "{ <(T bar) }'bla\n"," ('bla\n{ type method Outer0 #left(Outer0::T^bar'@private\n)mut method '@private\nOuter0::T #bar()read method '@private\nOuter0::T bar()})"
},{lineNumber(), "{ (T bar) }"," {type method Outer0 #apply(Outer0::T^bar'@private\n) mut method '@private\nOuter0::T #bar() read method '@private\nOuter0::T bar() }"
  ...
  " {Vara0:'@private\n{type method \n"
+"mut Outer0 #apply(Outer1::T^inner'@private\n"
+") \n"
+"mut method '@private\n"
...
+"mut Outer0 #apply(Outer1::#begin() ^inner'@private\n"
+")\n"
+"mut method '@private\n"
