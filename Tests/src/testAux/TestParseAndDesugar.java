...
*/
  ...
  },{lineNumber(), " (6Meter +A)*B"," (This0.Meter.#from(builder:(  b1=This0.Meter.#builder() "
  +" Void unused1=b1.#6()  b1  )).#plus(that:This0.A)).#times(that:This0.B)"

},{lineNumber(), " (A + 1B)*C",
  " (This0.A.#plus(that:This0.B.#from(builder:(  b1=This0.B.#builder()  Void unused1=b1.#1()  b1  )))).#times(that:This0.C)"
...
},{lineNumber(), " (A*b a b c )"," ( Void unused1=This0.A.#times(that:b) Void unused2=a Void unused3=b c )"
...
/*},{lineNumber(), " (var This0.T a=a+c c=a Fuffa(a:=a.foo(a)) c )",//ok outer 0 can not be desugared since there is not outer nested class.
  ...
  +")"*/
   ...
   " (This0.T a=void  Void unused1=a.#times(that:b)   Void unused2=a.#plus(that:b)  catch error This0.Foo x (x.bar()    )  (    Void unused3=a    Void unused4=b    c  ) )"
...
//TOO UNSTABLE},{"{ reuse L42.is/base }","{Bool:{interface class method Void #checkTrue() exception Void} True:{ _private() implements This1.Bool method #checkTrue() ( void )} False:{ _private() implements This1.Bool method #checkTrue() (exception  void )}}"
   ...
   " (  cond1=This0.Foo.#plus(that:This0.Bar) ( Void unused1=cond1.#checkTrue() catch exception Void catched2  void  (bla)))"
...
//},{lineNumber(), "{ (T bar) }"," {class method This0 #apply(This0.T bar) mut method This0.T #bar() read method This0.T bar() }"
  ...
  "{ method Any #apply() ( opNorm1=this this.#rightequal(that:opNorm1)).#and(that:this)}"
},{lineNumber(),"{ method Any() this+this &   this}",
