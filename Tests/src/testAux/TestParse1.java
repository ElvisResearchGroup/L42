...
//    more important: should // be accepted in single line strings?
        ...
        ,"  }"
        ,"I:{interface }"
        ,"AI:{ implements This1.I class method This k()}"
        ,"D:("
...
},{lineNumber(),"{ C:{class method This k() class method Library m() ({//@OK\n} )} D:C.m() }"
},{lineNumber(),"{ C:{class method This k() class method Library m() ({//@oK\n} )} D:C.m() }"
},{lineNumber(),"{class method This outer() C: {class method This new() class method Library m() ({inner()})} D: C.m()}"
},{lineNumber(),"{class method This outer() C: {class method This new() class method Library m() ({inner()})} D: ({inner()})}"
...
},{lineNumber()," {class method This foo()}"
},{lineNumber()," {class method mut This()}"
},{lineNumber()," {class method mut This foo()}"
},{lineNumber()," {//bla bla \n class method This k()}"
},{lineNumber()," (a )(b,x:c)"
},{lineNumber()," (a-a)()"
},{lineNumber(),  "{ method () (b)}"
},{lineNumber(),  "{class method This a( This0.A a)"
    +" class method This0 a( This0.A a) "
