...
,"{reuse L42.is/nanoBase0"
,"A:{new()"
,"  type method A a() This0.b()"
,"  type method This0 b() A.new()"
,"  }"
,"C:ExitCode.normal()"
,"}"
)).getErrCode(),0);}
...
,"      )"
,"    Cell:{interface }"
,"    CellEnd:{ #apply()<:This1::Cell}"
,"    CellNext:{ #apply(Library elem This1::Cell next)<:This1::Cell}}"
,"    C:("
,"      Void unused=("
,"        Void unused0=return ("
,"          This0::List result0=("
...
,"      next:this.#head()))"
,"    )"
,"  type method mut This0 #begin() This0()"
...
public void testDeepMakePrivate() throws IOException{
  ...
  Assert.assertEquals(L42.runSlow(null,TestHelper.multiLine(""
,"{reuse L42.is/miniBase"
,"C:Adapt[Name\"Bar\", into:Name\"This0\";Name\"Bar::Foo\" into:Name\"Bar::Foo1\"]<{type method N top() Bar::Foo.foo() Bar:{Foo:{ type method N foo() 42N }}}"
,""
,"Main:{"
,"  if C.top()==42N ("
,"    return ExitCode.normal()"
