...
interface Foo{
  ...
  static final L42Cache<Foo> mySCache=L42CacheMap.newSingletonCache("FooClass", instance.getClass());
  }
...
class IntBox implements L42Cachable<IntBox>,Box{
  ...
  static final L42Cache<IntBox> mySCache=L42CacheMap.newSingletonCache("IntBoxClass", instance.getClass());
  static final Class<IntBox> _class=IntBox.class;
  private static final L42StandardCache<IntBox> myCache=
      L42CacheMap.newStandardCache("IntBox",IntBox._class);
