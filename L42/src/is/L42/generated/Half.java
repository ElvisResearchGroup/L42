...
public class Half {
  ...
  public static final class D implements Visitable<D> {
    ...
    @java.lang.SuppressWarnings("all")
    public D(final Mdf _mdf, final List<ST> stz, final X x, final E e) {
      this._mdf = _mdf;
      this.stz = stz;
      this.x = x;
      this.e = e;
    ...
    public D with_mdf(final Mdf _mdf) {
      return this._mdf == _mdf ? this : new D(_mdf, this.stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public D withStz(final List<ST> stz) {
      return this.stz == stz ? this : new D(this._mdf, stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public D withX(final X x) {
      return this.x == x ? this : new D(this._mdf, this.stz, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public D withE(final E e) {
      return this.e == e ? this : new D(this._mdf, this.stz, this.x, e);
    }
  }
