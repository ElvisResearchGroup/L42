// Generated by delombok at Fri Nov 29 08:08:12 NZDT 2019
...
public class Half {
  ...
  public static final class PCastT implements Leaf, XP, Visitable<PCastT> {
    ...
    public PCastT withPos(final Pos pos) {
      return this.pos == pos ? this : new PCastT(pos, this.p, this.stz);
    }

    @java.lang.SuppressWarnings("all")
    public PCastT withP(final P p) {
      return this.p == p ? this : new PCastT(this.pos, p, this.stz);
    }

    @java.lang.SuppressWarnings("all")
    public PCastT withStz(final List<ST> stz) {
      return this.stz == stz ? this : new PCastT(this.pos, this.p, stz);
    }
  }
  ...
  public static final class SlashCastT implements Leaf, XP, Visitable<SlashCastT> {
    ...
    @java.lang.SuppressWarnings("all")
    public SlashCastT withPos(final Pos pos) {
      return this.pos == pos ? this : new SlashCastT(pos, this.stz, this.stz1);
    }

    @java.lang.SuppressWarnings("all")
    public SlashCastT withStz(final List<ST> stz) {
      return this.stz == stz ? this : new SlashCastT(this.pos, stz, this.stz1);
    }

    @java.lang.SuppressWarnings("all")
    public SlashCastT withStz1(final List<ST> stz1) {
      return this.stz1 == stz1 ? this : new SlashCastT(this.pos, this.stz, stz1);
    }
  }
  ...
  public static final class D implements Visitable<D> {
    ...
    public D withVar(final boolean isVar) {
      return this.isVar == isVar ? this : new D(isVar, this._mdf, this.stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public D with_mdf(final Mdf _mdf) {
      return this._mdf == _mdf ? this : new D(this.isVar, _mdf, this.stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public D withStz(final List<ST> stz) {
      return this.stz == stz ? this : new D(this.isVar, this._mdf, stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public D withX(final X x) {
      return this.x == x ? this : new D(this.isVar, this._mdf, this.stz, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public D withE(final E e) {
      return this.e == e ? this : new D(this.isVar, this._mdf, this.stz, this.x, e);
    }
  }
  ...
  public static final class K implements Visitable<K> {
    ...
    public K withThr(final ThrowKind thr) {
      return this.thr == thr ? this : new K(thr, this.stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public K withStz(final List<ST> stz) {
      return this.stz == stz ? this : new K(this.thr, stz, this.x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public K withX(final X x) {
      return this.x == x ? this : new K(this.thr, this.stz, x, this.e);
    }

    @java.lang.SuppressWarnings("all")
    public K withE(final E e) {
      return this.e == e ? this : new K(this.thr, this.stz, this.x, e);
    }
  }
}
