...
public class Core {
  ...
  public static final class L implements Leaf, Full.Leaf, Half.Leaf, Visitable<L> {
    ...
    public static final class Info implements Visitable<Info> {
      ...
      private final boolean havePrivateStaticMethods;

      @java.lang.SuppressWarnings("all")
      public Info(final boolean isTyped, final List<P> typeDep, final List<P> coherentDep, final List<P> friendsDep, final List<PathSel> usedMethDep, final List<P> privateImpl, final List<S> refined, final boolean havePrivateStaticMethods) {
        ...
        this.havePrivateStaticMethods = havePrivateStaticMethods;
      }
      ...
      @java.lang.SuppressWarnings("all")
      public boolean havePrivateStaticMethods() {
        return this.havePrivateStaticMethods;
      }
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        if (this.havePrivateStaticMethods() != other.havePrivateStaticMethods()) return false;
        return true;
      }
      ...
      public int hashCode() {
        ...
        result = result * PRIME + (this.havePrivateStaticMethods() ? 79 : 97);
        return result;
      }

      @java.lang.SuppressWarnings("all")
      public Info withTyped(final boolean isTyped) {
        return this.isTyped == isTyped ? this : new Info(isTyped, this.typeDep, this.coherentDep, this.friendsDep, this.usedMethDep, this.privateImpl, this.refined, this.havePrivateStaticMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withTypeDep(final List<P> typeDep) {
        return this.typeDep == typeDep ? this : new Info(this.isTyped, typeDep, this.coherentDep, this.friendsDep, this.usedMethDep, this.privateImpl, this.refined, this.havePrivateStaticMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withCoherentDep(final List<P> coherentDep) {
        return this.coherentDep == coherentDep ? this : new Info(this.isTyped, this.typeDep, coherentDep, this.friendsDep, this.usedMethDep, this.privateImpl, this.refined, this.havePrivateStaticMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withFriendsDep(final List<P> friendsDep) {
        return this.friendsDep == friendsDep ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, friendsDep, this.usedMethDep, this.privateImpl, this.refined, this.havePrivateStaticMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withUsedMethDep(final List<PathSel> usedMethDep) {
        return this.usedMethDep == usedMethDep ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friendsDep, usedMethDep, this.privateImpl, this.refined, this.havePrivateStaticMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withPrivateImpl(final List<P> privateImpl) {
        return this.privateImpl == privateImpl ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friendsDep, this.usedMethDep, privateImpl, this.refined, this.havePrivateStaticMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withRefined(final List<S> refined) {
        return this.refined == refined ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friendsDep, this.usedMethDep, this.privateImpl, refined, this.havePrivateStaticMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withHavePrivateStaticMethods(final boolean havePrivateStaticMethods) {
        return this.havePrivateStaticMethods == havePrivateStaticMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friendsDep, this.usedMethDep, this.privateImpl, this.refined, havePrivateStaticMethods);
      }
    }
