// Generated by delombok at Sat Sep 14 14:19:16 PETT 2019
...
public class Core {
  ...
  public static final class L implements LL, Leaf, Half.Leaf, Visitable<L> {
    ...
    @Override
    public L c(C c) {
      return ncs.stream().filter(m -> m.key().equals(c)).reduce(toOneOr(() -> new LL.NotInDom(this, c))).orElseThrow(() -> new LL.NotInDom(this, c)).l();
    }
