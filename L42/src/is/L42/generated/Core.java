// Generated by delombok at Thu Nov 07 20:50:46 NZDT 2019
...
public class Core {
  ...
  public static final class L implements LL, Leaf, Half.Leaf, Visitable<L> {
    ...
    public static final class Info implements Visitable<Info> {
      ...
      @java.lang.SuppressWarnings("all")
      public Info(final boolean isTyped, @NonNull final List<P.NCs> typeDep, @NonNull final List<P.NCs> coherentDep, @NonNull final List<P.NCs> watched, @NonNull final List<PathSel> usedMethods, @NonNull final List<P.NCs> hiddenSupertypes, @NonNull final List<S> refined, final boolean declaresClassMethods, @NonNull final String nativeKind, @NonNull final List<P> nativePar, final int _uniqueId) {
        if (typeDep == null) {
      ...
      public Info withTyped(final boolean isTyped) {
        return this.isTyped == isTyped ? this : new Info(isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withTypeDep(@NonNull final List<P.NCs> typeDep) {
        ...
        return this.typeDep == typeDep ? this : new Info(this.isTyped, typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withCoherentDep(@NonNull final List<P.NCs> coherentDep) {
        ...
        return this.coherentDep == coherentDep ? this : new Info(this.isTyped, this.typeDep, coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withWatched(@NonNull final List<P.NCs> watched) {
        ...
        return this.watched == watched ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withUsedMethods(@NonNull final List<PathSel> usedMethods) {
        ...
        return this.usedMethods == usedMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withHiddenSupertypes(@NonNull final List<P.NCs> hiddenSupertypes) {
        ...
        return this.hiddenSupertypes == hiddenSupertypes ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withRefined(@NonNull final List<S> refined) {
        ...
        return this.refined == refined ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, refined, this.declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withDeclaresClassMethods(final boolean declaresClassMethods) {
        return this.declaresClassMethods == declaresClassMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, declaresClassMethods, this.nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withNativeKind(@NonNull final String nativeKind) {
        ...
        return this.nativeKind == nativeKind ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, nativeKind, this.nativePar, this._uniqueId);
      }
      ...
      public Info withNativePar(@NonNull final List<P> nativePar) {
        ...
        return this.nativePar == nativePar ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info with_uniqueId(final int _uniqueId) {
        return this._uniqueId == _uniqueId ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.nativeKind, this.nativePar, _uniqueId);
      }
    }
