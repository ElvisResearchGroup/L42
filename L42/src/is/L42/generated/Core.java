// Generated by delombok at Tue Sep 17 21:59:20 PETT 2019
...
public class Core {
  ...
  public static final class L implements LL, Leaf, Half.Leaf, Visitable<L> {
    ...
    public static final class Info implements Visitable<Info> {
      ...
      @java.lang.SuppressWarnings("all")
      public Info(final boolean isTyped, final List<P.NCs> typeDep, final List<P.NCs> coherentDep, final List<P.NCs> friends, final List<PathSel> usedMethods, final List<P.NCs> privateSupertypes, final List<S> refined, final boolean declaresClassMethods) {
      ...
      @java.lang.SuppressWarnings("all")
      public Info withFriends(final List<P.NCs> friends) {
      ...
      @java.lang.SuppressWarnings("all")
      public Info withPrivateSupertypes(final List<P.NCs> privateSupertypes) {
