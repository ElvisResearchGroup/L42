...
public class Core {
  ...
  public static final class L implements Leaf, Full.Leaf, Half.Leaf, Visitable<L> {
    ...
    public static final class Info implements Visitable<Info> {
      ...
      private final List<P> privateSubtypes;
      private final List<S> refined;
      private final boolean canBeClassAny;

      @java.lang.SuppressWarnings("all")
      public Info(final boolean isTyped, final List<P> typeDep, final List<P> coherentDep, final List<P> friends, final List<PathSel> usedMethods, final List<P> privateSubtypes, final List<S> refined, final boolean canBeClassAny) {
        this.isTyped = isTyped;
        this.typeDep = typeDep;
        this.coherentDep = coherentDep;
        this.friends = friends;
        this.usedMethods = usedMethods;
        this.privateSubtypes = privateSubtypes;
      ...
      @java.lang.SuppressWarnings("all")
      public List<P> privateSubtypes() {
        return this.privateSubtypes;
      }
      ...
      public boolean equals(final java.lang.Object o) {
        ...
        final java.lang.Object this$privateSubtypes = this.privateSubtypes();
        final java.lang.Object other$privateSubtypes = other.privateSubtypes();
        if (this$privateSubtypes == null ? other$privateSubtypes != null : !this$privateSubtypes.equals(other$privateSubtypes)) return false;
      ...
      public int hashCode() {
        ...
        final java.lang.Object $privateSubtypes = this.privateSubtypes();
        result = result * PRIME + ($privateSubtypes == null ? 43 : $privateSubtypes.hashCode());
      ...
      public Info withTyped(final boolean isTyped) {
        return this.isTyped == isTyped ? this : new Info(isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSubtypes, this.refined, this.canBeClassAny);
      }

      @java.lang.SuppressWarnings("all")
      public Info withTypeDep(final List<P> typeDep) {
        return this.typeDep == typeDep ? this : new Info(this.isTyped, typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSubtypes, this.refined, this.canBeClassAny);
      }

      @java.lang.SuppressWarnings("all")
      public Info withCoherentDep(final List<P> coherentDep) {
        return this.coherentDep == coherentDep ? this : new Info(this.isTyped, this.typeDep, coherentDep, this.friends, this.usedMethods, this.privateSubtypes, this.refined, this.canBeClassAny);
      }

      @java.lang.SuppressWarnings("all")
      public Info withFriends(final List<P> friends) {
        return this.friends == friends ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, friends, this.usedMethods, this.privateSubtypes, this.refined, this.canBeClassAny);
      }

      @java.lang.SuppressWarnings("all")
      public Info withUsedMethods(final List<PathSel> usedMethods) {
        return this.usedMethods == usedMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, usedMethods, this.privateSubtypes, this.refined, this.canBeClassAny);
      }

      @java.lang.SuppressWarnings("all")
      public Info withPrivateSubtypes(final List<P> privateSubtypes) {
        return this.privateSubtypes == privateSubtypes ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, privateSubtypes, this.refined, this.canBeClassAny);
      }

      @java.lang.SuppressWarnings("all")
      public Info withRefined(final List<S> refined) {
        return this.refined == refined ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSubtypes, refined, this.canBeClassAny);
      }

      @java.lang.SuppressWarnings("all")
      public Info withCanBeClassAny(final boolean canBeClassAny) {
        return this.canBeClassAny == canBeClassAny ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSubtypes, this.refined, canBeClassAny);
      }
    }
