// Generated by delombok at Sun Jan 12 14:20:03 NZDT 2020
...
public class Core {
  ...
  public static final class L implements LL, Leaf, Half.Leaf, Visitable<L> {
    ...
    public static final class Info implements Visitable<Info> {
      ...
      @java.lang.SuppressWarnings("all")
      public Info(final boolean isTyped, final List<P.NCs> typeDep, final List<P.NCs> coherentDep, final List<P.NCs> watched, final List<PathSel> usedMethods, final List<P.NCs> hiddenSupertypes, final List<S> refined, final boolean declaresClassMethods, final boolean close, final String nativeKind, final List<P> nativePar, final int _uniqueId) {
      ...
      public Info withTyped(final boolean isTyped) {
        return this.isTyped == isTyped ? this : new Info(isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withTypeDep(final List<P.NCs> typeDep) {
        return this.typeDep == typeDep ? this : new Info(this.isTyped, typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withCoherentDep(final List<P.NCs> coherentDep) {
        return this.coherentDep == coherentDep ? this : new Info(this.isTyped, this.typeDep, coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withWatched(final List<P.NCs> watched) {
        return this.watched == watched ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withUsedMethods(final List<PathSel> usedMethods) {
        return this.usedMethods == usedMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withHiddenSupertypes(final List<P.NCs> hiddenSupertypes) {
        return this.hiddenSupertypes == hiddenSupertypes ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withRefined(final List<S> refined) {
        return this.refined == refined ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withDeclaresClassMethods(final boolean declaresClassMethods) {
        return this.declaresClassMethods == declaresClassMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, declaresClassMethods, this.close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withClose(final boolean close) {
        return this.close == close ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, close, this.nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withNativeKind(final String nativeKind) {
        return this.nativeKind == nativeKind ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, nativeKind, this.nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info withNativePar(final List<P> nativePar) {
        return this.nativePar == nativePar ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, nativePar, this._uniqueId);
      }

      @java.lang.SuppressWarnings("all")
      public Info with_uniqueId(final int _uniqueId) {
        return this._uniqueId == _uniqueId ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.watched, this.usedMethods, this.hiddenSupertypes, this.refined, this.declaresClassMethods, this.close, this.nativeKind, this.nativePar, _uniqueId);
      }
    }
