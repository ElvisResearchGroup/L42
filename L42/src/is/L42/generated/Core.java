...
public class Core {
  ...
  public static final class L implements LL, Leaf, Half.Leaf, Visitable<L> {
    ...
    @Override
    public List<LDom> dom() {
      return Stream.concat(mwts.stream().map(m -> (LDom) m.key()), ncs.stream().map(m -> (LDom) m.key())).collect(Collectors.toList());
    }

    @Override
    public L c(C c) {
      return ncs.stream().filter(m -> m.key().equals(c)).findFirst().get().l();
    }
    ...
    public static final class MWT implements Visitable<MWT> {
      @Override
    ...
    public static final class NC implements Visitable<NC> {
      @Override
    ...
    public static final class Info implements Visitable<Info> {
      ...
      private final List<P> friends;
      private final List<PathSel> usedMethods;
      private final List<P> privateSupertypes;
      ...
      @java.lang.SuppressWarnings("all")
      public Info(final boolean isTyped, final List<P> typeDep, final List<P> coherentDep, final List<P> friends, final List<PathSel> usedMethods, final List<P> privateSupertypes, final List<S> refined, final boolean declaresClassMethods) {
      ...
      @java.lang.SuppressWarnings("all")
      public List<P> privateSupertypes() {
      ...
      public Info withTyped(final boolean isTyped) {
        return this.isTyped == isTyped ? this : new Info(isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSupertypes, this.refined, this.declaresClassMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withTypeDep(final List<P> typeDep) {
        return this.typeDep == typeDep ? this : new Info(this.isTyped, typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSupertypes, this.refined, this.declaresClassMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withCoherentDep(final List<P> coherentDep) {
        return this.coherentDep == coherentDep ? this : new Info(this.isTyped, this.typeDep, coherentDep, this.friends, this.usedMethods, this.privateSupertypes, this.refined, this.declaresClassMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withFriends(final List<P> friends) {
        return this.friends == friends ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, friends, this.usedMethods, this.privateSupertypes, this.refined, this.declaresClassMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withUsedMethods(final List<PathSel> usedMethods) {
        return this.usedMethods == usedMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, usedMethods, this.privateSupertypes, this.refined, this.declaresClassMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withPrivateSupertypes(final List<P> privateSupertypes) {
        return this.privateSupertypes == privateSupertypes ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, privateSupertypes, this.refined, this.declaresClassMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withRefined(final List<S> refined) {
        return this.refined == refined ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSupertypes, refined, this.declaresClassMethods);
      }

      @java.lang.SuppressWarnings("all")
      public Info withDeclaresClassMethods(final boolean declaresClassMethods) {
        return this.declaresClassMethods == declaresClassMethods ? this : new Info(this.isTyped, this.typeDep, this.coherentDep, this.friends, this.usedMethods, this.privateSupertypes, this.refined, declaresClassMethods);
      }
    }
