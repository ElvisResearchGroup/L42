// Generated by delombok at Wed Sep 25 11:03:57 PETT 2019
...
public class Core {
  ...
  public static final class L implements LL, Leaf, Half.Leaf, Visitable<L> {
    ...
    public static final class Info implements Visitable<Info> {
      ...
      @java.lang.SuppressWarnings("all")
      public Info(final boolean isTyped, @NonNull final List<P.NCs> typeDep, @NonNull final List<P.NCs> coherentDep, @NonNull final List<P.NCs> friends, @NonNull final List<PathSel> usedMethods, @NonNull final List<P.NCs> privateSupertypes, @NonNull final List<S> refined, final boolean declaresClassMethods) {
        if (typeDep == null) {
