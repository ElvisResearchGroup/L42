...
public class Full {
  ...
  public static final class EString implements E, Visitable<EString> {
    ...
    public EString withPos(final Pos pos) {
      return this.pos == pos ? this : new EString(pos, this.escapeSize, this.es, this.strings);
    }

    @java.lang.SuppressWarnings("all")
    public EString withEscapeSize(final int escapeSize) {
      return this.escapeSize == escapeSize ? this : new EString(this.pos, escapeSize, this.es, this.strings);
    }

    @java.lang.SuppressWarnings("all")
    public EString withEs(final List<E> es) {
      return this.es == es ? this : new EString(this.pos, this.escapeSize, es, this.strings);
    }

    @java.lang.SuppressWarnings("all")
    public EString withStrings(final List<String> strings) {
      return this.strings == strings ? this : new EString(this.pos, this.escapeSize, this.es, strings);
    }
