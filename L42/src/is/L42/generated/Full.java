// Generated by delombok at Sun Aug 18 11:01:44 PETT 2019
...
public class Full {
  ...
  public static final class L implements Leaf, Half.E, Visitable<L> {
    @Override
    ...
    public static interface M extends HasWf, HasPos, HasVisitable {
      List<Doc> docs();
    ...
    public static final class F implements M, Visitable<F> {
      ...
      @java.lang.SuppressWarnings("all")
      public F(final Pos pos, final List<Doc> docs, final T t, final S key) {
        this.pos = pos;
        this.docs = docs;
        this.t = t;
        this.key = key;
      ...
      public F withPos(final Pos pos) {
        return this.pos == pos ? this : new F(pos, this.docs, this.t, this.key);
      }

      @java.lang.SuppressWarnings("all")
      public F withDocs(final List<Doc> docs) {
        return this.docs == docs ? this : new F(this.pos, docs, this.t, this.key);
      }

      @java.lang.SuppressWarnings("all")
      public F withT(final T t) {
        return this.t == t ? this : new F(this.pos, this.docs, t, this.key);
      }

      @java.lang.SuppressWarnings("all")
      public F withKey(final S key) {
        return this.key == key ? this : new F(this.pos, this.docs, this.t, key);
      }
    }
  ...
  public static final class Call implements E, Visitable<Call> {
    ...
    @java.lang.SuppressWarnings("all")
    public Call(final Pos pos, final E e, final S s, final boolean isSquare, final List<Par> pars) {
      this.pos = pos;
      this.e = e;
      this.s = s;
    ...
    public Call withPos(final Pos pos) {
      return this.pos == pos ? this : new Call(pos, this.e, this.s, this.isSquare, this.pars);
    }

    @java.lang.SuppressWarnings("all")
    public Call withE(final E e) {
      return this.e == e ? this : new Call(this.pos, e, this.s, this.isSquare, this.pars);
    }

    @java.lang.SuppressWarnings("all")
    public Call withS(final S s) {
      return this.s == s ? this : new Call(this.pos, this.e, s, this.isSquare, this.pars);
    }

    @java.lang.SuppressWarnings("all")
    public Call withSquare(final boolean isSquare) {
      return this.isSquare == isSquare ? this : new Call(this.pos, this.e, this.s, isSquare, this.pars);
    }

    @java.lang.SuppressWarnings("all")
    public Call withPars(final List<Par> pars) {
      return this.pars == pars ? this : new Call(this.pos, this.e, this.s, this.isSquare, pars);
    }
  }
  ...
  public static final class T implements Visitable<T> {
    ...
    @java.lang.SuppressWarnings("all")
    public T(final Mdf _mdf, final List<Doc> docs, final CsP csP) {
      this._mdf = _mdf;
      this.docs = docs;
      this.csP = csP;
    }
    ...
    public T with_mdf(final Mdf _mdf) {
      return this._mdf == _mdf ? this : new T(_mdf, this.docs, this.csP);
    }

    @java.lang.SuppressWarnings("all")
    public T withDocs(final List<Doc> docs) {
      return this.docs == docs ? this : new T(this._mdf, docs, this.csP);
    }

    @java.lang.SuppressWarnings("all")
    public T withCsP(final CsP csP) {
      return this.csP == csP ? this : new T(this._mdf, this.docs, csP);
    }
  }
  ...
  public static final class PathSel implements Visitable<PathSel> {
    ...
    private final CsP _csP;
    private final S _s;
    private final X _x;

    @java.lang.SuppressWarnings("all")
    public PathSel(final CsP _csP, final S _s, final X _x) {
      this._csP = _csP;
      this._s = _s;
      this._x = _x;
    }
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      final java.lang.Object this$_csP = this._csP();
      final java.lang.Object other$_csP = other._csP();
      if (this$_csP == null ? other$_csP != null : !this$_csP.equals(other$_csP)) return false;
    ...
    public int hashCode() {
      final int PRIME = 59;
      int result = 1;
      final java.lang.Object $_csP = this._csP();
      result = result * PRIME + ($_csP == null ? 43 : $_csP.hashCode());
    ...
    @java.lang.SuppressWarnings("all")
    public PathSel with_csP(final CsP _csP) {
      return this._csP == _csP ? this : new PathSel(_csP, this._s, this._x);
    }

    @java.lang.SuppressWarnings("all")
    public PathSel with_s(final S _s) {
      return this._s == _s ? this : new PathSel(this._csP, _s, this._x);
    }

    @java.lang.SuppressWarnings("all")
    public PathSel with_x(final X _x) {
      return this._x == _x ? this : new PathSel(this._csP, this._s, _x);
    }
  }
