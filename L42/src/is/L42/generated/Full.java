// Generated by delombok at Mon Jun 15 19:25:22 NZST 2020
...
public class Full {
  ...
  public static final class MH implements LDom.HasKey, Visitable<MH> {
    ...
    public Full.MH with_mdf(final Mdf _mdf) {
      return this._mdf == _mdf ? this : new Full.MH(_mdf, this.docs, this.t, this._op, this.n, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Full.MH withDocs(final List<Doc> docs) {
      return this.docs == docs ? this : new Full.MH(this._mdf, docs, this.t, this._op, this.n, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Full.MH withT(final T t) {
      return this.t == t ? this : new Full.MH(this._mdf, this.docs, t, this._op, this.n, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Full.MH with_op(final Op _op) {
      return this._op == _op ? this : new Full.MH(this._mdf, this.docs, this.t, _op, this.n, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Full.MH withN(final int n) {
      return this.n == n ? this : new Full.MH(this._mdf, this.docs, this.t, this._op, n, this.s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Full.MH withS(final S s) {
      return this.s == s ? this : new Full.MH(this._mdf, this.docs, this.t, this._op, this.n, s, this.pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Full.MH withPars(final List<T> pars) {
      return this.pars == pars ? this : new Full.MH(this._mdf, this.docs, this.t, this._op, this.n, this.s, pars, this.exceptions);
    }

    @java.lang.SuppressWarnings("all")
    public Full.MH withExceptions(final List<T> exceptions) {
      return this.exceptions == exceptions ? this : new Full.MH(this._mdf, this.docs, this.t, this._op, this.n, this.s, this.pars, exceptions);
    }
  }
}
