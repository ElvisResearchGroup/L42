...
public final class Y {
  ...
  private final Half.T _expectedT;
  private final boolean onPath;

  @java.lang.SuppressWarnings("all")
  public Y(final Program p, final GX g, final List<ST> onSlash, final Half.XP _onSlashX, final Half.T _expectedT, final boolean onPath) {
    this.p = p;
    this.g = g;
  ...
  @java.lang.SuppressWarnings("all")
  public Y with_expectedT(final Half.T _expectedT) {
