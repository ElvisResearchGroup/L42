...
public final class S implements LDom {
	private final String m;
	private final List<X> xs;

	@java.lang.SuppressWarnings("all")
	public S(final String m, final List<X> xs) {
		this.m = m;
		this.xs = xs;
	}
	...
	public java.lang.String toString() {
		return "S(m=" + this.m() + ", xs=" + this.xs() + ")";
	}

	@java.lang.SuppressWarnings("all")
	public S withM(final String m) {
		return this.m == m ? this : new S(m, this.xs);
	}

	@java.lang.SuppressWarnings("all")
	public S withXs(final List<X> xs) {
		return this.xs == xs ? this : new S(this.m, xs);
	}
}
