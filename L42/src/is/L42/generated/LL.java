...
public interface LL extends Full.Leaf, Half.E, HasVisitable, HasPos {
  ...
  final class NotInDom extends RuntimeException {
    ...
    @java.lang.SuppressWarnings("all")
    public LL.NotInDom withReceiver(final LL receiver) {
      return this.receiver == receiver ? this : new LL.NotInDom(receiver, this.parameter);
    }

    @java.lang.SuppressWarnings("all")
    public LL.NotInDom withParameter(final LDom parameter) {
      return this.parameter == parameter ? this : new LL.NotInDom(this.receiver, parameter);
    }
