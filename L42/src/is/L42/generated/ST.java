...
public interface ST {
  ...
  final class STMeth implements ST {
    private final ST st;
    private final S s;
    private final int x;/*0 for no i*/

    @java.lang.SuppressWarnings("all")
    public STMeth(final ST st, final S s, final int x) {
      this.st = st;
      this.s = s;
      this.x = x;
    }
    ...
    public java.lang.String toString() {
      return "ST.STMeth(st=" + this.st() + ", s=" + this.s() + ", x=" + this.x() + ")";
    }

    @java.lang.SuppressWarnings("all")
    public STMeth withSt(final ST st) {
      return this.st == st ? this : new STMeth(st, this.s, this.x);
    }

    @java.lang.SuppressWarnings("all")
    public STMeth withS(final S s) {
      return this.s == s ? this : new STMeth(this.st, s, this.x);
    }

    @java.lang.SuppressWarnings("all")
    public STMeth withX(final int x) {
      return this.x == x ? this : new STMeth(this.st, this.s, x);
    }
  }


  final class STOp implements ST {
    private final Op op;
    ...
    @java.lang.SuppressWarnings("all")
    public java.lang.String toString() {
      return "ST.STOp(op=" + this.op() + ", stzs=" + this.stzs() + ")";
    }
