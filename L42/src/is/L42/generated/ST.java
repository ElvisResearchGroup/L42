...
public interface ST extends HasWf, HasVisitable {
  ...
  final class STMeth implements ST, Visitable<STMeth> {
    @Override
    public Visitable<STMeth> visitable() {
      return this;
    }

    @Override
    public STMeth accept(CloneVisitor cv) {
  ...
  final class STOp implements ST, Visitable<STOp> {
    @Override
    public Visitable<STOp> visitable() {
      return this;
    }

    @Override
    public STOp accept(CloneVisitor cv) {
