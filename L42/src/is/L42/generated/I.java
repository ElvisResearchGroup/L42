...
public final class I {
  ...
  public I(final C _c, final Program p, final G g, final List<CT> ctz) {
    this._c = _c;
    this.p = p;
    this.g = g;
    this.ctz = ctz;
  ...
  public java.lang.String toString() {
    return "I(_c=" + this._c() + ", p=" + this.p() + ", g=" + this.g() + ", ctz=" + this.ctz() + ")";
  }

  @java.lang.SuppressWarnings("all")
  public I with_c(final C _c) {
    return this._c == _c ? this : new I(_c, this.p, this.g, this.ctz);
  }

  @java.lang.SuppressWarnings("all")
  public I withP(final Program p) {
    return this.p == p ? this : new I(this._c, p, this.g, this.ctz);
  }

  @java.lang.SuppressWarnings("all")
  public I withG(final G g) {
    return this.g == g ? this : new I(this._c, this.p, g, this.ctz);
  }

  @java.lang.SuppressWarnings("all")
  public I withCtz(final List<CT> ctz) {
    return this.ctz == ctz ? this : new I(this._c, this.p, this.g, ctz);
  }
}
