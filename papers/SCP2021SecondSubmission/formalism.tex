...
only used in our proofs since our small step reduction does not need to delete individual locations).
...
Invariants only see \Q@imm@ and \Q@capsule@ fields (as \Q@read@), neither of which can alias
  the current object.}
