...
\end{lstlisting}
In this example, the \Q@Data@ decorator generates a factory method, a \Q@mut method Void addItem(Item item)@ and a lot of other utility methods, including equality and conversion to string. \IOComm{Talk to marco about how the \Q!capsule! field is treated, in particular, how do you make different kinds of \Q!capsule! fields}
