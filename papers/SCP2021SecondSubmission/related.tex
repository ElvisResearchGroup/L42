...
In particular, note how the current concrete 42 syntax uses the keyword \Q@capsule@ to represent a varius kinds of restrictions over fields.
...
%\IOComm{Talk to marco about how the \Q!capsule! field is treated, in particular, how do you make different kinds of \Q!capsule! fields}
...
allows invariants to query owned mutable objects whose reachable object graph is not fully encapsulated. However as we showed in Section \ref{s:case-study}, it can become much more difficult to work with and requires significant annotation, since merely having an alias to an object
