...
The type-system requires that any method that could alter the result of a \Q!Cache.Now! method (except via a field update) must be marked with \Q!@Cache.Clear! and respect our capsule-mutator restrictions.
