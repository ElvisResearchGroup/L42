...
In particular, note how the current concrete 42 syntax uses the keyword \Q@capsule@ to represent various kinds of restrictions over fields.
...
However, our encapsulation strategies are so much more flexible.
