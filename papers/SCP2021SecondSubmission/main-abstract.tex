...
We present case studies showing that our system requires a much lower annotation burden compared to Spec\#, and performs orders of magnitude less runtime invariant checks compared to the `visible state semantics' protocols of D and Eiffel. \IOComm{When we said "widlely" used, we mean visible state semantics is, not the D and Eiffel languages}
