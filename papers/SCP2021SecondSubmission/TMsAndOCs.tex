...
L42 also allows non-destructive reads of \Q!capsule! fields, but the result of such a read cannot be stored in the heap.~\cite{ServettoEtAl13a,GIANNINI2019145}
