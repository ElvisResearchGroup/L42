...
and we are eager to lissen to more suggestions from the revs; however our work already has XX (more than 79) references.
...
be enforced on the internal object too. See section 7, the "subInvariant pattern" and when the "subInvariant" method can be observed as false
...
We hope that our new terminology (rep fields) clarifies how we do not rely on a L42 specific interpretation of capsulness and how 
