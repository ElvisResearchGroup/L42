...
%your: just points outside: It would require some powerful static or dynamic analysis to keep track of every case the reachable object graph of \Q@Person@ could be indirectly mutated, and insert validity checks appropriately, however ensuring deep mutability trivialises this for simple classes.
...
%\Q@println(bob.name())@ may change \Q@bob@ by quietly changing a part of its reachable object graph.
%Again, checking
...
%}{3}{\label{SES2} [see footnote \autoref{SES1}]}.
