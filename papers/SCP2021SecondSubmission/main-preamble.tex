...
\newcommand{\prom}[2]{\ensuremath{#1\ \Kw{promote}\ \oC#2\cC}}
\newcommand{\cprom}[1]{\prom{\Kw{capsule}}{#1}}
\newcommand{\call}[3]{#1\singleDot#2\oR#3\cR}
...
\lstdefinelanguage{FortyThree}[]{FortyTwo}{morekeywords={rep,promote}} % 42 but with rep keyword
...
\newmathword{\dom}{dom}
\newmathword{\RNC}{repNotCircular}
\newmathword{\NRM}{notRepMutating}
\newmathword{\ENR}{encapsulatedRep}
\newmathword{\rog}{rog}
...
\newcommand{\mread}[2]{\ensuremath{#2{::}#1}}
