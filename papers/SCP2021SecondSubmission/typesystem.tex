...
\SS\begin{Corollary}[\IO{Nested Type}]\ \\
...
\SS\begin{Lemma}[\IO{Substitution}]\ \\
...
\SS\begin{proof}
	\begin{enumerate}
		...
		for some $e$.
		\item By \thm{Type Rule}, the $\textsc{TCall}$ typing rule applied, so we have $\tyr{\mdf_0\,l_0}{\mdf\,C}$, for some $\mdf$ and $C$.
