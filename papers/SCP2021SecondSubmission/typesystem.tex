...
\\\IOComm{Actually I don't think this actually matters,
	so a simpler definition might be $\e \sim e'$ iff:\\ \indent$%
		e[\Kw{imm}\coloneqq\Kw{read},\Kw{mut}\coloneqq\Kw{read},\Kw{capsule}\coloneqq\Kw{read}] = %
		e'[\Kw{imm}\coloneqq\Kw{read},\Kw{mut}\coloneqq\Kw{read},\Kw{capsule}\coloneqq\Kw{read}]$}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\rowSpace}{\vspace{-1.5ex}\\}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		$e$ will compute the result of the entire expression (if the invariant check succeeds) and the $e'$ will be the \Q!invariant! check itself. The side condition on $l$ is not strictly needed as it follows directly from \thm{No Dangling}.
...
Now a simple lemma relating $\immut$ with $\mrog$ and $\muty$:
