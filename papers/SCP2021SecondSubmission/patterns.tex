...
In contrast, if \Q@invalid@ was a type system feature the any user defined type would intrinsically expose the existence of both variants in the public API.
\end{itemize}
