...
Note how the body of the \Q@imm@ lambda in \Q@connectWith(other,g)@, can not cpature the \Q@read this@ nor the \Q@read other@, but we get their (immutable) indexes 
