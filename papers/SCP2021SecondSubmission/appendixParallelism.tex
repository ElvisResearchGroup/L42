...
However, such \Q@mut@ references will all be unreachable from inside the initialisation expressions. This is because they cannot use \Q!mut! variables, and any \Q!capsule! variables they use will be encapsulated, and so hence will not alias anything reachable from such \Q!read! references.
