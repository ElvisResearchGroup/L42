...
\end{lstlisting}
The \emph{fork} part consists of the initialisation expressions for \Q@a0@, \Q@b0@, and 
\Q@c0@, which are run in parallel, the \emph{join} part is the final expression, which is run only when 
