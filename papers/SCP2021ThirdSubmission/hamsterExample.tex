...
%----
In Spec\#, we had to add $10$ different annotations, of $8$ different kinds, worth a total of $20$ tokens.
In comparison, our approach requires only $8$ simple keywords of $3$ different kinds, for a total of $8$ tokens. However, we needed to write 
