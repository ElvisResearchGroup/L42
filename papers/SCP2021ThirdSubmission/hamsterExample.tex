...
%----
In Spec\#, we had to add $10$ different annotations, of $8$ different kinds\IO[29.1]{, worth a total of $20$ tokens}.
In comparison, our approach requires only $8$ simple keywords of $3$ different kinds\IO[29.2]{, for a total of $8$ tokens}. However, we needed to write 
