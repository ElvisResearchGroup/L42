...
\SS\begin{proof}
	...
	\item Now we show that \thm{Capsule Consistency} holds, by assuming it does not, and then showing a contradiction. Thus we suppose that $e = \E[\Kw{capsule}\,l]$, for some $\E$ where $\encap(\s,\E,l)$
		doesn't hold.
		\LSenum
