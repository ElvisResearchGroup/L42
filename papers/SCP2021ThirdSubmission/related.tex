...
\item \IO{The same as above, but an invariant may optionally be declared `strong', requiring that it must hold for every variable/paramater (and their parts) at every well-defined step of execution (a `sequence point')~\cite{ACSL}.}
