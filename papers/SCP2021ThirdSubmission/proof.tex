...
\begin{ienumerate}
	...
	\begin{itemize}
		...
		\item Consider any other $l'$, where $l \in \rog(\s',l')$ and $l'$ was \valid; now suppose we just made $l'$ in\valid. 
			...
			\begin{itemize}
				\item As the \rog of $l'$ has just been mutated, and since $e'''$ was must have come from the reduction of $\invariant{l'''}$, if follows from \thm{Determinism}, that we cannot currently be inside $e'''$.
