...
\IO[15]{programmers can put less thought into their use of reference capabilities: a programmer can choose to use more restrictive them only when desired,} for example they can write many classes
