...
%, of which the GUI one is highlighted in the paper,
 showing that we require orders of magnitude fewer runtime checks than \textit{visible state semantics} and three times fewer annotation burden than an equivalent version in Spec\#. We hope that as a result of this work, the software verification community will make more use of the advanced general purpose language features, such as capabilities, appearing in modern languages to achieve its goals.
