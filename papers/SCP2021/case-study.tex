...
\end{wrapfigure}
\end{comment}
\IOComm{Somehow everything after this image seems to be forced into one column mode...; it also wasn't position correctly; so I've just commented it out for the moment!}\\
\SS
...
\footnote{
This difference is caused by Eiffel treating getters specilly, and skipping invariant checks when calling a getter.
