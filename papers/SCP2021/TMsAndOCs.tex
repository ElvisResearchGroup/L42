...
As you can see, RCs are applied to all types. This of course includes types in method parameters and the method receiver.
...
declaration fully determines what values can be stored; any contextual information must be explicitly passed through the type system, for example, with a generic RC parameter.
