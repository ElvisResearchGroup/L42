...
Note that those sub invariants are not restricted to be only about the local state of a node; since they can explore the state of all of the reachable nodes, they may even depend upon the whole graph.
