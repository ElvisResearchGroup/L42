...
In L42 ``depending on how we expose the owned data, we can closely model both \emph{owners-as-dominators}[...] and \emph{owners-as-qualifiers}[...]''\cite{GIANNINI2019145}, it also supports ``\Q!lent! getter[s], a third variant''\cite{GIANNINI2019145}%Flexible recovery of uniqueness and immutability
